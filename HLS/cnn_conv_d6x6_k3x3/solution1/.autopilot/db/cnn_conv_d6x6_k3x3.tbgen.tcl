set C_TypeInfoList {{ 
"cnn_conv_d6x6_k3x3" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"inStream": [[], {"reference": "0"}] }, {"outStream": [[], {"reference": "0"}] }, {"ctrl": [[],"1"] }, {"kernel": [[], {"array": ["2", [9]]}] }],[],""], 
...
set moduleName cnn_conv_d6x6_k3x3
...
set C_modelName {cnn_conv_d6x6_k3x3}
...
set NewPortList {[ 
	...
	{ "name": "s_axi_CTRL_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "CTRL", "role": "ARADDR" },"address":[{"name":"cnn_conv_d6x6_k3x3","role":"start","value":"0","valid_bit":"0"},{"name":"cnn_conv_d6x6_k3x3","role":"done","value":"0","valid_bit":"1"},{"name":"cnn_conv_d6x6_k3x3","role":"idle","value":"0","valid_bit":"2"},{"name":"cnn_conv_d6x6_k3x3","role":"ready","value":"0","valid_bit":"3"},{"name":"cnn_conv_d6x6_k3x3","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cnn_conv_d6x6_k3x3_CTRL_s_axi_U", "Parent" : "0"},
	{"ID" : "2", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lineBuffer_0_U", "Parent" : "0"},
	{"ID" : "3", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.lineBuffer_1_U", "Parent" : "0"},
	{"ID" : "4", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_517", "Parent" : "0", "Child" : ["5"],
	...
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_517.cnn_conv_d6x6_k3xbkb_U0", "Parent" : "4"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_524", "Parent" : "0", "Child" : ["7"],
		"CDFG" : "fixed_point_mul",
		"VariableLatency" : "0",
		"AlignedPipeline" : "1",
		"UnalignedPipeline" : "0",
		...
		{"Name" : "a", "Type" : "None", "Direction" : "I"},
		{"Name" : "b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_524.cnn_conv_d6x6_k3xbkb_U0", "Parent" : "6"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_531", "Parent" : "0", "Child" : ["9"],
		"CDFG" : "fixed_point_mul",
		"VariableLatency" : "0",
		"AlignedPipeline" : "1",
		"UnalignedPipeline" : "0",
		...
		{"Name" : "a", "Type" : "None", "Direction" : "I"},
		{"Name" : "b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_531.cnn_conv_d6x6_k3xbkb_U0", "Parent" : "8"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_538", "Parent" : "0", "Child" : ["11"],
		"CDFG" : "fixed_point_mul",
		"VariableLatency" : "0",
		"AlignedPipeline" : "1",
		"UnalignedPipeline" : "0",
		...
		{"Name" : "a", "Type" : "None", "Direction" : "I"},
		{"Name" : "b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "11", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_538.cnn_conv_d6x6_k3xbkb_U0", "Parent" : "10"},
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_545", "Parent" : "0", "Child" : ["13"],
		"CDFG" : "fixed_point_mul",
		"VariableLatency" : "0",
		"AlignedPipeline" : "1",
		"UnalignedPipeline" : "0",
		...
		{"Name" : "a", "Type" : "None", "Direction" : "I"},
		{"Name" : "b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "13", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_545.cnn_conv_d6x6_k3xbkb_U0", "Parent" : "12"},
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_553", "Parent" : "0", "Child" : ["15"],
		"CDFG" : "fixed_point_mul",
		"VariableLatency" : "0",
		"AlignedPipeline" : "1",
		"UnalignedPipeline" : "0",
		...
		{"Name" : "a", "Type" : "None", "Direction" : "I"},
		{"Name" : "b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "15", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_553.cnn_conv_d6x6_k3xbkb_U0", "Parent" : "14"},
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_561", "Parent" : "0", "Child" : ["17"],
		"CDFG" : "fixed_point_mul",
		"VariableLatency" : "0",
		"AlignedPipeline" : "1",
		"UnalignedPipeline" : "0",
		...
		{"Name" : "a", "Type" : "None", "Direction" : "I"},
		{"Name" : "b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "17", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_561.cnn_conv_d6x6_k3xbkb_U0", "Parent" : "16"},
	{"ID" : "18", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_568", "Parent" : "0", "Child" : ["19"],
		"CDFG" : "fixed_point_mul",
		"VariableLatency" : "0",
		"AlignedPipeline" : "1",
		"UnalignedPipeline" : "0",
		...
		{"Name" : "a", "Type" : "None", "Direction" : "I"},
		{"Name" : "b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "19", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_568.cnn_conv_d6x6_k3xbkb_U0", "Parent" : "18"},
	{"ID" : "20", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_576", "Parent" : "0", "Child" : ["21"],
		"CDFG" : "fixed_point_mul",
		"VariableLatency" : "0",
		"AlignedPipeline" : "1",
		"UnalignedPipeline" : "0",
		...
		{"Name" : "a", "Type" : "None", "Direction" : "I"},
		{"Name" : "b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "21", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_576.cnn_conv_d6x6_k3xbkb_U0", "Parent" : "20"}]}
