...
fixed_point_mul::fixed_point_mul(sc_module_name name) : sc_module(name), mVcdFile(0) {
    cnn_conv_d94x94_kbkb_U0 = new cnn_conv_d94x94_kbkb<1,6,32,32,32>("cnn_conv_d94x94_kbkb_U0");
    cnn_conv_d94x94_kbkb_U0->clk(ap_clk);
    cnn_conv_d94x94_kbkb_U0->reset(ap_rst);
    cnn_conv_d94x94_kbkb_U0->din0(b_assign_reg_132);
    cnn_conv_d94x94_kbkb_U0->din1(a_assign_reg_127);
    cnn_conv_d94x94_kbkb_U0->ce(grp_fu_74_ce);
    cnn_conv_d94x94_kbkb_U0->dout(grp_fu_74_p2);
...
fixed_point_mul::~fixed_point_mul() {
    ...
    delete cnn_conv_d94x94_kbkb_U0;
}
