; ModuleID = 'D:/School/Project/new_repo/HLS/cnn_conv_d94x94_k3x3/solution1/.autopilot/db/a.o.3.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-f80:128:128-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S32"
target triple = "i686-pc-mingw32"

@llvm_global_ctors_1 = appending global [1 x void ()*] [void ()* @_GLOBAL__I_a] ; [#uses=0 type=[1 x void ()*]*]
@llvm_global_ctors_0 = appending global [1 x i32] [i32 65535] ; [#uses=0 type=[1 x i32]*]
@cnn_conv_d94x94_k3x3_1 = internal unnamed_addr constant [21 x i8] c"cnn_conv_d94x94_k3x3\00" ; [#uses=1 type=[21 x i8]*]
...
define void @cnn_conv_d94x94_k3x3(i32* %inStream_V_data_V, i4* %inStream_V_keep_V, i4* %inStream_V_strb_V, i2* %inStream_V_user_V, i1* %inStream_V_last_V, i5* %inStream_V_id_V, i6* %inStream_V_dest_V, i32* %outStream_V_data_V, i4* %outStream_V_keep_V, i4* %outStream_V_strb_V, i2* %outStream_V_user_V, i1* %outStream_V_last_V, i5* %outStream_V_id_V, i6* %outStream_V_dest_V, i32 %ctrl, i32* %kernel_0, i32* %kernel_1, i32* %kernel_2, i32* %kernel_3, i32* %kernel_4, i32* %kernel_5, i32* %kernel_6, i32* %kernel_7, i32* %kernel_8) {
  ...
  call void (...)* @_ssdm_op_SpecTopModule([21 x i8]* @cnn_conv_d94x94_k3x3_1) nounwind
  ...
  %lineBuffer_0 = alloca [94 x i32], align 4      ; [#uses=3 type=[94 x i32]*]
  %lineBuffer_1 = alloca [94 x i32], align 4      ; [#uses=3 type=[94 x i32]*]
  ...
  call void @llvm.dbg.value(metadata !{i32* %outStream_V_data_V}, i64 0, metadata !2809), !dbg !2811 ; [debug line = 75:36] [debug variable = outStream.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %outStream_V_keep_V}, i64 0, metadata !2812), !dbg !2811 ; [debug line = 75:36] [debug variable = outStream.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %outStream_V_strb_V}, i64 0, metadata !2813), !dbg !2811 ; [debug line = 75:36] [debug variable = outStream.V.strb.V]
  call void @llvm.dbg.value(metadata !{i2* %outStream_V_user_V}, i64 0, metadata !2814), !dbg !2811 ; [debug line = 75:36] [debug variable = outStream.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %outStream_V_last_V}, i64 0, metadata !2815), !dbg !2811 ; [debug line = 75:36] [debug variable = outStream.V.last.V]
  call void @llvm.dbg.value(metadata !{i5* %outStream_V_id_V}, i64 0, metadata !2816), !dbg !2811 ; [debug line = 75:36] [debug variable = outStream.V.id.V]
  call void @llvm.dbg.value(metadata !{i6* %outStream_V_dest_V}, i64 0, metadata !2817), !dbg !2811 ; [debug line = 75:36] [debug variable = outStream.V.dest.V]
  ...
  call void @llvm.dbg.declare(metadata !{[94 x i32]* %lineBuffer_0}, metadata !2837), !dbg !2844 ; [debug line = 87:12] [debug variable = lineBuffer[0]]
  call void @llvm.dbg.declare(metadata !{[94 x i32]* %lineBuffer_1}, metadata !2845), !dbg !2844 ; [debug line = 87:12] [debug variable = lineBuffer[1]]
  br label %1, !dbg !2846                         ; [debug line = 95:39]

; <label>:1                                       ; preds = %2, %0
  %x = phi i7 [ -36, %0 ], [ %x_1, %2 ]           ; [#uses=3 type=i7]
  %exitcond1 = icmp eq i7 %x, -34, !dbg !2846     ; [#uses=1 type=i1] [debug line = 95:39]
...
; <label>:2                                       ; preds = %1
  ...
  %lineBuffer_0_addr = getelementptr [94 x i32]* %lineBuffer_0, i32 0, i32 %x_cast ; [#uses=1 type=i32*]
...
.preheader86.0:                                   ; preds = %3, %.preheader86.0.preheader
  ...
  %exitcond4 = icmp eq i7 %x1, -34, !dbg !2848    ; [#uses=1 type=i1] [debug line = 103:17]
...
; <label>:3                                       ; preds = %.preheader86.0
  ...
  %empty_7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 94, i64 94, i64 94) ; [#uses=0 type=i32]
  ...
  %lineBuffer_1_addr = getelementptr [94 x i32]* %lineBuffer_1, i32 0, i32 %x1_cast ; [#uses=1 type=i32*]
...
.preheader85:                                     ; preds = %.preheader84
  ...
  %x4_cast = zext i2 %x4_mid2 to i7, !dbg !2917   ; [#uses=1 type=i7] [debug line = 115:31]
  ...
  %tmp_s = add i7 -37, %x4_cast, !dbg !2902       ; [#uses=1 type=i7] [debug line = 117:2]
  %tmp_cast = zext i7 %tmp_s to i32, !dbg !2902   ; [#uses=2 type=i32] [debug line = 117:2]
  %lineBuffer_0_addr_1 = getelementptr [94 x i32]* %lineBuffer_0, i32 0, i32 %tmp_cast, !dbg !2902 ; [#uses=1 type=i32*] [debug line = 117:2]
  %lineBuffer_1_addr_1 = getelementptr [94 x i32]* %lineBuffer_1, i32 0, i32 %tmp_cast, !dbg !2902 ; [#uses=1 type=i32*] [debug line = 117:2]
...
.preheader82:                                     ; preds = %._crit_edge88, %.preheader83.preheader
  ...
  %exitcond_flatten8 = icmp eq i14 %indvar_flatten6, -7548 ; [#uses=1 type=i1]
...
_ifconv1:                                         ; preds = %.preheader83
  ...
  %tmp_last_V = icmp eq i32 %writeCount, 8464, !dbg !2964 ; [#uses=1 type=i1] [debug line = 66:2@139:19]
...
._crit_edge:                                      ; preds = %.preheader83, %_ifconv1
  ...
  %lineBuffer_0_addr_2 = getelementptr [94 x i32]* %lineBuffer_0, i32 0, i32 %x_assign_cast ; [#uses=2 type=i32*]
  ...
  %lineBuffer_1_addr_2 = getelementptr [94 x i32]* %lineBuffer_1, i32 0, i32 %x_assign_cast ; [#uses=2 type=i32*]
  ...
  %tmp_5 = icmp slt i32 %readCount_1_load, 8836, !dbg !2987 ; [#uses=1 type=i1] [debug line = 152:4]
  store i32 %windowRightCol_0, i32* %window_0_1
  br i1 %tmp_5, label %4, label %._crit_edge88, !dbg !2987 ; [debug line = 152:4]
...
.preheader83:                                     ; preds = %.preheader82
  %empty_14 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8836, i64 8836, i64 8836) ; [#uses=0 type=i32]
  %exitcond2 = icmp eq i7 %x_assign, -34, !dbg !3026 ; [#uses=4 type=i1] [debug line = 123:17]
  ...
  %tmp_2_i_mid1 = icmp ugt i7 %y_s, -36, !dbg !3028 ; [#uses=1 type=i1] [debug line = 40:2@127:9]
  %tmp_2_i = icmp ugt i7 %y_assign, -36, !dbg !3028 ; [#uses=1 type=i1] [debug line = 40:2@127:9]
  ...
  %tmp_1_i = icmp ugt i7 %x_assign_mid2, -36, !dbg !3028 ; [#uses=1 type=i1] [debug line = 40:2@127:9]
...
!67 = metadata !{i32 786473, metadata !"cnn_conv_d94x94_k3x3/fixed_point.h", metadata !"D:\5CSchool\5CProject\5Cnew_repo\5CHLS", null} ; [ DW_TAG_file_type ]
...
!71 = metadata !{i32 786473, metadata !"cnn_conv_d94x94_k3x3/core.cpp", metadata !"D:\5CSchool\5CProject\5Cnew_repo\5CHLS", null} ; [ DW_TAG_file_type ]
...
!2811 = metadata !{i32 75, i32 36, metadata !203, null}
...
!2839 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 6016, i64 32, i32 0, i32 0, metadata !70, metadata !2840, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2840 = metadata !{metadata !2841, metadata !2842}
!2841 = metadata !{i32 786465, i64 0, i64 1}      ; [ DW_TAG_subrange_type ]
!2842 = metadata !{i32 786465, i64 0, i64 93}     ; [ DW_TAG_subrange_type ]
!2843 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 3008, i64 32, i32 0, i32 0, metadata !70, metadata !2840, i32 0, i32 0} ; [ DW_TAG_array_type ]
