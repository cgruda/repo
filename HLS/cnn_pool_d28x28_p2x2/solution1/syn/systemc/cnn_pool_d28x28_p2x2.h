...
#ifndef _cnn_pool_d28x28_p2x2_HH_
#define _cnn_pool_d28x28_p2x2_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "cnn_pool_d28x28_pbkb.h"
#include "cnn_pool_d28x28_p2x2_CTRL_s_axi.h"

namespace ap_rtl {

template<unsigned int C_S_AXI_CTRL_ADDR_WIDTH = 5,
         unsigned int C_S_AXI_CTRL_DATA_WIDTH = 32>
struct cnn_pool_d28x28_p2x2 : public sc_module {
    ...
    // Module declarations
    cnn_pool_d28x28_p2x2(sc_module_name name);
    SC_HAS_PROCESS(cnn_pool_d28x28_p2x2);
    ...
    cnn_pool_d28x28_p2x2_CTRL_s_axi<C_S_AXI_CTRL_ADDR_WIDTH,C_S_AXI_CTRL_DATA_WIDTH>* cnn_pool_d28x28_p2x2_CTRL_s_axi_U;
    cnn_pool_d28x28_pbkb* lineBuffer_0_U;
    cnn_pool_d28x28_pbkb* lineBuffer_1_U;
    ...
    sc_signal< sc_lv<10> > indvar_flatten6_reg_370;
    ...
    sc_signal< sc_lv<5> > x_2_fu_459_p2;
    sc_signal< sc_lv<5> > x_2_reg_908;
    ...
    sc_signal< sc_lv<10> > indvar_flatten_next7_fu_620_p2;
    sc_signal< sc_logic > ap_enable_reg_pp3_iter0;
    sc_signal< sc_lv<5> > y_assign_cast7_mid2_s_fu_646_p3;
    sc_signal< sc_lv<5> > y_assign_cast7_mid2_s_reg_1027;
    sc_signal< sc_lv<1> > tmp_fu_668_p2;
    sc_signal< sc_lv<5> > lineBuffer_0_addr_2_reg_1036;
    sc_signal< sc_lv<5> > lineBuffer_1_addr_2_reg_1042;
    sc_signal< sc_lv<5> > ap_pipeline_reg_pp3_iter1_lineBuffer_1_addr_2_reg_1042;
    sc_signal< sc_lv<1> > tmp_7_fu_677_p2;
    sc_signal< sc_lv<5> > x_4_fu_694_p2;
    ...
    sc_signal< sc_lv<5> > x_cast_fu_444_p1;
    ...
    sc_signal< sc_lv<5> > tmp_5_cast1_fu_544_p1;
    ...
    sc_signal< sc_lv<5> > y_s_fu_640_p2;
    sc_signal< sc_lv<5> > x_assign_mid2_fu_632_p3;
