...
set DataType0 [list "ap_axiu<32, 2, 5, 6>" "struct ap_axiu" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
...
set DataType1 [list "ap_axiu<32, 2, 5, 6>" "struct ap_axiu" $structMem1 1 0 $structParameter1 $structArgument1 $NameSpace1 $structIsPacked1]
