; ModuleID = 'D:/School/Project/new_repo/HLS/cnn_conv_d128x128_k3x3/solution1/.autopilot/db/a.o.2.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-f80:128:128-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S32"
target triple = "i686-pc-mingw32"

@llvm_global_ctors_1 = appending global [1 x void ()*] [void ()* @_GLOBAL__I_a]
@llvm_global_ctors_0 = appending global [1 x i32] [i32 65535]
@cnn_conv_d128x128_k3 = internal unnamed_addr constant [23 x i8] c"cnn_conv_d128x128_k3x3\00"
...
define void @cnn_conv_d128x128_k3x3(i32* %inStream_V_data_V, i4* %inStream_V_keep_V, i4* %inStream_V_strb_V, i2* %inStream_V_user_V, i1* %inStream_V_last_V, i5* %inStream_V_id_V, i6* %inStream_V_dest_V, i32* %outStream_V_data_V, i4* %outStream_V_keep_V, i4* %outStream_V_strb_V, i2* %outStream_V_user_V, i1* %outStream_V_last_V, i5* %outStream_V_id_V, i6* %outStream_V_dest_V, i32 %ctrl, i32* %kernel_0, i32* %kernel_1, i32* %kernel_2, i32* %kernel_3, i32* %kernel_4, i32* %kernel_5, i32* %kernel_6, i32* %kernel_7, i32* %kernel_8) {
  ...
  %lineBuffer_0 = alloca [128 x i32], align 4
  %lineBuffer_1 = alloca [128 x i32], align 4
...
; <label>:1                                       ; preds = %2, %0
  %x = phi i8 [ 126, %0 ], [ %x_1, %2 ]
  %exitcond1 = icmp eq i8 %x, -128
...
; <label>:2                                       ; preds = %1
  ...
  %lineBuffer_0_addr = getelementptr [128 x i32]* %lineBuffer_0, i32 0, i32 %x_cast
...
.preheader86.0:                                   ; preds = %.preheader86.0.preheader, %3
  %x1 = phi i8 [ %x_2, %3 ], [ 0, %.preheader86.0.preheader ]
  %exitcond4 = icmp eq i8 %x1, -128
  %x_2 = add i8 %x1, 1
...
; <label>:3                                       ; preds = %.preheader86.0
  ...
  %lineBuffer_1_addr = getelementptr [128 x i32]* %lineBuffer_1, i32 0, i32 %x1_cast
...
.preheader85:                                     ; preds = %.preheader84
  ...
  %x4_cast19_cast = zext i2 %x4_mid2 to i3
  %tmp_4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str8)
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind
  %tmp_s = add i3 -3, %x4_cast19_cast
  %tmp_cast1 = sext i3 %tmp_s to i7
  %tmp_cast = zext i7 %tmp_cast1 to i32
  %lineBuffer_0_addr_1 = getelementptr [128 x i32]* %lineBuffer_0, i32 0, i32 %tmp_cast
  %lineBuffer_1_addr_1 = getelementptr [128 x i32]* %lineBuffer_1, i32 0, i32 %tmp_cast
...
.preheader82:                                     ; preds = %.preheader83.preheader, %._crit_edge88
  %indvar_flatten6 = phi i15 [ 0, %.preheader83.preheader ], [ %indvar_flatten_next7, %._crit_edge88 ]
  %y_assign = phi i8 [ 0, %.preheader83.preheader ], [ %y_assign_mid2, %._crit_edge88 ]
  ...
  %x_assign = phi i8 [ 0, %.preheader83.preheader ], [ %x_4, %._crit_edge88 ]
  ...
  %exitcond_flatten8 = icmp eq i15 %indvar_flatten6, -16384
  %indvar_flatten_next7 = add i15 %indvar_flatten6, 1
...
_ifconv1:                                         ; preds = %.preheader83
  ...
  %tmp11_trunc25_ext_ca = sext i23 %tmp_9_2_1_i to i24
  %tmp1 = add i24 %tmp11_trunc25_ext_ca, %tmp11_trunc_ext_cast
  %tmp11_cast = sext i24 %tmp1 to i25
  %tmp12_trunc_ext_cast = sext i23 %tmp_9_1_1_i to i24
  %tmp12_trunc24_ext_ca = sext i23 %tmp_9_1_2_i to i24
  %tmp4 = add i24 %tmp12_trunc_ext_cast, %tmp12_trunc24_ext_ca
  ...
  %tmp14_trunc23_ext_ca = sext i23 %tmp_9_0_1_i to i24
  %tmp6 = add i24 %tmp14_trunc23_ext_ca, %tmp14_trunc_ext_cast
  %tmp14_cast = sext i24 %tmp6 to i26
  %tmp16_trunc_ext_cast = sext i23 %tmp_9_0_2_i to i24
  %tmp16_trunc26_ext_ca = sext i23 %tmp_9_2_2_i to i24
  %tmp7 = add i24 %tmp16_trunc26_ext_ca, %tmp16_trunc_ext_cast
  ...
  %tmp_last_V = icmp eq i32 %writeCount, 15876
...
._crit_edge:                                      ; preds = %_ifconv1, %.preheader83
  ...
  %lineBuffer_0_addr_2 = getelementptr [128 x i32]* %lineBuffer_0, i32 0, i32 %x_assign_cast
  %windowRightCol_0 = load i32* %lineBuffer_0_addr_2, align 4
  %lineBuffer_1_addr_2 = getelementptr [128 x i32]* %lineBuffer_1, i32 0, i32 %x_assign_cast
  %windowRightCol_1 = load i32* %lineBuffer_1_addr_2, align 4
  store i32 %windowRightCol_1, i32* %lineBuffer_0_addr_2, align 4
  %tmp_11 = call i18 @_ssdm_op_PartSelect.i18.i32.i32.i32(i32 %readCount_1_load, i32 14, i32 31)
  %icmp = icmp slt i18 %tmp_11, 1
  store i32 %windowRightCol_0, i32* %window_0_1
  br i1 %icmp, label %4, label %._crit_edge88
...
._crit_edge88:                                    ; preds = %4, %._crit_edge
  ...
  %x_4 = add i8 %x_assign_mid2, 1
  br label %.preheader82

.preheader83:                                     ; preds = %.preheader82
  %empty_14 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 16384, i64 16384, i64 16384)
  %exitcond2 = icmp eq i8 %x_assign, -128
  %x_assign_mid2 = select i1 %exitcond2, i8 0, i8 %x_assign
  %y_s = add i8 %y_assign, 1
  %tmp_i_mid1 = icmp eq i8 %y_s, 0
  %tmp_i = icmp eq i8 %y_assign, 0
  %tmp_i_mid2 = select i1 %exitcond2, i1 %tmp_i_mid1, i1 %tmp_i
  %tmp_2_i_mid1 = icmp ugt i8 %y_s, 126
  %tmp_2_i = icmp ugt i8 %y_assign, 126
  %tmp_2_i_mid2 = select i1 %exitcond2, i1 %tmp_2_i_mid1, i1 %tmp_2_i
  %y_assign_mid2 = select i1 %exitcond2, i8 %y_s, i8 %y_assign
  %x_assign_cast = zext i8 %x_assign_mid2 to i32
  %tmp_3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str9)
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind
  %tmp_i_15 = icmp eq i8 %x_assign_mid2, 0
  %tmp_1_i = icmp ugt i8 %x_assign_mid2, 126
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2)
  %empty_23 = trunc i32 %empty to i18
  ret i18 %empty_23
}
