...
set ID 3
set MemName cnn_conv_d128x128cud
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 4 \
			corename cnn_conv_d128x128_k3x3_CTRL_axilite \
			name cnn_conv_d128x128_k3x3_CTRL_s_axi \
			ports {$port_CTRL} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler cnn_conv_d128x128_k3x3_CTRL_s_axi
}
