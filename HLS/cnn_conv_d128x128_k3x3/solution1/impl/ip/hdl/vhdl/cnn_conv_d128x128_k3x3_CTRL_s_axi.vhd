...
entity cnn_conv_d128x128_k3x3_CTRL_s_axi is
generic (
...
end entity cnn_conv_d128x128_k3x3_CTRL_s_axi;
...
architecture behave of cnn_conv_d128x128_k3x3_CTRL_s_axi is
    ...
    constant ADDR_KERNEL_0_DATA_0 : INTEGER := 16#18#;
    constant ADDR_KERNEL_0_CTRL   : INTEGER := 16#1c#;
    constant ADDR_KERNEL_1_DATA_0 : INTEGER := 16#20#;
    constant ADDR_KERNEL_1_CTRL   : INTEGER := 16#24#;
    constant ADDR_KERNEL_2_DATA_0 : INTEGER := 16#28#;
    constant ADDR_KERNEL_2_CTRL   : INTEGER := 16#2c#;
    constant ADDR_KERNEL_3_DATA_0 : INTEGER := 16#30#;
    constant ADDR_KERNEL_3_CTRL   : INTEGER := 16#34#;
    constant ADDR_KERNEL_4_DATA_0 : INTEGER := 16#38#;
    constant ADDR_KERNEL_4_CTRL   : INTEGER := 16#3c#;
    constant ADDR_KERNEL_5_DATA_0 : INTEGER := 16#40#;
    constant ADDR_KERNEL_5_CTRL   : INTEGER := 16#44#;
    constant ADDR_KERNEL_6_DATA_0 : INTEGER := 16#48#;
    constant ADDR_KERNEL_6_CTRL   : INTEGER := 16#4c#;
    constant ADDR_KERNEL_7_DATA_0 : INTEGER := 16#50#;
    constant ADDR_KERNEL_7_CTRL   : INTEGER := 16#54#;
    constant ADDR_KERNEL_8_DATA_0 : INTEGER := 16#58#;
    constant ADDR_KERNEL_8_CTRL   : INTEGER := 16#5c#;
    ...
    signal int_kernel_0        : UNSIGNED(31 downto 0);
    signal int_kernel_1        : UNSIGNED(31 downto 0);
    signal int_kernel_2        : UNSIGNED(31 downto 0);
    signal int_kernel_3        : UNSIGNED(31 downto 0);
    signal int_kernel_4        : UNSIGNED(31 downto 0);
    signal int_kernel_5        : UNSIGNED(31 downto 0);
    signal int_kernel_6        : UNSIGNED(31 downto 0);
    signal int_kernel_7        : UNSIGNED(31 downto 0);
    signal int_kernel_8        : UNSIGNED(31 downto 0);
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_KERNEL_3_DATA_0 =>
                        rdata_data <= RESIZE(int_kernel_3(31 downto 0), 32);
                    when ADDR_KERNEL_4_DATA_0 =>
                        rdata_data <= RESIZE(int_kernel_4(31 downto 0), 32);
                    when ADDR_KERNEL_5_DATA_0 =>
                        rdata_data <= RESIZE(int_kernel_5(31 downto 0), 32);
                    when ADDR_KERNEL_6_DATA_0 =>
                        rdata_data <= RESIZE(int_kernel_6(31 downto 0), 32);
                    when ADDR_KERNEL_7_DATA_0 =>
                        rdata_data <= RESIZE(int_kernel_7(31 downto 0), 32);
                    when ADDR_KERNEL_8_DATA_0 =>
                        rdata_data <= RESIZE(int_kernel_8(31 downto 0), 32);
                    when others =>
                        rdata_data <= (others => '0');
                    end case;
                end if;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_KERNEL_3_DATA_0) then
                    int_kernel_3(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_kernel_3(31 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_KERNEL_4_DATA_0) then
                    int_kernel_4(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_kernel_4(31 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_KERNEL_5_DATA_0) then
                    int_kernel_5(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_kernel_5(31 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_KERNEL_6_DATA_0) then
                    int_kernel_6(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_kernel_6(31 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_KERNEL_7_DATA_0) then
                    int_kernel_7(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_kernel_7(31 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_KERNEL_8_DATA_0) then
                    int_kernel_8(31 downto 0) <= (UNSIGNED(WDATA(31 downto 0)) and wmask(31 downto 0)) or ((not wmask(31 downto 0)) and int_kernel_8(31 downto 0));
                end if;
            end if;
        end if;
    end process;
