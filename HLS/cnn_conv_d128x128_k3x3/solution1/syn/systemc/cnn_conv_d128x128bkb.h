...
#ifndef __cnn_conv_d128x128bkb__HH__
#define __cnn_conv_d128x128bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_conv_d128x128bkb) {
    ...
    SC_CTOR(cnn_conv_d128x128bkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
