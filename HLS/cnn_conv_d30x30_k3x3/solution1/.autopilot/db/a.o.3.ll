; ModuleID = 'D:/School/Project/new_repo/HLS/cnn_conv_d30x30_k3x3/solution1/.autopilot/db/a.o.3.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-f80:128:128-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S32"
target triple = "i686-pc-mingw32"

@llvm_global_ctors_1 = appending global [1 x void ()*] [void ()* @_GLOBAL__I_a] ; [#uses=0 type=[1 x void ()*]*]
@llvm_global_ctors_0 = appending global [1 x i32] [i32 65535] ; [#uses=0 type=[1 x i32]*]
@cnn_conv_d30x30_k3x3_1 = internal unnamed_addr constant [21 x i8] c"cnn_conv_d30x30_k3x3\00" ; [#uses=1 type=[21 x i8]*]
...
define void @cnn_conv_d30x30_k3x3(i32* %inStream_V_data_V, i4* %inStream_V_keep_V, i4* %inStream_V_strb_V, i2* %inStream_V_user_V, i1* %inStream_V_last_V, i5* %inStream_V_id_V, i6* %inStream_V_dest_V, i32* %outStream_V_data_V, i4* %outStream_V_keep_V, i4* %outStream_V_strb_V, i2* %outStream_V_user_V, i1* %outStream_V_last_V, i5* %outStream_V_id_V, i6* %outStream_V_dest_V, i32 %ctrl, i32* %kernel_0, i32* %kernel_1, i32* %kernel_2, i32* %kernel_3, i32* %kernel_4, i32* %kernel_5, i32* %kernel_6, i32* %kernel_7, i32* %kernel_8) {
  ...
  call void (...)* @_ssdm_op_SpecTopModule([21 x i8]* @cnn_conv_d30x30_k3x3_1) nounwind
  %ctrl_read = call i32 @_ssdm_op_Read.s_axilite.i32(i32 %ctrl) ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %ctrl_read}, i64 0, metadata !202), !dbg !2717 ; [debug line = 78:10] [debug variable = ctrl]
  call void @llvm.dbg.value(metadata !{i32 %ctrl_read}, i64 0, metadata !2718), !dbg !2733 ; [debug line = 47:53@135:19] [debug variable = ctrl]
  %lineBuffer_0 = alloca [30 x i32], align 4      ; [#uses=3 type=[30 x i32]*]
  %lineBuffer_1 = alloca [30 x i32], align 4      ; [#uses=3 type=[30 x i32]*]
  call void @llvm.dbg.value(metadata !{i32* %inStream_V_data_V}, i64 0, metadata !2734), !dbg !2747 ; [debug line = 76:25] [debug variable = inStream.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_keep_V}, i64 0, metadata !2748), !dbg !2747 ; [debug line = 76:25] [debug variable = inStream.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_strb_V}, i64 0, metadata !2760), !dbg !2747 ; [debug line = 76:25] [debug variable = inStream.V.strb.V]
  call void @llvm.dbg.value(metadata !{i2* %inStream_V_user_V}, i64 0, metadata !2761), !dbg !2747 ; [debug line = 76:25] [debug variable = inStream.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %inStream_V_last_V}, i64 0, metadata !2773), !dbg !2747 ; [debug line = 76:25] [debug variable = inStream.V.last.V]
  call void @llvm.dbg.value(metadata !{i5* %inStream_V_id_V}, i64 0, metadata !2785), !dbg !2747 ; [debug line = 76:25] [debug variable = inStream.V.id.V]
  call void @llvm.dbg.value(metadata !{i6* %inStream_V_dest_V}, i64 0, metadata !2797), !dbg !2747 ; [debug line = 76:25] [debug variable = inStream.V.dest.V]
  call void @llvm.dbg.value(metadata !{i32* %outStream_V_data_V}, i64 0, metadata !2809), !dbg !2811 ; [debug line = 77:24] [debug variable = outStream.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %outStream_V_keep_V}, i64 0, metadata !2812), !dbg !2811 ; [debug line = 77:24] [debug variable = outStream.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %outStream_V_strb_V}, i64 0, metadata !2813), !dbg !2811 ; [debug line = 77:24] [debug variable = outStream.V.strb.V]
  call void @llvm.dbg.value(metadata !{i2* %outStream_V_user_V}, i64 0, metadata !2814), !dbg !2811 ; [debug line = 77:24] [debug variable = outStream.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %outStream_V_last_V}, i64 0, metadata !2815), !dbg !2811 ; [debug line = 77:24] [debug variable = outStream.V.last.V]
  call void @llvm.dbg.value(metadata !{i5* %outStream_V_id_V}, i64 0, metadata !2816), !dbg !2811 ; [debug line = 77:24] [debug variable = outStream.V.id.V]
  call void @llvm.dbg.value(metadata !{i6* %outStream_V_dest_V}, i64 0, metadata !2817), !dbg !2811 ; [debug line = 77:24] [debug variable = outStream.V.dest.V]
  call void @llvm.dbg.value(metadata !{i32 %ctrl}, i64 0, metadata !202), !dbg !2717 ; [debug line = 78:10] [debug variable = ctrl]
  call void @llvm.dbg.value(metadata !{i32* %kernel_0}, i64 0, metadata !2818), !dbg !2824 ; [debug line = 79:11] [debug variable = kernel[0]]
  call void @llvm.dbg.value(metadata !{i32* %kernel_1}, i64 0, metadata !2825), !dbg !2824 ; [debug line = 79:11] [debug variable = kernel[1]]
  call void @llvm.dbg.value(metadata !{i32* %kernel_2}, i64 0, metadata !2826), !dbg !2824 ; [debug line = 79:11] [debug variable = kernel[2]]
  call void @llvm.dbg.value(metadata !{i32* %kernel_3}, i64 0, metadata !2827), !dbg !2824 ; [debug line = 79:11] [debug variable = kernel[3]]
  call void @llvm.dbg.value(metadata !{i32* %kernel_4}, i64 0, metadata !2828), !dbg !2824 ; [debug line = 79:11] [debug variable = kernel[4]]
  call void @llvm.dbg.value(metadata !{i32* %kernel_5}, i64 0, metadata !2829), !dbg !2824 ; [debug line = 79:11] [debug variable = kernel[5]]
  call void @llvm.dbg.value(metadata !{i32* %kernel_6}, i64 0, metadata !2830), !dbg !2824 ; [debug line = 79:11] [debug variable = kernel[6]]
  call void @llvm.dbg.value(metadata !{i32* %kernel_7}, i64 0, metadata !2831), !dbg !2824 ; [debug line = 79:11] [debug variable = kernel[7]]
  call void @llvm.dbg.value(metadata !{i32* %kernel_8}, i64 0, metadata !2832), !dbg !2824 ; [debug line = 79:11] [debug variable = kernel[8]]
  call void (...)* @_ssdm_op_SpecInterface(i32* %outStream_V_data_V, i4* %outStream_V_keep_V, i4* %outStream_V_strb_V, i2* %outStream_V_user_V, i1* %outStream_V_last_V, i5* %outStream_V_id_V, i6* %outStream_V_dest_V, [5 x i8]* @p_str, i32 1, i32 1, [5 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str2, [1 x i8]* @p_str2, [1 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str2, [1 x i8]* @p_str2) nounwind, !dbg !2833 ; [debug line = 81:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %inStream_V_data_V, i4* %inStream_V_keep_V, i4* %inStream_V_strb_V, i2* %inStream_V_user_V, i1* %inStream_V_last_V, i5* %inStream_V_id_V, i6* %inStream_V_dest_V, [5 x i8]* @p_str, i32 1, i32 1, [5 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str2, [1 x i8]* @p_str2, [1 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str2, [1 x i8]* @p_str2) nounwind, !dbg !2834 ; [debug line = 82:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %ctrl, [10 x i8]* @p_str3, i32 0, i32 0, [1 x i8]* @p_str2, i32 0, i32 0, [5 x i8]* @p_str4, [1 x i8]* @p_str2, [1 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str2, [1 x i8]* @p_str2) nounwind, !dbg !2835 ; [debug line = 83:1]
  ...
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [10 x i8]* @p_str3, i32 0, i32 0, [1 x i8]* @p_str2, i32 0, i32 0, [5 x i8]* @p_str4, [1 x i8]* @p_str2, [1 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str2, [1 x i8]* @p_str2) nounwind, !dbg !2836 ; [debug line = 85:1]
  call void @llvm.dbg.declare(metadata !{[30 x i32]* %lineBuffer_0}, metadata !2837), !dbg !2844 ; [debug line = 89:12] [debug variable = lineBuffer[0]]
  call void @llvm.dbg.declare(metadata !{[30 x i32]* %lineBuffer_1}, metadata !2845), !dbg !2844 ; [debug line = 89:12] [debug variable = lineBuffer[1]]
  br label %1, !dbg !2846                         ; [debug line = 97:39]

; <label>:1                                       ; preds = %2, %0
  %x = phi i3 [ -4, %0 ], [ %x_1, %2 ]            ; [#uses=3 type=i3]
  %exitcond1 = icmp eq i3 %x, -2, !dbg !2846      ; [#uses=1 type=i1] [debug line = 97:39]
  br i1 %exitcond1, label %.preheader86.0.preheader, label %2, !dbg !2846 ; [debug line = 97:39]

.preheader86.0.preheader:                         ; preds = %1
  br label %.preheader86.0, !dbg !2848            ; [debug line = 105:17]

; <label>:2                                       ; preds = %1
  %x_cast = sext i3 %x to i5, !dbg !2846          ; [#uses=1 type=i5] [debug line = 97:39]
  %x_cast1 = zext i5 %x_cast to i32, !dbg !2846   ; [#uses=1 type=i32] [debug line = 97:39]
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 2, i64 2, i64 2) ; [#uses=0 type=i32]
  %tmp = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str6), !dbg !2852 ; [#uses=1 type=i32] [debug line = 97:55]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind, !dbg !2854 ; [debug line = 98:1]
  call void @llvm.dbg.value(metadata !{i32* %inStream_V_data_V}, i64 0, metadata !2855), !dbg !2860 ; [debug line = 129:56@99:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_keep_V}, i64 0, metadata !2862), !dbg !2860 ; [debug line = 129:56@99:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_strb_V}, i64 0, metadata !2864), !dbg !2860 ; [debug line = 129:56@99:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.strb.V]
  call void @llvm.dbg.value(metadata !{i2* %inStream_V_user_V}, i64 0, metadata !2865), !dbg !2860 ; [debug line = 129:56@99:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %inStream_V_last_V}, i64 0, metadata !2867), !dbg !2860 ; [debug line = 129:56@99:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.last.V]
  call void @llvm.dbg.value(metadata !{i5* %inStream_V_id_V}, i64 0, metadata !2869), !dbg !2860 ; [debug line = 129:56@99:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.id.V]
  call void @llvm.dbg.value(metadata !{i6* %inStream_V_dest_V}, i64 0, metadata !2871), !dbg !2860 ; [debug line = 129:56@99:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.dest.V]
  %empty_5 = call { i32, i4, i4, i2, i1, i5, i6 } @_ssdm_op_Read.axis.volatile.i32P.i4P.i4P.i2P.i1P.i5P.i6P(i32* %inStream_V_data_V, i4* %inStream_V_keep_V, i4* %inStream_V_strb_V, i2* %inStream_V_user_V, i1* %inStream_V_last_V, i5* %inStream_V_id_V, i6* %inStream_V_dest_V), !dbg !2873 ; [#uses=1 type={ i32, i4, i4, i2, i1, i5, i6 }] [debug line = 131:9@99:19]
  %tmp_data_V = extractvalue { i32, i4, i4, i2, i1, i5, i6 } %empty_5, 0, !dbg !2873 ; [#uses=1 type=i32] [debug line = 131:9@99:19]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V}, i64 0, metadata !2875), !dbg !2873 ; [debug line = 131:9@99:19] [debug variable = tmp.data.V]
  %lineBuffer_0_addr = getelementptr [30 x i32]* %lineBuffer_0, i32 0, i32 %x_cast1 ; [#uses=1 type=i32*]
  store i32 %tmp_data_V, i32* %lineBuffer_0_addr, align 4, !dbg !2877 ; [debug line = 100:40]
  %empty_6 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str6, i32 %tmp), !dbg !2878 ; [#uses=0 type=i32] [debug line = 101:2]
  %x_1 = add i3 %x, 1, !dbg !2879                 ; [#uses=1 type=i3] [debug line = 97:49]
  call void @llvm.dbg.value(metadata !{i3 %x_1}, i64 0, metadata !2880), !dbg !2879 ; [debug line = 97:49] [debug variable = x]
  br label %1, !dbg !2879                         ; [debug line = 97:49]

.preheader86.0:                                   ; preds = %3, %.preheader86.0.preheader
  %x1 = phi i5 [ %x_2, %3 ], [ 0, %.preheader86.0.preheader ] ; [#uses=3 type=i5]
  %exitcond4 = icmp eq i5 %x1, -2, !dbg !2848     ; [#uses=1 type=i1] [debug line = 105:17]
  %x_2 = add i5 %x1, 1, !dbg !2881                ; [#uses=1 type=i5] [debug line = 105:27]
  br i1 %exitcond4, label %.preheader84.preheader, label %3, !dbg !2848 ; [debug line = 105:17]
...
; <label>:3                                       ; preds = %.preheader86.0
  %x1_cast = zext i5 %x1 to i32, !dbg !2848       ; [#uses=1 type=i32] [debug line = 105:17]
  %empty_7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 30, i64 30, i64 30) ; [#uses=0 type=i32]
  %tmp_1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str7), !dbg !2887 ; [#uses=1 type=i32] [debug line = 105:33]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind, !dbg !2889 ; [debug line = 106:1]
  call void @llvm.dbg.value(metadata !{i32* %inStream_V_data_V}, i64 0, metadata !2855), !dbg !2890 ; [debug line = 129:56@107:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_keep_V}, i64 0, metadata !2862), !dbg !2890 ; [debug line = 129:56@107:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_strb_V}, i64 0, metadata !2864), !dbg !2890 ; [debug line = 129:56@107:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.strb.V]
  call void @llvm.dbg.value(metadata !{i2* %inStream_V_user_V}, i64 0, metadata !2865), !dbg !2890 ; [debug line = 129:56@107:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %inStream_V_last_V}, i64 0, metadata !2867), !dbg !2890 ; [debug line = 129:56@107:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.last.V]
  call void @llvm.dbg.value(metadata !{i5* %inStream_V_id_V}, i64 0, metadata !2869), !dbg !2890 ; [debug line = 129:56@107:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.id.V]
  call void @llvm.dbg.value(metadata !{i6* %inStream_V_dest_V}, i64 0, metadata !2871), !dbg !2890 ; [debug line = 129:56@107:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.dest.V]
  %empty_8 = call { i32, i4, i4, i2, i1, i5, i6 } @_ssdm_op_Read.axis.volatile.i32P.i4P.i4P.i2P.i1P.i5P.i6P(i32* %inStream_V_data_V, i4* %inStream_V_keep_V, i4* %inStream_V_strb_V, i2* %inStream_V_user_V, i1* %inStream_V_last_V, i5* %inStream_V_id_V, i6* %inStream_V_dest_V), !dbg !2892 ; [#uses=1 type={ i32, i4, i4, i2, i1, i5, i6 }] [debug line = 131:9@107:19]
  %tmp_data_V_1 = extractvalue { i32, i4, i4, i2, i1, i5, i6 } %empty_8, 0, !dbg !2892 ; [#uses=1 type=i32] [debug line = 131:9@107:19]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_1}, i64 0, metadata !2875), !dbg !2892 ; [debug line = 131:9@107:19] [debug variable = tmp.data.V]
  %lineBuffer_1_addr = getelementptr [30 x i32]* %lineBuffer_1, i32 0, i32 %x1_cast ; [#uses=1 type=i32*]
  store i32 %tmp_data_V_1, i32* %lineBuffer_1_addr, align 4, !dbg !2893 ; [debug line = 108:23]
  %empty_9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str7, i32 %tmp_1), !dbg !2894 ; [#uses=0 type=i32] [debug line = 109:3]
  br label %.preheader86.0, !dbg !2881            ; [debug line = 105:27]
...
.preheader83.preheader:                           ; preds = %.preheader84
  ...
  %window_2_2_load = load i32* %window_2_2, !dbg !2902 ; [#uses=1 type=i32] [debug line = 119:2]
  ...
  %tmp_8 = trunc i32 %ctrl_read to i1, !dbg !2914 ; [#uses=1 type=i1] [debug line = 58:2@135:19]
  store i32 32, i32* %readCount_1
  store i32 0, i32* %writeCount_1
  store i32 %window_2_2_load, i32* %window_2_1, !dbg !2902 ; [debug line = 119:2]
  br label %.preheader82, !dbg !2916              ; [debug line = 124:16]
...
.preheader85:                                     ; preds = %.preheader84
  ...
  %exitcond = icmp eq i2 %x4, -1, !dbg !2917      ; [#uses=3 type=i1] [debug line = 117:31]
  %x4_mid2 = select i1 %exitcond, i2 1, i2 %x4    ; [#uses=3 type=i2]
  %y9 = add i2 1, %y3, !dbg !2918                 ; [#uses=1 type=i2] [debug line = 116:39]
  %tmp_2_mid2_v = select i1 %exitcond, i2 %y9, i2 %y3, !dbg !2902 ; [#uses=2 type=i2] [debug line = 119:2]
  %tmp_9 = trunc i2 %tmp_2_mid2_v to i1, !dbg !2902 ; [#uses=1 type=i1] [debug line = 119:2]
  %cond_mid1 = icmp eq i2 %y3, 0, !dbg !2902      ; [#uses=1 type=i1] [debug line = 119:2]
  %cond = icmp eq i2 %y3, 1, !dbg !2902           ; [#uses=1 type=i1] [debug line = 119:2]
  %cond_mid2 = select i1 %exitcond, i1 %cond_mid1, i1 %cond, !dbg !2902 ; [#uses=4 type=i1] [debug line = 119:2]
  %x4_cast19_cast = zext i2 %x4_mid2 to i4, !dbg !2917 ; [#uses=1 type=i4] [debug line = 117:31]
  %tmp_4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str8), !dbg !2919 ; [#uses=1 type=i32] [debug line = 117:46]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind, !dbg !2920 ; [debug line = 118:1]
  %tmp_s = add i4 -5, %x4_cast19_cast, !dbg !2902 ; [#uses=1 type=i4] [debug line = 119:2]
  %tmp_cast1 = sext i4 %tmp_s to i5, !dbg !2902   ; [#uses=1 type=i5] [debug line = 119:2]
  %tmp_cast = zext i5 %tmp_cast1 to i32, !dbg !2902 ; [#uses=2 type=i32] [debug line = 119:2]
  %lineBuffer_0_addr_1 = getelementptr [30 x i32]* %lineBuffer_0, i32 0, i32 %tmp_cast, !dbg !2902 ; [#uses=1 type=i32*] [debug line = 119:2]
  %lineBuffer_1_addr_1 = getelementptr [30 x i32]* %lineBuffer_1, i32 0, i32 %tmp_cast, !dbg !2902 ; [#uses=1 type=i32*] [debug line = 119:2]
  %lineBuffer_0_load = load i32* %lineBuffer_0_addr_1, align 4, !dbg !2902 ; [#uses=1 type=i32] [debug line = 119:2]
  %lineBuffer_1_load = load i32* %lineBuffer_1_addr_1, align 4, !dbg !2902 ; [#uses=1 type=i32] [debug line = 119:2]
  %window_1_1_2 = select i1 %tmp_9, i32 %lineBuffer_0_load, i32 %lineBuffer_1_load, !dbg !2902 ; [#uses=4 type=i32] [debug line = 119:2]
  %cond1 = icmp eq i2 %x4_mid2, 1, !dbg !2902     ; [#uses=4 type=i1] [debug line = 119:2]
  call void @llvm.dbg.value(metadata !{i32 %window_1_1_2}, i64 0, metadata !2921), !dbg !2902 ; [debug line = 119:2] [debug variable = window[1][1]]
  call void @llvm.dbg.value(metadata !{i32 %window_1_1_2}, i64 0, metadata !2922), !dbg !2902 ; [debug line = 119:2] [debug variable = window[1][2]]
  %window_2_2_1 = select i1 %cond1, i32 %window_1_2_1, i32 %window_1_1_2, !dbg !2902 ; [#uses=1 type=i32] [debug line = 119:2]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_1}, i64 0, metadata !2882), !dbg !2902 ; [debug line = 119:2] [debug variable = window[2][2]]
  %window_2_2_2 = select i1 %cond1, i32 %window_1_1_2, i32 %window_1_1_1, !dbg !2902 ; [#uses=1 type=i32] [debug line = 119:2]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_2}, i64 0, metadata !2882), !dbg !2902 ; [debug line = 119:2] [debug variable = window[2][2]]
  call void @llvm.dbg.value(metadata !{i32 %window_1_1_2}, i64 0, metadata !2907), !dbg !2902 ; [debug line = 119:2] [debug variable = window[2][1]]
  call void @llvm.dbg.value(metadata !{i32 %window_1_1_2}, i64 0, metadata !2882), !dbg !2902 ; [debug line = 119:2] [debug variable = window[2][2]]
  %window_2_2_4 = select i1 %cond1, i32 %window_2_2_load_1, i32 %window_1_1_2, !dbg !2902 ; [#uses=1 type=i32] [debug line = 119:2]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_4}, i64 0, metadata !2882), !dbg !2902 ; [debug line = 119:2] [debug variable = window[2][2]]
  %window_2_2_5 = select i1 %cond1, i32 %window_1_1_2, i32 %window_2_1_1, !dbg !2902 ; [#uses=1 type=i32] [debug line = 119:2]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_5}, i64 0, metadata !2882), !dbg !2902 ; [debug line = 119:2] [debug variable = window[2][2]]
  %window_2_2_6 = select i1 %cond_mid2, i32 %window_2_2_load_1, i32 %window_2_2_4 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_6}, i64 0, metadata !2882), !dbg !2902 ; [debug line = 119:2] [debug variable = window[2][2]]
  %window_2_2_7 = select i1 %cond_mid2, i32 %window_2_1_1, i32 %window_2_2_5 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_7}, i64 0, metadata !2882), !dbg !2902 ; [debug line = 119:2] [debug variable = window[2][2]]
  %window_2_2_8 = select i1 %cond_mid2, i32 %window_2_2_1, i32 %window_1_2_1 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_8}, i64 0, metadata !2882), !dbg !2902 ; [debug line = 119:2] [debug variable = window[2][2]]
  %window_2_2_9 = select i1 %cond_mid2, i32 %window_2_2_2, i32 %window_1_1_1 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_9}, i64 0, metadata !2882), !dbg !2902 ; [debug line = 119:2] [debug variable = window[2][2]]
  %empty_11 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str8, i32 %tmp_4), !dbg !2923 ; [#uses=0 type=i32] [debug line = 120:3]
  %x_3 = add i2 1, %x4_mid2, !dbg !2924           ; [#uses=1 type=i2] [debug line = 117:40]
  call void @llvm.dbg.value(metadata !{i2 %x_3}, i64 0, metadata !2925), !dbg !2924 ; [debug line = 117:40] [debug variable = x]
  store i32 %window_2_2_6, i32* %window_2_2
  br label %.preheader84, !dbg !2924              ; [debug line = 117:40]

.preheader82:                                     ; preds = %._crit_edge88, %.preheader83.preheader
  %indvar_flatten6 = phi i10 [ 0, %.preheader83.preheader ], [ %indvar_flatten_next7, %._crit_edge88 ] ; [#uses=2 type=i10]
  %y_assign = phi i5 [ 0, %.preheader83.preheader ], [ %y_assign_mid2, %._crit_edge88 ] ; [#uses=4 type=i5]
  ...
  %x_assign = phi i5 [ 0, %.preheader83.preheader ], [ %x_4, %._crit_edge88 ] ; [#uses=2 type=i5]
  %window_0_0_read_as_1 = load i32* %window_0_0_read_as, !dbg !2926 ; [#uses=1 type=i32] [debug line = 53:14@135:19]
  %window_0_0_load = load i32* %window_0_0        ; [#uses=2 type=i32]
  %window_0_1_load = load i32* %window_0_1        ; [#uses=1 type=i32]
  %window_1_0_read_as_1 = load i32* %window_1_0_read_as, !dbg !2926 ; [#uses=1 type=i32] [debug line = 53:14@135:19]
  %window_2_0_read_as_1 = load i32* %window_2_0_read_as, !dbg !2926 ; [#uses=1 type=i32] [debug line = 53:14@135:19]
  %window_2_1_2 = load i32* %window_2_1           ; [#uses=2 type=i32]
  %exitcond_flatten8 = icmp eq i10 %indvar_flatten6, -124 ; [#uses=1 type=i1]
  %indvar_flatten_next7 = add i10 %indvar_flatten6, 1 ; [#uses=1 type=i10]
...
_ifconv1:                                         ; preds = %.preheader83
  %window_0_1_load_1 = load i32* %window_0_1, !dbg !2926 ; [#uses=1 type=i32] [debug line = 53:14@135:19]
  %writeCount_1_load = load i32* %writeCount_1, !dbg !2931 ; [#uses=1 type=i32] [debug line = 133:5]
  %writeCount = add nsw i32 %writeCount_1_load, 1, !dbg !2931 ; [#uses=2 type=i32] [debug line = 133:5]
  call void @llvm.dbg.value(metadata !{i32 %writeCount}, i64 0, metadata !2932), !dbg !2931 ; [debug line = 133:5] [debug variable = writeCount]
  %kernel_0_read = call i32 @_ssdm_op_Read.s_axilite.i32P(i32* %kernel_0), !dbg !2726 ; [#uses=1 type=i32] [debug line = 135:19]
  %kernel_1_read = call i32 @_ssdm_op_Read.s_axilite.i32P(i32* %kernel_1), !dbg !2726 ; [#uses=1 type=i32] [debug line = 135:19]
  %kernel_2_read = call i32 @_ssdm_op_Read.s_axilite.i32P(i32* %kernel_2), !dbg !2726 ; [#uses=1 type=i32] [debug line = 135:19]
  %kernel_3_read = call i32 @_ssdm_op_Read.s_axilite.i32P(i32* %kernel_3), !dbg !2726 ; [#uses=1 type=i32] [debug line = 135:19]
  %kernel_4_read = call i32 @_ssdm_op_Read.s_axilite.i32P(i32* %kernel_4), !dbg !2726 ; [#uses=1 type=i32] [debug line = 135:19]
  %kernel_5_read = call i32 @_ssdm_op_Read.s_axilite.i32P(i32* %kernel_5), !dbg !2726 ; [#uses=1 type=i32] [debug line = 135:19]
  %kernel_6_read = call i32 @_ssdm_op_Read.s_axilite.i32P(i32* %kernel_6), !dbg !2726 ; [#uses=1 type=i32] [debug line = 135:19]
  %kernel_7_read = call i32 @_ssdm_op_Read.s_axilite.i32P(i32* %kernel_7), !dbg !2726 ; [#uses=1 type=i32] [debug line = 135:19]
  %kernel_8_read = call i32 @_ssdm_op_Read.s_axilite.i32P(i32* %kernel_8), !dbg !2726 ; [#uses=1 type=i32] [debug line = 135:19]
  call void @llvm.dbg.value(metadata !{i32 %window_1_0}, i64 0, metadata !2933), !dbg !2934 ; [debug line = 46:44@135:19] [debug variable = window[1][1]]
  call void @llvm.dbg.value(metadata !{i32 %window_1_1}, i64 0, metadata !2935), !dbg !2934 ; [debug line = 46:44@135:19] [debug variable = window[1][2]]
  call void @llvm.dbg.value(metadata !{i32 %window_2_0}, i64 0, metadata !2936), !dbg !2934 ; [debug line = 46:44@135:19] [debug variable = window[2][1]]
  call void @llvm.dbg.value(metadata !{i32 %window_2_1_2}, i64 0, metadata !2937), !dbg !2934 ; [debug line = 46:44@135:19] [debug variable = window[2][2]]
  call void @llvm.dbg.value(metadata !{i32 %kernel_0_read}, i64 0, metadata !2938), !dbg !2940 ; [debug line = 47:13@135:19] [debug variable = kernel[0]]
  call void @llvm.dbg.value(metadata !{i32 %kernel_1_read}, i64 0, metadata !2941), !dbg !2940 ; [debug line = 47:13@135:19] [debug variable = kernel[1]]
  call void @llvm.dbg.value(metadata !{i32 %kernel_2_read}, i64 0, metadata !2942), !dbg !2940 ; [debug line = 47:13@135:19] [debug variable = kernel[2]]
  call void @llvm.dbg.value(metadata !{i32 %kernel_3_read}, i64 0, metadata !2943), !dbg !2940 ; [debug line = 47:13@135:19] [debug variable = kernel[3]]
  call void @llvm.dbg.value(metadata !{i32 %kernel_4_read}, i64 0, metadata !2944), !dbg !2940 ; [debug line = 47:13@135:19] [debug variable = kernel[4]]
  call void @llvm.dbg.value(metadata !{i32 %kernel_5_read}, i64 0, metadata !2945), !dbg !2940 ; [debug line = 47:13@135:19] [debug variable = kernel[5]]
  call void @llvm.dbg.value(metadata !{i32 %kernel_6_read}, i64 0, metadata !2946), !dbg !2940 ; [debug line = 47:13@135:19] [debug variable = kernel[6]]
  call void @llvm.dbg.value(metadata !{i32 %kernel_7_read}, i64 0, metadata !2947), !dbg !2940 ; [debug line = 47:13@135:19] [debug variable = kernel[7]]
  call void @llvm.dbg.value(metadata !{i32 %kernel_8_read}, i64 0, metadata !2948), !dbg !2940 ; [debug line = 47:13@135:19] [debug variable = kernel[8]]
  call void @llvm.dbg.value(metadata !{i32 %ctrl}, i64 0, metadata !2718), !dbg !2733 ; [debug line = 47:53@135:19] [debug variable = ctrl]
  %tmp_9_0_i = call fastcc i23 @fixed_point_mul(i32 %window_0_0_read_as_1, i32 %kernel_0_read), !dbg !2926 ; [#uses=1 type=i23] [debug line = 53:14@135:19]
  %tmp_9_0_1_i = call fastcc i23 @fixed_point_mul(i32 %window_0_0_load, i32 %kernel_1_read), !dbg !2926 ; [#uses=1 type=i23] [debug line = 53:14@135:19]
  %tmp_9_0_2_i = call fastcc i23 @fixed_point_mul(i32 %window_0_1_load_1, i32 %kernel_2_read), !dbg !2926 ; [#uses=1 type=i23] [debug line = 53:14@135:19]
  %tmp_9_1_i = call fastcc i23 @fixed_point_mul(i32 %window_1_0_read_as_1, i32 %kernel_3_read), !dbg !2926 ; [#uses=1 type=i23] [debug line = 53:14@135:19]
  %tmp_9_1_1_i = call fastcc i23 @fixed_point_mul(i32 %window_1_0, i32 %kernel_4_read), !dbg !2926 ; [#uses=1 type=i23] [debug line = 53:14@135:19]
  %tmp_9_1_2_i = call fastcc i23 @fixed_point_mul(i32 %window_1_1, i32 %kernel_5_read), !dbg !2926 ; [#uses=1 type=i23] [debug line = 53:14@135:19]
  %tmp_9_2_i = call fastcc i23 @fixed_point_mul(i32 %window_2_0_read_as_1, i32 %kernel_6_read), !dbg !2926 ; [#uses=1 type=i23] [debug line = 53:14@135:19]
  %tmp_9_2_1_i = call fastcc i23 @fixed_point_mul(i32 %window_2_0, i32 %kernel_7_read), !dbg !2926 ; [#uses=1 type=i23] [debug line = 53:14@135:19]
  %tmp_9_2_2_i = call fastcc i23 @fixed_point_mul(i32 %window_2_1_2, i32 %kernel_8_read), !dbg !2926 ; [#uses=1 type=i23] [debug line = 53:14@135:19]
  %tmp11_trunc_ext_cast = sext i23 %tmp_9_2_i to i24, !dbg !2926 ; [#uses=1 type=i24] [debug line = 53:14@135:19]
  %tmp11_trunc25_ext_ca = sext i23 %tmp_9_2_1_i to i24, !dbg !2926 ; [#uses=1 type=i24] [debug line = 53:14@135:19]
  %tmp1 = add i24 %tmp11_trunc25_ext_ca, %tmp11_trunc_ext_cast, !dbg !2926 ; [#uses=1 type=i24] [debug line = 53:14@135:19]
  %tmp11_cast = sext i24 %tmp1 to i25, !dbg !2926 ; [#uses=1 type=i25] [debug line = 53:14@135:19]
  %tmp12_trunc_ext_cast = sext i23 %tmp_9_1_1_i to i24, !dbg !2926 ; [#uses=1 type=i24] [debug line = 53:14@135:19]
  %tmp12_trunc24_ext_ca = sext i23 %tmp_9_1_2_i to i24, !dbg !2926 ; [#uses=1 type=i24] [debug line = 53:14@135:19]
  %tmp4 = add i24 %tmp12_trunc_ext_cast, %tmp12_trunc24_ext_ca, !dbg !2926 ; [#uses=1 type=i24] [debug line = 53:14@135:19]
  %tmp12_cast = sext i24 %tmp4 to i25, !dbg !2926 ; [#uses=1 type=i25] [debug line = 53:14@135:19]
  %tmp5 = add i25 %tmp11_cast, %tmp12_cast, !dbg !2926 ; [#uses=1 type=i25] [debug line = 53:14@135:19]
  %tmp10_cast = sext i25 %tmp5 to i27, !dbg !2926 ; [#uses=1 type=i27] [debug line = 53:14@135:19]
  %tmp14_trunc_ext_cast = sext i23 %tmp_9_0_i to i24, !dbg !2926 ; [#uses=1 type=i24] [debug line = 53:14@135:19]
  %tmp14_trunc23_ext_ca = sext i23 %tmp_9_0_1_i to i24, !dbg !2926 ; [#uses=1 type=i24] [debug line = 53:14@135:19]
  %tmp6 = add i24 %tmp14_trunc23_ext_ca, %tmp14_trunc_ext_cast, !dbg !2926 ; [#uses=1 type=i24] [debug line = 53:14@135:19]
  %tmp14_cast = sext i24 %tmp6 to i26, !dbg !2926 ; [#uses=1 type=i26] [debug line = 53:14@135:19]
  %tmp16_trunc_ext_cast = sext i23 %tmp_9_0_2_i to i24, !dbg !2926 ; [#uses=1 type=i24] [debug line = 53:14@135:19]
  %tmp16_trunc26_ext_ca = sext i23 %tmp_9_2_2_i to i24, !dbg !2926 ; [#uses=1 type=i24] [debug line = 53:14@135:19]
  %tmp7 = add i24 %tmp16_trunc26_ext_ca, %tmp16_trunc_ext_cast, !dbg !2926 ; [#uses=1 type=i24] [debug line = 53:14@135:19]
  %tmp16_cast = sext i24 %tmp7 to i25, !dbg !2926 ; [#uses=1 type=i25] [debug line = 53:14@135:19]
  %tmp15_trunc_ext_cast = sext i23 %tmp_9_1_i to i25, !dbg !2926 ; [#uses=1 type=i25] [debug line = 53:14@135:19]
  %tmp8 = add i25 %tmp15_trunc_ext_cast, %tmp16_cast, !dbg !2926 ; [#uses=1 type=i25] [debug line = 53:14@135:19]
  %tmp15_cast = sext i25 %tmp8 to i26, !dbg !2926 ; [#uses=1 type=i26] [debug line = 53:14@135:19]
  %tmp9 = add i26 %tmp14_cast, %tmp15_cast, !dbg !2926 ; [#uses=1 type=i26] [debug line = 53:14@135:19]
  %tmp13_cast = sext i26 %tmp9 to i27, !dbg !2926 ; [#uses=1 type=i27] [debug line = 53:14@135:19]
  %result_4_2_2_i = add i27 %tmp10_cast, %tmp13_cast, !dbg !2926 ; [#uses=3 type=i27] [debug line = 53:14@135:19]
  %result_4_2_2_i_cast1 = sext i27 %result_4_2_2_i to i32, !dbg !2926 ; [#uses=1 type=i32] [debug line = 53:14@135:19]
  %tmp_10 = call i1 @_ssdm_op_BitSelect.i1.i27.i32(i27 %result_4_2_2_i, i32 26), !dbg !2949 ; [#uses=1 type=i1] [debug line = 59:3@135:19]
  %result = select i1 %tmp_10, i27 0, i27 %result_4_2_2_i, !dbg !2949 ; [#uses=1 type=i27] [debug line = 59:3@135:19]
  %result_cast1 = sext i27 %result to i31, !dbg !2949 ; [#uses=1 type=i31] [debug line = 59:3@135:19]
  %result_cast = zext i31 %result_cast1 to i32, !dbg !2949 ; [#uses=1 type=i32] [debug line = 59:3@135:19]
  call void @llvm.dbg.value(metadata !{i27 %result}, i64 0, metadata !2951), !dbg !2949 ; [debug line = 59:3@135:19] [debug variable = result]
  %tmp_data_V_2 = select i1 %tmp_8, i32 %result_cast, i32 %result_4_2_2_i_cast1, !dbg !2952 ; [#uses=1 type=i32] [debug line = 145:31@143:5]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_2}, i64 0, metadata !2956), !dbg !2958 ; [debug line = 251:64@135:19] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_2}, i64 0, metadata !2959), !dbg !2961 ; [debug line = 251:64@251:86@135:19] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %writeCount}, i64 0, metadata !2908), !dbg !2963 ; [debug line = 65:24@141:19] [debug variable = writeCount]
  %tmp_last_V = icmp eq i32 %writeCount, 784, !dbg !2964 ; [#uses=1 type=i1] [debug line = 66:2@141:19]
  call void @llvm.dbg.value(metadata !{i1 %tmp_last_V}, i64 0, metadata !2966), !dbg !2968 ; [debug line = 245:56@141:19] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i1 %tmp_last_V}, i64 0, metadata !2969), !dbg !2971 ; [debug line = 245:56@245:78@141:19] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32* %outStream_V_data_V}, i64 0, metadata !2973), !dbg !2975 ; [debug line = 144:48@143:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %outStream_V_keep_V}, i64 0, metadata !2976), !dbg !2975 ; [debug line = 144:48@143:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %outStream_V_strb_V}, i64 0, metadata !2977), !dbg !2975 ; [debug line = 144:48@143:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.strb.V]
  call void @llvm.dbg.value(metadata !{i2* %outStream_V_user_V}, i64 0, metadata !2978), !dbg !2975 ; [debug line = 144:48@143:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %outStream_V_last_V}, i64 0, metadata !2979), !dbg !2975 ; [debug line = 144:48@143:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.last.V]
  call void @llvm.dbg.value(metadata !{i5* %outStream_V_id_V}, i64 0, metadata !2980), !dbg !2975 ; [debug line = 144:48@143:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.id.V]
  call void @llvm.dbg.value(metadata !{i6* %outStream_V_dest_V}, i64 0, metadata !2981), !dbg !2975 ; [debug line = 144:48@143:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.dest.V]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_2}, i64 0, metadata !2982), !dbg !2952 ; [debug line = 145:31@143:5] [debug variable = tmp.data.V]
  call void @llvm.dbg.value(metadata !{i1 %tmp_last_V}, i64 0, metadata !2984), !dbg !2952 ; [debug line = 145:31@143:5] [debug variable = tmp.last.V]
  call void @_ssdm_op_Write.axis.volatile.i32P.i4P.i4P.i2P.i1P.i5P.i6P(i32* %outStream_V_data_V, i4* %outStream_V_keep_V, i4* %outStream_V_strb_V, i2* %outStream_V_user_V, i1* %outStream_V_last_V, i5* %outStream_V_id_V, i6* %outStream_V_dest_V, i32 %tmp_data_V_2, i4 -1, i4 0, i2 0, i1 %tmp_last_V, i5 0, i6 0), !dbg !2985 ; [debug line = 146:9@143:5]
  store i32 %writeCount, i32* %writeCount_1, !dbg !2963 ; [debug line = 65:24@141:19]
  br label %._crit_edge, !dbg !2986               ; [debug line = 144:4]

._crit_edge:                                      ; preds = %.preheader83, %_ifconv1
  %readCount_1_load = load i32* %readCount_1, !dbg !2987 ; [#uses=2 type=i32] [debug line = 154:4]
  %lineBuffer_0_addr_2 = getelementptr [30 x i32]* %lineBuffer_0, i32 0, i32 %x_assign_cast ; [#uses=2 type=i32*]
  %windowRightCol_0 = load i32* %lineBuffer_0_addr_2, align 4, !dbg !2988 ; [#uses=1 type=i32] [debug line = 147:4]
  call void @llvm.dbg.value(metadata !{i32 %windowRightCol_0}, i64 0, metadata !2989), !dbg !2988 ; [debug line = 147:4] [debug variable = windowRightCol[0]]
  %lineBuffer_1_addr_2 = getelementptr [30 x i32]* %lineBuffer_1, i32 0, i32 %x_assign_cast ; [#uses=2 type=i32*]
  %windowRightCol_1 = load i32* %lineBuffer_1_addr_2, align 4, !dbg !2992 ; [#uses=2 type=i32] [debug line = 149:5]
  store i32 %windowRightCol_1, i32* %lineBuffer_0_addr_2, align 4, !dbg !2992 ; [debug line = 149:5]
  call void @llvm.dbg.value(metadata !{i32 %windowRightCol_1}, i64 0, metadata !2995), !dbg !2992 ; [debug line = 149:5] [debug variable = windowRightCol[1]]
  %tmp_5 = icmp slt i32 %readCount_1_load, 900, !dbg !2987 ; [#uses=1 type=i1] [debug line = 154:4]
  store i32 %windowRightCol_0, i32* %window_0_1
  br i1 %tmp_5, label %4, label %._crit_edge88, !dbg !2987 ; [debug line = 154:4]

; <label>:4                                       ; preds = %._crit_edge
  call void @llvm.dbg.value(metadata !{i32* %inStream_V_data_V}, i64 0, metadata !2855), !dbg !2996 ; [debug line = 129:56@155:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_keep_V}, i64 0, metadata !2862), !dbg !2996 ; [debug line = 129:56@155:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_strb_V}, i64 0, metadata !2864), !dbg !2996 ; [debug line = 129:56@155:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.strb.V]
  call void @llvm.dbg.value(metadata !{i2* %inStream_V_user_V}, i64 0, metadata !2865), !dbg !2996 ; [debug line = 129:56@155:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %inStream_V_last_V}, i64 0, metadata !2867), !dbg !2996 ; [debug line = 129:56@155:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.last.V]
  call void @llvm.dbg.value(metadata !{i5* %inStream_V_id_V}, i64 0, metadata !2869), !dbg !2996 ; [debug line = 129:56@155:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.id.V]
  call void @llvm.dbg.value(metadata !{i6* %inStream_V_dest_V}, i64 0, metadata !2871), !dbg !2996 ; [debug line = 129:56@155:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.dest.V]
  %empty_12 = call { i32, i4, i4, i2, i1, i5, i6 } @_ssdm_op_Read.axis.volatile.i32P.i4P.i4P.i2P.i1P.i5P.i6P(i32* %inStream_V_data_V, i4* %inStream_V_keep_V, i4* %inStream_V_strb_V, i2* %inStream_V_user_V, i1* %inStream_V_last_V, i5* %inStream_V_id_V, i6* %inStream_V_dest_V), !dbg !2999 ; [#uses=1 type={ i32, i4, i4, i2, i1, i5, i6 }] [debug line = 131:9@155:13]
  %tmp_data_V_4 = extractvalue { i32, i4, i4, i2, i1, i5, i6 } %empty_12, 0, !dbg !2999 ; [#uses=1 type=i32] [debug line = 131:9@155:13]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_4}, i64 0, metadata !2875), !dbg !2999 ; [debug line = 131:9@155:13] [debug variable = tmp.data.V]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_4}, i64 0, metadata !3000), !dbg !3003 ; [debug line = 277:10@100:10@155:13] [debug variable = valIn.data.V]
  %readCount = add nsw i32 %readCount_1_load, 1, !dbg !3009 ; [#uses=1 type=i32] [debug line = 156:5]
  call void @llvm.dbg.value(metadata !{i32 %readCount}, i64 0, metadata !2913), !dbg !3009 ; [debug line = 156:5] [debug variable = readCount]
  store i32 %readCount, i32* %readCount_1, !dbg !3009 ; [debug line = 156:5]
  store i32 %tmp_data_V_4, i32* %window_2_1, !dbg !2999 ; [debug line = 131:9@155:13]
  br label %._crit_edge88, !dbg !3010             ; [debug line = 157:4]

._crit_edge88:                                    ; preds = %4, %._crit_edge
  %window_2_2_10 = load i32* %window_2_1          ; [#uses=1 type=i32]
  store i32 %window_2_2_10, i32* %lineBuffer_1_addr_2, align 4, !dbg !3011 ; [debug line = 158:51]
  call void @llvm.dbg.value(metadata !{i32 %window_1_0}, i64 0, metadata !3012), !dbg !3013 ; [debug line = 163:6] [debug variable = window[1][0]]
  call void @llvm.dbg.value(metadata !{i32 %window_1_1}, i64 0, metadata !2921), !dbg !3013 ; [debug line = 163:6] [debug variable = window[1][1]]
  call void @llvm.dbg.value(metadata !{i32 %window_2_0}, i64 0, metadata !3018), !dbg !3013 ; [debug line = 163:6] [debug variable = window[2][0]]
  call void @llvm.dbg.value(metadata !{i32 %window_2_1_2}, i64 0, metadata !2907), !dbg !3013 ; [debug line = 163:6] [debug variable = window[2][1]]
  call void @llvm.dbg.value(metadata !{i32 %windowRightCol_0}, i64 0, metadata !3019), !dbg !3020 ; [debug line = 169:5] [debug variable = window[0][2]]
  call void @llvm.dbg.value(metadata !{i32 %windowRightCol_1}, i64 0, metadata !2922), !dbg !3020 ; [debug line = 169:5] [debug variable = window[1][2]]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_10}, i64 0, metadata !2882), !dbg !3020 ; [debug line = 169:5] [debug variable = window[2][2]]
  %empty_13 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str9, i32 %tmp_3), !dbg !3023 ; [#uses=0 type=i32] [debug line = 171:3]
  %x_4 = add i5 %x_assign_mid2, 1, !dbg !3024     ; [#uses=1 type=i5] [debug line = 125:27]
  call void @llvm.dbg.value(metadata !{i5 %x_4}, i64 0, metadata !3025), !dbg !3024 ; [debug line = 125:27] [debug variable = x]
  br label %.preheader82, !dbg !3024              ; [debug line = 125:27]

.preheader83:                                     ; preds = %.preheader82
  %empty_14 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 900, i64 900, i64 900) ; [#uses=0 type=i32]
  %exitcond2 = icmp eq i5 %x_assign, -2, !dbg !3026 ; [#uses=4 type=i1] [debug line = 125:17]
  %x_assign_mid2 = select i1 %exitcond2, i5 0, i5 %x_assign ; [#uses=4 type=i5]
  %y_s = add i5 %y_assign, 1, !dbg !3027          ; [#uses=3 type=i5] [debug line = 124:26]
  %tmp_i_mid1 = icmp eq i5 %y_s, 0, !dbg !3028    ; [#uses=1 type=i1] [debug line = 40:2@129:9]
  %tmp_i = icmp eq i5 %y_assign, 0, !dbg !3028    ; [#uses=1 type=i1] [debug line = 40:2@129:9]
  %tmp_i_mid2 = select i1 %exitcond2, i1 %tmp_i_mid1, i1 %tmp_i, !dbg !3028 ; [#uses=1 type=i1] [debug line = 40:2@129:9]
  %tmp_2_i_mid1 = icmp ugt i5 %y_s, -4, !dbg !3028 ; [#uses=1 type=i1] [debug line = 40:2@129:9]
  %tmp_2_i = icmp ugt i5 %y_assign, -4, !dbg !3028 ; [#uses=1 type=i1] [debug line = 40:2@129:9]
  %tmp_2_i_mid2 = select i1 %exitcond2, i1 %tmp_2_i_mid1, i1 %tmp_2_i, !dbg !3028 ; [#uses=1 type=i1] [debug line = 40:2@129:9]
  %y_assign_mid2 = select i1 %exitcond2, i5 %y_s, i5 %y_assign ; [#uses=1 type=i5]
  %x_assign_cast = zext i5 %x_assign_mid2 to i32, !dbg !3026 ; [#uses=2 type=i32] [debug line = 125:17]
  %tmp_3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str9), !dbg !3034 ; [#uses=1 type=i32] [debug line = 125:33]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind, !dbg !3035 ; [debug line = 126:1]
  call void @llvm.dbg.value(metadata !{i5 %x_assign}, i64 0, metadata !3036), !dbg !3037 ; [debug line = 38:25@129:9] [debug variable = x]
  call void @llvm.dbg.value(metadata !{i5 %y_assign}, i64 0, metadata !3038), !dbg !3039 ; [debug line = 38:32@129:9] [debug variable = y]
  %tmp_i_15 = icmp eq i5 %x_assign_mid2, 0, !dbg !3028 ; [#uses=1 type=i1] [debug line = 40:2@129:9]
  %tmp_1_i = icmp ugt i5 %x_assign_mid2, -4, !dbg !3028 ; [#uses=1 type=i1] [debug line = 40:2@129:9]
  %tmp2 = or i1 %tmp_i_15, %tmp_i_mid2, !dbg !3028 ; [#uses=1 type=i1] [debug line = 40:2@129:9]
  %tmp3 = or i1 %tmp_1_i, %tmp_2_i_mid2, !dbg !3028 ; [#uses=1 type=i1] [debug line = 40:2@129:9]
  %p_i = or i1 %tmp3, %tmp2, !dbg !3028           ; [#uses=1 type=i1] [debug line = 40:2@129:9]
  br i1 %p_i, label %._crit_edge, label %_ifconv1, !dbg !3033 ; [debug line = 129:9]

; <label>:5                                       ; preds = %.preheader82
  ret void, !dbg !3040                            ; [debug line = 173:1]
}
...
entry:
  ...
  %empty_25 = shl i27 1, %empty                   ; [#uses=1 type=i27]
  %empty_26 = and i27 %0, %empty_25               ; [#uses=1 type=i27]
  %empty_27 = icmp ne i27 %empty_26, 0            ; [#uses=1 type=i1]
  ret i1 %empty_27
}
...
!67 = metadata !{i32 786473, metadata !"cnn_conv_d30x30_k3x3/fixed_point.h", metadata !"D:\5CSchool\5CProject\5Cnew_repo\5CHLS", null} ; [ DW_TAG_file_type ]
...
!71 = metadata !{i32 786473, metadata !"cnn_conv_d30x30_k3x3/core.cpp", metadata !"D:\5CSchool\5CProject\5Cnew_repo\5CHLS", null} ; [ DW_TAG_file_type ]
...
!202 = metadata !{i32 786689, metadata !203, metadata !"ctrl", metadata !71, i32 50331726, metadata !72, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!203 = metadata !{i32 786478, i32 0, metadata !71, metadata !"cnn_conv_d30x30_k3x3", metadata !"cnn_conv_d30x30_k3x3", metadata !"_Z20cnn_conv_d30x30_k3x3RN3hls6streamI7ap_axiuILi32ELi2ELi5ELi6EEEES4_jPj", metadata !71, i32 75, metadata !204, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !74, i32 80} ; [ DW_TAG_subprogram ]
...
!2717 = metadata !{i32 78, i32 10, metadata !203, null}
...
!2726 = metadata !{i32 135, i32 19, metadata !2727, null}
!2727 = metadata !{i32 786443, metadata !2728, i32 129, i32 24, metadata !71, i32 15} ; [ DW_TAG_lexical_block ]
!2728 = metadata !{i32 786443, metadata !2729, i32 125, i32 32, metadata !71, i32 14} ; [ DW_TAG_lexical_block ]
!2729 = metadata !{i32 786443, metadata !2730, i32 125, i32 3, metadata !71, i32 13} ; [ DW_TAG_lexical_block ]
!2730 = metadata !{i32 786443, metadata !2731, i32 124, i32 31, metadata !71, i32 12} ; [ DW_TAG_lexical_block ]
!2731 = metadata !{i32 786443, metadata !2732, i32 124, i32 2, metadata !71, i32 11} ; [ DW_TAG_lexical_block ]
!2732 = metadata !{i32 786443, metadata !203, i32 80, i32 1, metadata !71, i32 0} ; [ DW_TAG_lexical_block ]
!2733 = metadata !{i32 47, i32 53, metadata !2719, metadata !2726}
!2734 = metadata !{i32 790531, metadata !2735, metadata !"inStream.V.data.V", null, i32 76, metadata !2736, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2735 = metadata !{i32 786689, metadata !203, metadata !"inStream", metadata !71, i32 16777292, metadata !206, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
...
!2747 = metadata !{i32 76, i32 25, metadata !203, null}
!2748 = metadata !{i32 790531, metadata !2735, metadata !"inStream.V.keep.V", null, i32 76, metadata !2749, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
...
!2760 = metadata !{i32 790531, metadata !2735, metadata !"inStream.V.strb.V", null, i32 76, metadata !2749, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2761 = metadata !{i32 790531, metadata !2735, metadata !"inStream.V.user.V", null, i32 76, metadata !2762, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
...
!2773 = metadata !{i32 790531, metadata !2735, metadata !"inStream.V.last.V", null, i32 76, metadata !2774, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
...
!2785 = metadata !{i32 790531, metadata !2735, metadata !"inStream.V.id.V", null, i32 76, metadata !2786, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
...
!2797 = metadata !{i32 790531, metadata !2735, metadata !"inStream.V.dest.V", null, i32 76, metadata !2798, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
...
!2809 = metadata !{i32 790531, metadata !2810, metadata !"outStream.V.data.V", null, i32 77, metadata !2736, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2810 = metadata !{i32 786689, metadata !203, metadata !"outStream", metadata !71, i32 33554509, metadata !206, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2811 = metadata !{i32 77, i32 24, metadata !203, null}
!2812 = metadata !{i32 790531, metadata !2810, metadata !"outStream.V.keep.V", null, i32 77, metadata !2749, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2813 = metadata !{i32 790531, metadata !2810, metadata !"outStream.V.strb.V", null, i32 77, metadata !2749, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2814 = metadata !{i32 790531, metadata !2810, metadata !"outStream.V.user.V", null, i32 77, metadata !2762, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2815 = metadata !{i32 790531, metadata !2810, metadata !"outStream.V.last.V", null, i32 77, metadata !2774, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2816 = metadata !{i32 790531, metadata !2810, metadata !"outStream.V.id.V", null, i32 77, metadata !2786, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2817 = metadata !{i32 790531, metadata !2810, metadata !"outStream.V.dest.V", null, i32 77, metadata !2798, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2818 = metadata !{i32 790531, metadata !2819, metadata !"kernel[0]", null, i32 79, metadata !2823, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2819 = metadata !{i32 786689, metadata !203, metadata !"kernel", null, i32 79, metadata !2820, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
...
!2824 = metadata !{i32 79, i32 11, metadata !203, null}
!2825 = metadata !{i32 790531, metadata !2819, metadata !"kernel[1]", null, i32 79, metadata !2823, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2826 = metadata !{i32 790531, metadata !2819, metadata !"kernel[2]", null, i32 79, metadata !2823, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2827 = metadata !{i32 790531, metadata !2819, metadata !"kernel[3]", null, i32 79, metadata !2823, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2828 = metadata !{i32 790531, metadata !2819, metadata !"kernel[4]", null, i32 79, metadata !2823, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2829 = metadata !{i32 790531, metadata !2819, metadata !"kernel[5]", null, i32 79, metadata !2823, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2830 = metadata !{i32 790531, metadata !2819, metadata !"kernel[6]", null, i32 79, metadata !2823, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2831 = metadata !{i32 790531, metadata !2819, metadata !"kernel[7]", null, i32 79, metadata !2823, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2832 = metadata !{i32 790531, metadata !2819, metadata !"kernel[8]", null, i32 79, metadata !2823, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2833 = metadata !{i32 81, i32 1, metadata !2732, null}
!2834 = metadata !{i32 82, i32 1, metadata !2732, null}
!2835 = metadata !{i32 83, i32 1, metadata !2732, null}
!2836 = metadata !{i32 85, i32 1, metadata !2732, null}
!2837 = metadata !{i32 790529, metadata !2838, metadata !"lineBuffer[0]", null, i32 89, metadata !2843, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2838 = metadata !{i32 786688, metadata !2732, metadata !"lineBuffer", metadata !71, i32 89, metadata !2839, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2839 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1920, i64 32, i32 0, i32 0, metadata !70, metadata !2840, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2840 = metadata !{metadata !2841, metadata !2842}
!2841 = metadata !{i32 786465, i64 0, i64 1}      ; [ DW_TAG_subrange_type ]
!2842 = metadata !{i32 786465, i64 0, i64 29}     ; [ DW_TAG_subrange_type ]
!2843 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 960, i64 32, i32 0, i32 0, metadata !70, metadata !2840, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2844 = metadata !{i32 89, i32 12, metadata !2732, null}
!2845 = metadata !{i32 790529, metadata !2838, metadata !"lineBuffer[1]", null, i32 89, metadata !2843, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2846 = metadata !{i32 97, i32 39, metadata !2847, null}
!2847 = metadata !{i32 786443, metadata !2732, i32 97, i32 2, metadata !71, i32 1} ; [ DW_TAG_lexical_block ]
!2848 = metadata !{i32 105, i32 17, metadata !2849, null}
!2849 = metadata !{i32 786443, metadata !2850, i32 105, i32 3, metadata !71, i32 5} ; [ DW_TAG_lexical_block ]
!2850 = metadata !{i32 786443, metadata !2851, i32 104, i32 48, metadata !71, i32 4} ; [ DW_TAG_lexical_block ]
!2851 = metadata !{i32 786443, metadata !2732, i32 104, i32 2, metadata !71, i32 3} ; [ DW_TAG_lexical_block ]
!2852 = metadata !{i32 97, i32 55, metadata !2853, null}
!2853 = metadata !{i32 786443, metadata !2847, i32 97, i32 54, metadata !71, i32 2} ; [ DW_TAG_lexical_block ]
!2854 = metadata !{i32 98, i32 1, metadata !2853, null}
...
!2861 = metadata !{i32 99, i32 19, metadata !2853, null}
...
!2877 = metadata !{i32 100, i32 40, metadata !2853, null}
!2878 = metadata !{i32 101, i32 2, metadata !2853, null}
!2879 = metadata !{i32 97, i32 49, metadata !2847, null}
!2880 = metadata !{i32 786688, metadata !2847, metadata !"x", metadata !71, i32 97, metadata !240, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2881 = metadata !{i32 105, i32 27, metadata !2849, null}
!2882 = metadata !{i32 790529, metadata !2883, metadata !"window[2][2]", null, i32 90, metadata !2886, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2883 = metadata !{i32 786688, metadata !2732, metadata !"window", metadata !71, i32 90, metadata !2884, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!2887 = metadata !{i32 105, i32 33, metadata !2888, null}
!2888 = metadata !{i32 786443, metadata !2849, i32 105, i32 32, metadata !71, i32 6} ; [ DW_TAG_lexical_block ]
!2889 = metadata !{i32 106, i32 1, metadata !2888, null}
!2890 = metadata !{i32 129, i32 56, metadata !2857, metadata !2891}
!2891 = metadata !{i32 107, i32 19, metadata !2888, null}
!2892 = metadata !{i32 131, i32 9, metadata !2874, metadata !2891}
!2893 = metadata !{i32 108, i32 23, metadata !2888, null}
!2894 = metadata !{i32 109, i32 3, metadata !2888, null}
...
!2898 = metadata !{i32 790529, metadata !2883, metadata !"window[0][0]", null, i32 90, metadata !2886, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2899 = metadata !{i32 790529, metadata !2883, metadata !"window[0][1]", null, i32 90, metadata !2886, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
...
!2902 = metadata !{i32 119, i32 2, metadata !2903, null}
!2903 = metadata !{i32 786443, metadata !2904, i32 117, i32 45, metadata !71, i32 10} ; [ DW_TAG_lexical_block ]
!2904 = metadata !{i32 786443, metadata !2905, i32 117, i32 3, metadata !71, i32 9} ; [ DW_TAG_lexical_block ]
!2905 = metadata !{i32 786443, metadata !2906, i32 116, i32 44, metadata !71, i32 8} ; [ DW_TAG_lexical_block ]
!2906 = metadata !{i32 786443, metadata !2732, i32 116, i32 2, metadata !71, i32 7} ; [ DW_TAG_lexical_block ]
!2907 = metadata !{i32 790529, metadata !2883, metadata !"window[2][1]", null, i32 90, metadata !2886, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
...
!2912 = metadata !{i32 141, i32 19, metadata !2727, null}
!2913 = metadata !{i32 786688, metadata !2732, metadata !"readCount", metadata !71, i32 112, metadata !240, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!2916 = metadata !{i32 124, i32 16, metadata !2731, null}
!2917 = metadata !{i32 117, i32 31, metadata !2904, null}
!2918 = metadata !{i32 116, i32 39, metadata !2906, null}
!2919 = metadata !{i32 117, i32 46, metadata !2903, null}
!2920 = metadata !{i32 118, i32 1, metadata !2903, null}
!2921 = metadata !{i32 790529, metadata !2883, metadata !"window[1][1]", null, i32 90, metadata !2886, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2922 = metadata !{i32 790529, metadata !2883, metadata !"window[1][2]", null, i32 90, metadata !2886, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2923 = metadata !{i32 120, i32 3, metadata !2903, null}
!2924 = metadata !{i32 117, i32 40, metadata !2904, null}
!2925 = metadata !{i32 786688, metadata !2904, metadata !"x", metadata !71, i32 117, metadata !240, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!2931 = metadata !{i32 133, i32 5, metadata !2727, null}
!2932 = metadata !{i32 786688, metadata !2732, metadata !"writeCount", metadata !71, i32 113, metadata !240, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!2955 = metadata !{i32 143, i32 5, metadata !2727, null}
...
!2986 = metadata !{i32 144, i32 4, metadata !2727, null}
!2987 = metadata !{i32 154, i32 4, metadata !2728, null}
!2988 = metadata !{i32 147, i32 4, metadata !2728, null}
!2989 = metadata !{i32 790529, metadata !2990, metadata !"windowRightCol[0]", null, i32 91, metadata !2991, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2990 = metadata !{i32 786688, metadata !2732, metadata !"windowRightCol", metadata !71, i32 91, metadata !2723, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!2992 = metadata !{i32 149, i32 5, metadata !2993, null}
!2993 = metadata !{i32 786443, metadata !2994, i32 148, i32 36, metadata !71, i32 17} ; [ DW_TAG_lexical_block ]
!2994 = metadata !{i32 786443, metadata !2728, i32 148, i32 4, metadata !71, i32 16} ; [ DW_TAG_lexical_block ]
!2995 = metadata !{i32 790529, metadata !2990, metadata !"windowRightCol[1]", null, i32 91, metadata !2991, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2996 = metadata !{i32 129, i32 56, metadata !2857, metadata !2997}
!2997 = metadata !{i32 155, i32 13, metadata !2998, null}
!2998 = metadata !{i32 786443, metadata !2728, i32 154, i32 29, metadata !71, i32 18} ; [ DW_TAG_lexical_block ]
!2999 = metadata !{i32 131, i32 9, metadata !2874, metadata !2997}
!3000 = metadata !{i32 790529, metadata !3001, metadata !"valIn.data.V", null, i32 153, metadata !2739, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3001 = metadata !{i32 786688, metadata !2728, metadata !"valIn", metadata !71, i32 153, metadata !3002, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!3009 = metadata !{i32 156, i32 5, metadata !2998, null}
!3010 = metadata !{i32 157, i32 4, metadata !2998, null}
!3011 = metadata !{i32 158, i32 51, metadata !2728, null}
!3012 = metadata !{i32 790529, metadata !2883, metadata !"window[1][0]", null, i32 90, metadata !2886, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3013 = metadata !{i32 163, i32 6, metadata !3014, null}
!3014 = metadata !{i32 786443, metadata !3015, i32 162, i32 37, metadata !71, i32 22} ; [ DW_TAG_lexical_block ]
!3015 = metadata !{i32 786443, metadata !3016, i32 162, i32 5, metadata !71, i32 21} ; [ DW_TAG_lexical_block ]
!3016 = metadata !{i32 786443, metadata !3017, i32 161, i32 32, metadata !71, i32 20} ; [ DW_TAG_lexical_block ]
!3017 = metadata !{i32 786443, metadata !2728, i32 161, i32 4, metadata !71, i32 19} ; [ DW_TAG_lexical_block ]
!3018 = metadata !{i32 790529, metadata !2883, metadata !"window[2][0]", null, i32 90, metadata !2886, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3019 = metadata !{i32 790529, metadata !2883, metadata !"window[0][2]", null, i32 90, metadata !2886, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!3020 = metadata !{i32 169, i32 5, metadata !3021, null}
!3021 = metadata !{i32 786443, metadata !3022, i32 168, i32 32, metadata !71, i32 24} ; [ DW_TAG_lexical_block ]
!3022 = metadata !{i32 786443, metadata !2728, i32 168, i32 4, metadata !71, i32 23} ; [ DW_TAG_lexical_block ]
!3023 = metadata !{i32 171, i32 3, metadata !2728, null}
!3024 = metadata !{i32 125, i32 27, metadata !2729, null}
!3025 = metadata !{i32 786688, metadata !2729, metadata !"x", metadata !71, i32 125, metadata !240, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!3026 = metadata !{i32 125, i32 17, metadata !2729, null}
!3027 = metadata !{i32 124, i32 26, metadata !2731, null}
...
!3033 = metadata !{i32 129, i32 9, metadata !2728, null}
!3034 = metadata !{i32 125, i32 33, metadata !2728, null}
!3035 = metadata !{i32 126, i32 1, metadata !2728, null}
...
!3040 = metadata !{i32 173, i32 1, metadata !2732, null}
