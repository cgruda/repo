...
if {[file isfile cnn_pool_d4x4_p2x2.autotvin.dat]} {
	file delete -force cnn_pool_d4x4_p2x2.autotvin.dat
}

if {[file isfile cnn_pool_d4x4_p2x2.autotvout.dat]} {
	file delete -force cnn_pool_d4x4_p2x2.autotvout.dat
}
