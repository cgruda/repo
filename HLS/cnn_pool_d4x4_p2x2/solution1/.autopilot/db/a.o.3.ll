; ModuleID = 'D:/School/Project/new_repo/HLS/cnn_pool_d4x4_p2x2/solution1/.autopilot/db/a.o.3.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-f80:128:128-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S32"
target triple = "i686-pc-mingw32"

@llvm_global_ctors_1 = appending global [1 x void ()*] [void ()* @_GLOBAL__I_a] ; [#uses=0 type=[1 x void ()*]*]
@llvm_global_ctors_0 = appending global [1 x i32] [i32 65535] ; [#uses=0 type=[1 x i32]*]
@cnn_pool_d4x4_p2x2_s = internal unnamed_addr constant [19 x i8] c"cnn_pool_d4x4_p2x2\00" ; [#uses=1 type=[19 x i8]*]
...
define void @cnn_pool_d4x4_p2x2(i32* %inStream_V_data_V, i4* %inStream_V_keep_V, i4* %inStream_V_strb_V, i2* %inStream_V_user_V, i1* %inStream_V_last_V, i5* %inStream_V_id_V, i6* %inStream_V_dest_V, i32* %outStream_V_data_V, i4* %outStream_V_keep_V, i4* %outStream_V_strb_V, i2* %outStream_V_user_V, i1* %outStream_V_last_V, i5* %outStream_V_id_V, i6* %outStream_V_dest_V, i32 %ctrl) {
  ...
  br label %1, !dbg !2736                         ; [debug line = 103:42]

; <label>:1                                       ; preds = %_ifconv, %0
  %lineBuffer_0_3 = phi i32 [ undef, %0 ], [ %lineBuffer_0_3_1, %_ifconv ] ; [#uses=3 type=i32]
  %lineBuffer_0_2 = phi i32 [ undef, %0 ], [ %lineBuffer_0_3_4, %_ifconv ] ; [#uses=2 type=i32]
  %x = phi i3 [ 2, %0 ], [ %x_1, %_ifconv ]       ; [#uses=3 type=i3]
  %exitcond1 = icmp eq i3 %x, -4, !dbg !2736      ; [#uses=1 type=i1] [debug line = 103:42]
  br i1 %exitcond1, label %.preheader86.0.preheader, label %_ifconv, !dbg !2736 ; [debug line = 103:42]

.preheader86.0.preheader:                         ; preds = %1
  br label %.preheader86.0, !dbg !2738            ; [debug line = 111:17]

_ifconv:                                          ; preds = %1
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 2, i64 2, i64 2) ; [#uses=0 type=i32]
  %tmp_1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str6), !dbg !2742 ; [#uses=1 type=i32] [debug line = 103:57]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind, !dbg !2744 ; [debug line = 104:1]
  call void @llvm.dbg.value(metadata !{i32* %inStream_V_data_V}, i64 0, metadata !2745), !dbg !2750 ; [debug line = 129:56@105:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_keep_V}, i64 0, metadata !2752), !dbg !2750 ; [debug line = 129:56@105:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_strb_V}, i64 0, metadata !2754), !dbg !2750 ; [debug line = 129:56@105:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.strb.V]
  call void @llvm.dbg.value(metadata !{i2* %inStream_V_user_V}, i64 0, metadata !2755), !dbg !2750 ; [debug line = 129:56@105:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %inStream_V_last_V}, i64 0, metadata !2757), !dbg !2750 ; [debug line = 129:56@105:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.last.V]
  call void @llvm.dbg.value(metadata !{i5* %inStream_V_id_V}, i64 0, metadata !2759), !dbg !2750 ; [debug line = 129:56@105:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.id.V]
  call void @llvm.dbg.value(metadata !{i6* %inStream_V_dest_V}, i64 0, metadata !2761), !dbg !2750 ; [debug line = 129:56@105:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.dest.V]
  %empty_5 = call { i32, i4, i4, i2, i1, i5, i6 } @_ssdm_op_Read.axis.volatile.i32P.i4P.i4P.i2P.i1P.i5P.i6P(i32* %inStream_V_data_V, i4* %inStream_V_keep_V, i4* %inStream_V_strb_V, i2* %inStream_V_user_V, i1* %inStream_V_last_V, i5* %inStream_V_id_V, i6* %inStream_V_dest_V), !dbg !2763 ; [#uses=1 type={ i32, i4, i4, i2, i1, i5, i6 }] [debug line = 131:9@105:19]
  %tmp_data_V_2 = extractvalue { i32, i4, i4, i2, i1, i5, i6 } %empty_5, 0, !dbg !2763 ; [#uses=2 type=i32] [debug line = 131:9@105:19]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_2}, i64 0, metadata !2765), !dbg !2763 ; [debug line = 131:9@105:19] [debug variable = tmp.data.V]
  %tmp_7 = trunc i3 %x to i2                      ; [#uses=1 type=i2]
  %cond = icmp eq i2 %tmp_7, -2, !dbg !2767       ; [#uses=2 type=i1] [debug line = 106:44]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_2}, i64 0, metadata !2768), !dbg !2767 ; [debug line = 106:44] [debug variable = lineBuffer[0][2]]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_2}, i64 0, metadata !2776), !dbg !2767 ; [debug line = 106:44] [debug variable = lineBuffer[0][3]]
  %lineBuffer_0_3_1 = select i1 %cond, i32 %lineBuffer_0_3, i32 %tmp_data_V_2 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_0_3_1}, i64 0, metadata !2776), !dbg !2767 ; [debug line = 106:44] [debug variable = lineBuffer[0][3]]
  %lineBuffer_0_3_4 = select i1 %cond, i32 %tmp_data_V_2, i32 %lineBuffer_0_2 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_0_3_4}, i64 0, metadata !2776), !dbg !2767 ; [debug line = 106:44] [debug variable = lineBuffer[0][3]]
  %empty_6 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str6, i32 %tmp_1), !dbg !2777 ; [#uses=0 type=i32] [debug line = 107:2]
  %x_1 = add i3 1, %x, !dbg !2778                 ; [#uses=1 type=i3] [debug line = 103:51]
  call void @llvm.dbg.value(metadata !{i3 %x_1}, i64 0, metadata !2779), !dbg !2778 ; [debug line = 103:51] [debug variable = x]
  br label %1, !dbg !2778                         ; [debug line = 103:51]
...
.preheader86.0:                                   ; preds = %_ifconv5, %.preheader86.0.preheader
  ...
  %lineBuffer_1_2 = phi i32 [ %lineBuffer_1_3_4, %_ifconv5 ], [ undef, %.preheader86.0.preheader ] ; [#uses=3 type=i32]
  %lineBuffer_1_3_5 = phi i32 [ %lineBuffer_1_3_7, %_ifconv5 ], [ undef, %.preheader86.0.preheader ] ; [#uses=4 type=i32]
  %lineBuffer_1_3_8 = phi i32 [ %lineBuffer_1_3_9, %_ifconv5 ], [ undef, %.preheader86.0.preheader ] ; [#uses=3 type=i32]
  %x1 = phi i3 [ %x_2, %_ifconv5 ], [ 0, %.preheader86.0.preheader ] ; [#uses=3 type=i3]
  %exitcond4 = icmp eq i3 %x1, -4, !dbg !2738     ; [#uses=1 type=i1] [debug line = 111:17]
  %x_2 = add i3 %x1, 1, !dbg !2780                ; [#uses=1 type=i3] [debug line = 111:26]
  br i1 %exitcond4, label %.preheader84.preheader, label %_ifconv5, !dbg !2738 ; [debug line = 111:17]
...
_ifconv5:                                         ; preds = %.preheader86.0
  ...
  %tmp_2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str7), !dbg !2781 ; [#uses=1 type=i32] [debug line = 111:32]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind, !dbg !2783 ; [debug line = 112:1]
  call void @llvm.dbg.value(metadata !{i32* %inStream_V_data_V}, i64 0, metadata !2745), !dbg !2784 ; [debug line = 129:56@113:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_keep_V}, i64 0, metadata !2752), !dbg !2784 ; [debug line = 129:56@113:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_strb_V}, i64 0, metadata !2754), !dbg !2784 ; [debug line = 129:56@113:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.strb.V]
  call void @llvm.dbg.value(metadata !{i2* %inStream_V_user_V}, i64 0, metadata !2755), !dbg !2784 ; [debug line = 129:56@113:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %inStream_V_last_V}, i64 0, metadata !2757), !dbg !2784 ; [debug line = 129:56@113:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.last.V]
  call void @llvm.dbg.value(metadata !{i5* %inStream_V_id_V}, i64 0, metadata !2759), !dbg !2784 ; [debug line = 129:56@113:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.id.V]
  call void @llvm.dbg.value(metadata !{i6* %inStream_V_dest_V}, i64 0, metadata !2761), !dbg !2784 ; [debug line = 129:56@113:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.dest.V]
  %empty_8 = call { i32, i4, i4, i2, i1, i5, i6 } @_ssdm_op_Read.axis.volatile.i32P.i4P.i4P.i2P.i1P.i5P.i6P(i32* %inStream_V_data_V, i4* %inStream_V_keep_V, i4* %inStream_V_strb_V, i2* %inStream_V_user_V, i1* %inStream_V_last_V, i5* %inStream_V_id_V, i6* %inStream_V_dest_V), !dbg !2786 ; [#uses=1 type={ i32, i4, i4, i2, i1, i5, i6 }] [debug line = 131:9@113:19]
  %tmp_data_V_3 = extractvalue { i32, i4, i4, i2, i1, i5, i6 } %empty_8, 0, !dbg !2786 ; [#uses=4 type=i32] [debug line = 131:9@113:19]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_3}, i64 0, metadata !2765), !dbg !2786 ; [debug line = 131:9@113:19] [debug variable = tmp.data.V]
  %tmp_9 = trunc i3 %x1 to i2                     ; [#uses=3 type=i2]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_3}, i64 0, metadata !2787), !dbg !2788 ; [debug line = 114:23] [debug variable = lineBuffer[1][3]]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_3}, i64 0, metadata !2789), !dbg !2788 ; [debug line = 114:23] [debug variable = lineBuffer[1][0]]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_3}, i64 0, metadata !2790), !dbg !2788 ; [debug line = 114:23] [debug variable = lineBuffer[1][1]]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_3}, i64 0, metadata !2791), !dbg !2788 ; [debug line = 114:23] [debug variable = lineBuffer[1][2]]
  ...
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_1_3_2}, i64 0, metadata !2787), !dbg !2788 ; [debug line = 114:23] [debug variable = lineBuffer[1][3]]
  ...
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_1_3_4}, i64 0, metadata !2787), !dbg !2788 ; [debug line = 114:23] [debug variable = lineBuffer[1][3]]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_1_3_5}, i64 0, metadata !2787), !dbg !2788 ; [debug line = 114:23] [debug variable = lineBuffer[1][3]]
  %lineBuffer_1_3_6 = select i1 %sel_tmp7, i32 %tmp_data_V_3, i32 %lineBuffer_1_3_5 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_1_3_6}, i64 0, metadata !2787), !dbg !2788 ; [debug line = 114:23] [debug variable = lineBuffer[1][3]]
  %lineBuffer_1_3_7 = select i1 %sel_tmp9, i32 %lineBuffer_1_3_5, i32 %lineBuffer_1_3_6 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_1_3_7}, i64 0, metadata !2787), !dbg !2788 ; [debug line = 114:23] [debug variable = lineBuffer[1][3]]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_1_3_8}, i64 0, metadata !2787), !dbg !2788 ; [debug line = 114:23] [debug variable = lineBuffer[1][3]]
  %lineBuffer_1_3_9 = select i1 %sel_tmp9, i32 %tmp_data_V_3, i32 %lineBuffer_1_3_8 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_1_3_9}, i64 0, metadata !2787), !dbg !2788 ; [debug line = 114:23] [debug variable = lineBuffer[1][3]]
  %empty_9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str7, i32 %tmp_2), !dbg !2792 ; [#uses=0 type=i32] [debug line = 115:3]
  br label %.preheader86.0, !dbg !2780            ; [debug line = 111:26]

.preheader83.preheader:                           ; preds = %.preheader84
  %window_0_0_read_as = alloca i32                ; [#uses=2 type=i32*]
  call void @llvm.dbg.declare(metadata !{i32* %window_0_0_read_as}, metadata !2793) ; [debug variable = window[0][0]]
  %window_0_0 = alloca i32                        ; [#uses=2 type=i32*]
  call void @llvm.dbg.declare(metadata !{i32* %window_0_0}, metadata !2812) ; [debug variable = window[0][0]]
  %window_0_1 = alloca i32                        ; [#uses=2 type=i32*]
  call void @llvm.dbg.declare(metadata !{i32* %window_0_1}, metadata !2814) ; [debug variable = window[0][1]]
  %window_1_0_read_as = alloca i32                ; [#uses=2 type=i32*]
  call void @llvm.dbg.declare(metadata !{i32* %window_1_0_read_as}, metadata !2815) ; [debug variable = window[1][0]]
  %lineBuffer_0_3_5 = alloca i32                  ; [#uses=2 type=i32*]
  call void @llvm.dbg.declare(metadata !{i32* %lineBuffer_0_3_5}, metadata !2776) ; [debug variable = lineBuffer[0][3]]
  %lineBuffer_0_3_8 = alloca i32                  ; [#uses=2 type=i32*]
  call void @llvm.dbg.declare(metadata !{i32* %lineBuffer_0_3_8}, metadata !2776) ; [debug variable = lineBuffer[0][3]]
  %writeCount_1 = alloca i32                      ; [#uses=3 type=i32*]
  call void @llvm.dbg.declare(metadata !{i32* %writeCount_1}, metadata !2816) ; [debug variable = writeCount]
  %readCount_1 = alloca i32                       ; [#uses=3 type=i32*]
  call void @llvm.dbg.declare(metadata !{i32* %readCount_1}, metadata !2821) ; [debug variable = readCount]
  %window_2_2_2 = alloca i32                      ; [#uses=2 type=i32*]
  call void @llvm.dbg.declare(metadata !{i32* %window_2_2_2}, metadata !2822) ; [debug variable = window[2][2]]
  %tmp_10 = trunc i32 %ctrl_read to i1, !dbg !2806 ; [#uses=1 type=i1] [debug line = 141:19]
  store i32 6, i32* %readCount_1
  store i32 0, i32* %writeCount_1
  br label %.preheader82, !dbg !2823              ; [debug line = 130:16]
...
.preheader84:                                     ; preds = %.preheader85, %.preheader84.preheader
  ...
  %window_1_2_1 = phi i32 [ %window_2_2_3, %.preheader85 ], [ undef, %.preheader84.preheader ] ; [#uses=3 type=i32]
  %window_1_1_1 = phi i32 [ %window_2_2_4, %.preheader85 ], [ undef, %.preheader84.preheader ] ; [#uses=3 type=i32]
...
.preheader85:                                     ; preds = %.preheader84
  ...
  %exitcond = icmp eq i2 %x4, -1, !dbg !2824      ; [#uses=3 type=i1] [debug line = 123:35]
  %x4_mid2 = select i1 %exitcond, i2 1, i2 %x4    ; [#uses=6 type=i2]
  %y9 = add i2 1, %y3, !dbg !2828                 ; [#uses=1 type=i2] [debug line = 122:47]
  %tmp_3_mid2_v = select i1 %exitcond, i2 %y9, i2 %y3, !dbg !2829 ; [#uses=2 type=i2] [debug line = 125:2]
  %tmp_11 = trunc i2 %tmp_3_mid2_v to i1, !dbg !2829 ; [#uses=2 type=i1] [debug line = 125:2]
  %cond1_mid1 = icmp eq i2 %y3, 0, !dbg !2829     ; [#uses=1 type=i1] [debug line = 125:2]
  %cond1 = icmp eq i2 %y3, 1, !dbg !2829          ; [#uses=1 type=i1] [debug line = 125:2]
  %cond1_mid2 = select i1 %exitcond, i1 %cond1_mid1, i1 %cond1, !dbg !2829 ; [#uses=2 type=i1] [debug line = 125:2]
  %sel_tmp13_mid2 = xor i1 %tmp_11, true, !dbg !2829 ; [#uses=2 type=i1] [debug line = 125:2]
  %tmp_4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str8), !dbg !2831 ; [#uses=1 type=i32] [debug line = 123:54]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind, !dbg !2832 ; [debug line = 124:1]
  %sel_tmp5 = icmp ne i2 %x4_mid2, 1, !dbg !2829  ; [#uses=1 type=i1] [debug line = 125:2]
  %sel_tmp6 = icmp ne i2 %x4_mid2, -2, !dbg !2829 ; [#uses=1 type=i1] [debug line = 125:2]
  %sel_tmp8 = icmp ne i2 %x4_mid2, -1, !dbg !2829 ; [#uses=1 type=i1] [debug line = 125:2]
  %tmp = and i1 %tmp_11, %sel_tmp5                ; [#uses=1 type=i1]
  %tmp1 = and i1 %sel_tmp6, %sel_tmp8             ; [#uses=1 type=i1]
  %sel_tmp1 = and i1 %tmp1, %tmp                  ; [#uses=1 type=i1]
  %sel_tmp2 = select i1 %sel_tmp1, i32 %lineBuffer_0_3, i32 %lineBuffer_1_3, !dbg !2829 ; [#uses=1 type=i32] [debug line = 125:2]
  %sel_tmp3 = icmp eq i2 %x4_mid2, -2, !dbg !2829 ; [#uses=1 type=i1] [debug line = 125:2]
  %sel_tmp4 = and i1 %sel_tmp3, %sel_tmp13_mid2   ; [#uses=1 type=i1]
  %sel_tmp10 = select i1 %sel_tmp4, i32 %lineBuffer_1_3_5, i32 %sel_tmp2, !dbg !2829 ; [#uses=2 type=i32] [debug line = 125:2]
  %sel_tmp11 = icmp eq i2 %x4_mid2, 1, !dbg !2829 ; [#uses=3 type=i1] [debug line = 125:2]
  %sel_tmp12 = and i1 %sel_tmp11, %sel_tmp13_mid2 ; [#uses=1 type=i1]
  %window_2_2_7 = select i1 %sel_tmp12, i32 %lineBuffer_1_3_8, i32 %sel_tmp10, !dbg !2829 ; [#uses=1 type=i32] [debug line = 125:2]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_7}, i64 0, metadata !2822), !dbg !2829 ; [debug line = 125:2] [debug variable = window[2][2]]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_7}, i64 0, metadata !2833), !dbg !2829 ; [debug line = 125:2] [debug variable = window[2][1]]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_7}, i64 0, metadata !2834), !dbg !2829 ; [debug line = 125:2] [debug variable = window[1][1]]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_7}, i64 0, metadata !2835), !dbg !2829 ; [debug line = 125:2] [debug variable = window[1][2]]
  %window_2_2 = select i1 %sel_tmp11, i32 %window_1_2_1, i32 %sel_tmp10, !dbg !2829 ; [#uses=1 type=i32] [debug line = 125:2]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2}, i64 0, metadata !2822), !dbg !2829 ; [debug line = 125:2] [debug variable = window[2][2]]
  %window_2_2_1 = select i1 %sel_tmp11, i32 %window_2_2_7, i32 %window_1_1_1, !dbg !2829 ; [#uses=1 type=i32] [debug line = 125:2]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_1}, i64 0, metadata !2822), !dbg !2829 ; [debug line = 125:2] [debug variable = window[2][2]]
  %window_2_2_3 = select i1 %cond1_mid2, i32 %window_2_2, i32 %window_1_2_1 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_3}, i64 0, metadata !2822), !dbg !2829 ; [debug line = 125:2] [debug variable = window[2][2]]
  %window_2_2_4 = select i1 %cond1_mid2, i32 %window_2_2_1, i32 %window_1_1_1 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_4}, i64 0, metadata !2822), !dbg !2829 ; [debug line = 125:2] [debug variable = window[2][2]]
  %empty_11 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str8, i32 %tmp_4), !dbg !2836 ; [#uses=0 type=i32] [debug line = 126:3]
  %x_3 = add i2 1, %x4_mid2, !dbg !2837           ; [#uses=1 type=i2] [debug line = 123:48]
  call void @llvm.dbg.value(metadata !{i2 %x_3}, i64 0, metadata !2838), !dbg !2837 ; [debug line = 123:48] [debug variable = x]
  br label %.preheader84, !dbg !2837              ; [debug line = 123:48]
...
.preheader82:                                     ; preds = %._crit_edge88_ifconv, %.preheader83.preheader
  ...
  %y_assign = phi i3 [ 0, %.preheader83.preheader ], [ %y_assign_cast_mid2_v, %._crit_edge88_ifconv ] ; [#uses=2 type=i3]
  ...
  %window_1_1 = phi i32 [ %window_1_2_1, %.preheader83.preheader ], [ %lineBuffer_0_3_15, %._crit_edge88_ifconv ] ; [#uses=1 type=i32]
  %window_1_0 = phi i32 [ %window_1_1_1, %.preheader83.preheader ], [ %window_1_1, %._crit_edge88_ifconv ] ; [#uses=4 type=i32]
  %x_assign = phi i3 [ 0, %.preheader83.preheader ], [ %x_4, %._crit_edge88_ifconv ] ; [#uses=2 type=i3]
  %window_0_0_read_as_1 = load i32* %window_0_0_read_as, !dbg !2839 ; [#uses=3 type=i32] [debug line = 62:4@141:19]
  %window_0_0_load = load i32* %window_0_0, !dbg !2839 ; [#uses=4 type=i32] [debug line = 62:4@141:19]
  %window_0_1_load = load i32* %window_0_1        ; [#uses=1 type=i32]
  %window_1_0_read_as_1 = load i32* %window_1_0_read_as, !dbg !2839 ; [#uses=3 type=i32] [debug line = 62:4@141:19]
...
_ifconv87:                                        ; preds = %.preheader83
  %writeCount_1_load = load i32* %writeCount_1, !dbg !2845 ; [#uses=1 type=i32] [debug line = 139:5]
  %writeCount = add nsw i32 %writeCount_1_load, 1, !dbg !2845 ; [#uses=2 type=i32] [debug line = 139:5]
  call void @llvm.dbg.value(metadata !{i32 %writeCount}, i64 0, metadata !2846), !dbg !2845 ; [debug line = 139:5] [debug variable = writeCount]
  call void @llvm.dbg.value(metadata !{i32 %window_1_0}, i64 0, metadata !2847), !dbg !2848 ; [debug line = 51:44@141:19] [debug variable = window[1][1]]
  call void @llvm.dbg.value(metadata !{i1 %tmp_10}, i64 0, metadata !2849), !dbg !2850 ; [debug line = 51:84@141:19] [debug variable = op]
  %tmp_4_0_1_i = icmp ugt i32 %window_0_0_load, %window_0_0_read_as_1, !dbg !2851 ; [#uses=1 type=i1] [debug line = 59:4@141:19]
  %maxValue_0_1_maxVal = select i1 %tmp_4_0_1_i, i32 %window_0_0_load, i32 %window_0_0_read_as_1, !dbg !2851 ; [#uses=2 type=i32] [debug line = 59:4@141:19]
  %tmp_4_1_i = icmp ult i32 %maxValue_0_1_maxVal, %window_1_0_read_as_1, !dbg !2851 ; [#uses=1 type=i1] [debug line = 59:4@141:19]
  %maxValue_17_0_maxVal = select i1 %tmp_4_1_i, i32 %window_1_0_read_as_1, i32 %maxValue_0_1_maxVal, !dbg !2851 ; [#uses=2 type=i32] [debug line = 59:4@141:19]
  %tmp_4_1_1_i = icmp ult i32 %maxValue_17_0_maxVal, %window_1_0, !dbg !2851 ; [#uses=1 type=i1] [debug line = 59:4@141:19]
  %sel_SEBB_i = select i1 %tmp_4_1_1_i, i32 %window_1_0, i32 %maxValue_17_0_maxVal, !dbg !2851 ; [#uses=1 type=i32] [debug line = 59:4@141:19]
  %tmp6 = add i32 %window_0_0_read_as_1, %window_1_0_read_as_1, !dbg !2839 ; [#uses=1 type=i32] [debug line = 62:4@141:19]
  %tmp7 = add i32 %window_0_0_load, %window_1_0, !dbg !2839 ; [#uses=1 type=i32] [debug line = 62:4@141:19]
  %a_assign = add i32 %tmp7, %tmp6, !dbg !2839    ; [#uses=3 type=i32] [debug line = 62:4@141:19]
  call void @llvm.dbg.value(metadata !{i32 %a_assign}, i64 0, metadata !2852), !dbg !2859 ; [debug line = 69:44@69:12@141:19] [debug variable = a]
  %tmp_14 = call i1 @_ssdm_op_BitSelect.i1.i32.i32(i32 %a_assign, i32 31), !dbg !2860 ; [#uses=2 type=i1] [debug line = 74:2@69:12@141:19]
  %tmp_1_i_i = sub i32 0, %a_assign, !dbg !2860   ; [#uses=1 type=i32] [debug line = 74:2@69:12@141:19]
  %tmp_3 = call i20 @_ssdm_op_PartSelect.i20.i32.i32.i32(i32 %tmp_1_i_i, i32 2, i32 21), !dbg !2862 ; [#uses=1 type=i20] [debug line = 77:2@69:12@141:19]
  %tmp_6 = call i20 @_ssdm_op_PartSelect.i20.i32.i32.i32(i32 %a_assign, i32 2, i32 21), !dbg !2862 ; [#uses=1 type=i20] [debug line = 77:2@69:12@141:19]
  %result = select i1 %tmp_14, i20 %tmp_3, i20 %tmp_6, !dbg !2860 ; [#uses=1 type=i20] [debug line = 74:2@69:12@141:19]
  %result_cast = zext i20 %result to i21, !dbg !2862 ; [#uses=2 type=i21] [debug line = 77:2@69:12@141:19]
  call void @llvm.dbg.value(metadata !{i20 %result}, i64 0, metadata !2863), !dbg !2862 ; [debug line = 77:2@69:12@141:19] [debug variable = result]
  %tmp_4_i_i = sub i21 0, %result_cast, !dbg !2864 ; [#uses=1 type=i21] [debug line = 79:2@69:12@141:19]
  %result_1 = select i1 %tmp_14, i21 %tmp_4_i_i, i21 %result_cast, !dbg !2864 ; [#uses=1 type=i21] [debug line = 79:2@69:12@141:19]
  %result_1_cast = sext i21 %result_1 to i32, !dbg !2864 ; [#uses=1 type=i32] [debug line = 79:2@69:12@141:19]
  call void @llvm.dbg.value(metadata !{i21 %result_1}, i64 0, metadata !2863), !dbg !2864 ; [debug line = 79:2@69:12@141:19] [debug variable = result]
  call void @llvm.dbg.value(metadata !{i21 %result_1}, i64 0, metadata !2865), !dbg !2857 ; [debug line = 69:12@141:19] [debug variable = result]
  %tmp_data_V = select i1 %tmp_10, i32 %result_1_cast, i32 %sel_SEBB_i, !dbg !2866 ; [#uses=1 type=i32] [debug line = 145:31@149:5]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V}, i64 0, metadata !2870), !dbg !2872 ; [debug line = 251:64@141:19] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V}, i64 0, metadata !2873), !dbg !2875 ; [debug line = 251:64@251:86@141:19] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %writeCount}, i64 0, metadata !2816), !dbg !2877 ; [debug line = 75:24@147:19] [debug variable = writeCount]
  %tmp_last_V = icmp eq i32 %writeCount, 4, !dbg !2878 ; [#uses=1 type=i1] [debug line = 76:2@147:19]
  call void @llvm.dbg.value(metadata !{i1 %tmp_last_V}, i64 0, metadata !2880), !dbg !2882 ; [debug line = 245:56@147:19] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i1 %tmp_last_V}, i64 0, metadata !2883), !dbg !2885 ; [debug line = 245:56@245:78@147:19] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32* %outStream_V_data_V}, i64 0, metadata !2887), !dbg !2889 ; [debug line = 144:48@149:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %outStream_V_keep_V}, i64 0, metadata !2890), !dbg !2889 ; [debug line = 144:48@149:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %outStream_V_strb_V}, i64 0, metadata !2891), !dbg !2889 ; [debug line = 144:48@149:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.strb.V]
  call void @llvm.dbg.value(metadata !{i2* %outStream_V_user_V}, i64 0, metadata !2892), !dbg !2889 ; [debug line = 144:48@149:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %outStream_V_last_V}, i64 0, metadata !2893), !dbg !2889 ; [debug line = 144:48@149:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.last.V]
  call void @llvm.dbg.value(metadata !{i5* %outStream_V_id_V}, i64 0, metadata !2894), !dbg !2889 ; [debug line = 144:48@149:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.id.V]
  call void @llvm.dbg.value(metadata !{i6* %outStream_V_dest_V}, i64 0, metadata !2895), !dbg !2889 ; [debug line = 144:48@149:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.dest.V]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V}, i64 0, metadata !2896), !dbg !2866 ; [debug line = 145:31@149:5] [debug variable = tmp.data.V]
  call void @llvm.dbg.value(metadata !{i1 %tmp_last_V}, i64 0, metadata !2898), !dbg !2866 ; [debug line = 145:31@149:5] [debug variable = tmp.last.V]
  call void @_ssdm_op_Write.axis.volatile.i32P.i4P.i4P.i2P.i1P.i5P.i6P(i32* %outStream_V_data_V, i4* %outStream_V_keep_V, i4* %outStream_V_strb_V, i2* %outStream_V_user_V, i1* %outStream_V_last_V, i5* %outStream_V_id_V, i6* %outStream_V_dest_V, i32 %tmp_data_V, i4 -1, i4 0, i2 0, i1 %tmp_last_V, i5 0, i6 0), !dbg !2899 ; [debug line = 146:9@149:5]
  store i32 %writeCount, i32* %writeCount_1, !dbg !2877 ; [debug line = 75:24@147:19]
  br label %._crit_edge_ifconv, !dbg !2900        ; [debug line = 150:4]

._crit_edge_ifconv:                               ; preds = %.preheader83, %_ifconv87
  %lineBuffer_0_3_5_l = load i32* %lineBuffer_0_3_5 ; [#uses=2 type=i32]
  %lineBuffer_0_3_8_l = load i32* %lineBuffer_0_3_8 ; [#uses=3 type=i32]
  %readCount_1_load = load i32* %readCount_1, !dbg !2901 ; [#uses=2 type=i32] [debug line = 160:4]
  %tmp_15 = trunc i3 %x_assign_mid2 to i2         ; [#uses=5 type=i2]
  %windowRightCol_0 = call i32 @_ssdm_op_Mux.ap_auto.4i32.i2(i32 %lineBuffer_0_3_5_l, i32 %lineBuffer_0_3_8_l, i32 %lineBuffer_0_2_s, i32 %lineBuffer_0_3_3, i2 %tmp_15) ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %windowRightCol_0}, i64 0, metadata !2902), !dbg !2905 ; [debug line = 153:4] [debug variable = windowRightCol[0]]
  %lineBuffer_0_3_15 = call i32 @_ssdm_op_Mux.ap_auto.4i32.i2(i32 %lineBuffer_1_3_1, i32 %lineBuffer_1_3_17, i32 %lineBuffer_1_2_3, i32 %lineBuffer_1_3_3, i2 %tmp_15) ; [#uses=5 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_0_3_15}, i64 0, metadata !2776), !dbg !2906 ; [debug line = 155:5] [debug variable = lineBuffer[0][3]]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_0_3_15}, i64 0, metadata !2909), !dbg !2906 ; [debug line = 155:5] [debug variable = lineBuffer[0][0]]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_0_3_15}, i64 0, metadata !2910), !dbg !2906 ; [debug line = 155:5] [debug variable = lineBuffer[0][1]]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_0_3_15}, i64 0, metadata !2768), !dbg !2906 ; [debug line = 155:5] [debug variable = lineBuffer[0][2]]
  %sel_tmp13 = icmp eq i2 %tmp_15, -2             ; [#uses=4 type=i1]
  %sel_tmp14 = icmp eq i2 %tmp_15, 1              ; [#uses=3 type=i1]
  %sel_tmp15 = icmp eq i2 %tmp_15, 0              ; [#uses=5 type=i1]
  %or_cond2 = or i1 %sel_tmp15, %sel_tmp14        ; [#uses=4 type=i1]
  %newSel4 = select i1 %sel_tmp13, i32 %lineBuffer_0_3_3, i32 %lineBuffer_0_3_15 ; [#uses=1 type=i32]
  %lineBuffer_0_3_6 = select i1 %or_cond2, i32 %lineBuffer_0_3_3, i32 %newSel4 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_0_3_6}, i64 0, metadata !2776), !dbg !2767 ; [debug line = 106:44] [debug variable = lineBuffer[0][3]]
  %newSel6 = select i1 %sel_tmp13, i32 %lineBuffer_0_3_15, i32 %lineBuffer_0_2_s ; [#uses=1 type=i32]
  %lineBuffer_0_3_7 = select i1 %or_cond2, i32 %lineBuffer_0_2_s, i32 %newSel6 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_0_3_7}, i64 0, metadata !2776), !dbg !2906 ; [debug line = 155:5] [debug variable = lineBuffer[0][3]]
  %lineBuffer_0_3_9 = select i1 %sel_tmp14, i32 %lineBuffer_0_3_15, i32 %lineBuffer_0_3_8_l ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_0_3_9}, i64 0, metadata !2776), !dbg !2906 ; [debug line = 155:5] [debug variable = lineBuffer[0][3]]
  %lineBuffer_0_3_13 = select i1 %sel_tmp15, i32 %lineBuffer_0_3_8_l, i32 %lineBuffer_0_3_9 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_0_3_13}, i64 0, metadata !2776), !dbg !2906 ; [debug line = 155:5] [debug variable = lineBuffer[0][3]]
  %lineBuffer_0_3_14 = select i1 %sel_tmp15, i32 %lineBuffer_0_3_15, i32 %lineBuffer_0_3_5_l ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_0_3_14}, i64 0, metadata !2776), !dbg !2906 ; [debug line = 155:5] [debug variable = lineBuffer[0][3]]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_0_3_15}, i64 0, metadata !2911), !dbg !2906 ; [debug line = 155:5] [debug variable = windowRightCol[1]]
  %tmp_16 = call i28 @_ssdm_op_PartSelect.i28.i32.i32.i32(i32 %readCount_1_load, i32 4, i32 31), !dbg !2901 ; [#uses=1 type=i28] [debug line = 160:4]
  %icmp = icmp slt i28 %tmp_16, 1, !dbg !2901     ; [#uses=1 type=i1] [debug line = 160:4]
  ...
  br i1 %icmp, label %2, label %._crit_edge88_ifconv, !dbg !2901 ; [debug line = 160:4]

; <label>:2                                       ; preds = %._crit_edge_ifconv
  call void @llvm.dbg.value(metadata !{i32* %inStream_V_data_V}, i64 0, metadata !2745), !dbg !2912 ; [debug line = 129:56@161:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_keep_V}, i64 0, metadata !2752), !dbg !2912 ; [debug line = 129:56@161:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_strb_V}, i64 0, metadata !2754), !dbg !2912 ; [debug line = 129:56@161:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.strb.V]
  call void @llvm.dbg.value(metadata !{i2* %inStream_V_user_V}, i64 0, metadata !2755), !dbg !2912 ; [debug line = 129:56@161:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %inStream_V_last_V}, i64 0, metadata !2757), !dbg !2912 ; [debug line = 129:56@161:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.last.V]
  call void @llvm.dbg.value(metadata !{i5* %inStream_V_id_V}, i64 0, metadata !2759), !dbg !2912 ; [debug line = 129:56@161:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.id.V]
  call void @llvm.dbg.value(metadata !{i6* %inStream_V_dest_V}, i64 0, metadata !2761), !dbg !2912 ; [debug line = 129:56@161:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.dest.V]
  %empty_12 = call { i32, i4, i4, i2, i1, i5, i6 } @_ssdm_op_Read.axis.volatile.i32P.i4P.i4P.i2P.i1P.i5P.i6P(i32* %inStream_V_data_V, i4* %inStream_V_keep_V, i4* %inStream_V_strb_V, i2* %inStream_V_user_V, i1* %inStream_V_last_V, i5* %inStream_V_id_V, i6* %inStream_V_dest_V), !dbg !2915 ; [#uses=1 type={ i32, i4, i4, i2, i1, i5, i6 }] [debug line = 131:9@161:13]
  %tmp_data_V_4 = extractvalue { i32, i4, i4, i2, i1, i5, i6 } %empty_12, 0, !dbg !2915 ; [#uses=1 type=i32] [debug line = 131:9@161:13]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_4}, i64 0, metadata !2765), !dbg !2915 ; [debug line = 131:9@161:13] [debug variable = tmp.data.V]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_4}, i64 0, metadata !2916), !dbg !2919 ; [debug line = 277:10@100:10@161:13] [debug variable = valIn.data.V]
  %readCount = add nsw i32 %readCount_1_load, 1, !dbg !2925 ; [#uses=1 type=i32] [debug line = 162:5]
  call void @llvm.dbg.value(metadata !{i32 %readCount}, i64 0, metadata !2821), !dbg !2925 ; [debug line = 162:5] [debug variable = readCount]
  store i32 %tmp_data_V_4, i32* %window_2_2_2, !dbg !2915 ; [debug line = 131:9@161:13]
  store i32 %readCount, i32* %readCount_1, !dbg !2925 ; [debug line = 162:5]
  br label %._crit_edge88_ifconv, !dbg !2926      ; [debug line = 163:4]

._crit_edge88_ifconv:                             ; preds = %2, %._crit_edge_ifconv
  %lineBuffer_1_3_21 = load i32* %window_2_2_2    ; [#uses=4 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_1_3_21}, i64 0, metadata !2787), !dbg !2927 ; [debug line = 164:59] [debug variable = lineBuffer[1][3]]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_1_3_21}, i64 0, metadata !2789), !dbg !2927 ; [debug line = 164:59] [debug variable = lineBuffer[1][0]]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_1_3_21}, i64 0, metadata !2790), !dbg !2927 ; [debug line = 164:59] [debug variable = lineBuffer[1][1]]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_1_3_21}, i64 0, metadata !2791), !dbg !2927 ; [debug line = 164:59] [debug variable = lineBuffer[1][2]]
  %newSel8 = select i1 %sel_tmp13, i32 %lineBuffer_1_3_3, i32 %lineBuffer_1_3_21 ; [#uses=1 type=i32]
  %lineBuffer_1_3_10 = select i1 %or_cond2, i32 %lineBuffer_1_3_3, i32 %newSel8 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_1_3_10}, i64 0, metadata !2787), !dbg !2788 ; [debug line = 114:23] [debug variable = lineBuffer[1][3]]
  %newSel1 = select i1 %sel_tmp13, i32 %lineBuffer_1_3_21, i32 %lineBuffer_1_2_3 ; [#uses=1 type=i32]
  %lineBuffer_1_3_11 = select i1 %or_cond2, i32 %lineBuffer_1_2_3, i32 %newSel1 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_1_3_11}, i64 0, metadata !2787), !dbg !2927 ; [debug line = 164:59] [debug variable = lineBuffer[1][3]]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_1_3_17}, i64 0, metadata !2787), !dbg !2927 ; [debug line = 164:59] [debug variable = lineBuffer[1][3]]
  %lineBuffer_1_3_18 = select i1 %sel_tmp14, i32 %lineBuffer_1_3_21, i32 %lineBuffer_1_3_17 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_1_3_18}, i64 0, metadata !2787), !dbg !2927 ; [debug line = 164:59] [debug variable = lineBuffer[1][3]]
  %lineBuffer_1_3_19 = select i1 %sel_tmp15, i32 %lineBuffer_1_3_17, i32 %lineBuffer_1_3_18 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_1_3_19}, i64 0, metadata !2787), !dbg !2927 ; [debug line = 164:59] [debug variable = lineBuffer[1][3]]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_1_3_1}, i64 0, metadata !2787), !dbg !2927 ; [debug line = 164:59] [debug variable = lineBuffer[1][3]]
  %lineBuffer_1_3_20 = select i1 %sel_tmp15, i32 %lineBuffer_1_3_21, i32 %lineBuffer_1_3_1 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_1_3_20}, i64 0, metadata !2787), !dbg !2927 ; [debug line = 164:59] [debug variable = lineBuffer[1][3]]
  call void @llvm.dbg.value(metadata !{i32 %window_1_0}, i64 0, metadata !2928), !dbg !2929 ; [debug line = 169:6] [debug variable = window[1][0]]
  call void @llvm.dbg.value(metadata !{i32 %window_1_1}, i64 0, metadata !2834), !dbg !2929 ; [debug line = 169:6] [debug variable = window[1][1]]
  call void @llvm.dbg.value(metadata !{i32 %windowRightCol_0}, i64 0, metadata !2934), !dbg !2935 ; [debug line = 175:5] [debug variable = window[0][2]]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_0_3_15}, i64 0, metadata !2835), !dbg !2935 ; [debug line = 175:5] [debug variable = window[1][2]]
  call void @llvm.dbg.value(metadata !{i32 %lineBuffer_1_3_21}, i64 0, metadata !2822), !dbg !2935 ; [debug line = 175:5] [debug variable = window[2][2]]
  %empty_13 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str9, i32 %tmp_8), !dbg !2938 ; [#uses=0 type=i32] [debug line = 177:3]
  %x_4 = add i3 %x_assign_mid2, 1, !dbg !2939     ; [#uses=1 type=i3] [debug line = 131:26]
  call void @llvm.dbg.value(metadata !{i3 %x_4}, i64 0, metadata !2940), !dbg !2939 ; [debug line = 131:26] [debug variable = x]
  br label %.preheader82, !dbg !2939              ; [debug line = 131:26]

.preheader83:                                     ; preds = %.preheader82
  %empty_14 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 16, i64 16, i64 16) ; [#uses=0 type=i32]
  %exitcond2 = icmp eq i3 %x_assign, -4, !dbg !2941 ; [#uses=2 type=i1] [debug line = 131:17]
  %x_assign_mid2 = select i1 %exitcond2, i3 0, i3 %x_assign ; [#uses=3 type=i3]
  %y_s = add i3 1, %y_assign, !dbg !2942          ; [#uses=1 type=i3] [debug line = 130:25]
  %y_assign_cast_mid2_v = select i1 %exitcond2, i3 %y_s, i3 %y_assign, !dbg !2823 ; [#uses=2 type=i3] [debug line = 130:16]
  %tmp_12 = trunc i3 %y_assign_cast_mid2_v to i1, !dbg !2823 ; [#uses=1 type=i1] [debug line = 130:16]
  %tmp_13 = trunc i3 %x_assign_mid2 to i1, !dbg !2941 ; [#uses=1 type=i1] [debug line = 131:17]
  %tmp_8 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str9), !dbg !2943 ; [#uses=1 type=i32] [debug line = 131:32]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind, !dbg !2944 ; [debug line = 132:1]
  call void @llvm.dbg.value(metadata !{i3 %x_assign}, i64 0, metadata !2945), !dbg !2950 ; [debug line = 45:26@135:9] [debug variable = x]
  call void @llvm.dbg.value(metadata !{i3 %y_assign}, i64 0, metadata !2951), !dbg !2952 ; [debug line = 45:33@135:9] [debug variable = y]
  %tmp_5 = and i1 %tmp_12, %tmp_13, !dbg !2953    ; [#uses=1 type=i1] [debug line = 47:2@135:9]
  br i1 %tmp_5, label %_ifconv87, label %._crit_edge_ifconv, !dbg !2953 ; [debug line = 47:2@135:9]

; <label>:3                                       ; preds = %.preheader82
  ret void, !dbg !2955                            ; [debug line = 179:1]
}
...
entry:
  ...
  %empty_21 = trunc i32 %empty to i28             ; [#uses=1 type=i28]
  ret i28 %empty_21
}
...
entry:
  %empty = call i32 @llvm.part.select.i32(i32 %0, i32 %1, i32 %2) ; [#uses=1 type=i32]
  %empty_22 = trunc i32 %empty to i20             ; [#uses=1 type=i20]
  ret i20 %empty_22
}
...
entry:
  ...
  %empty_23 = and i32 %0, %empty                  ; [#uses=1 type=i32]
  %empty_24 = icmp ne i32 %empty_23, 0            ; [#uses=1 type=i1]
  ret i1 %empty_24
}
...
!128 = metadata !{i32 786478, i32 0, metadata !129, metadata !"cnn_pool_d4x4_p2x2", metadata !"cnn_pool_d4x4_p2x2", metadata !"_Z18cnn_pool_d4x4_p2x2RN3hls6streamI7ap_axiuILi32ELi2ELi5ELi6EEEES4_j", metadata !129, i32 85, metadata !130, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !159, i32 89} ; [ DW_TAG_subprogram ]
!129 = metadata !{i32 786473, metadata !"cnn_pool_d4x4_p2x2/core.cpp", metadata !"D:\5CSchool\5CProject\5Cnew_repo\5CHLS", null} ; [ DW_TAG_file_type ]
...
!2736 = metadata !{i32 103, i32 42, metadata !2737, null}
!2737 = metadata !{i32 786443, metadata !2732, i32 103, i32 2, metadata !129, i32 1} ; [ DW_TAG_lexical_block ]
!2738 = metadata !{i32 111, i32 17, metadata !2739, null}
!2739 = metadata !{i32 786443, metadata !2740, i32 111, i32 3, metadata !129, i32 5} ; [ DW_TAG_lexical_block ]
!2740 = metadata !{i32 786443, metadata !2741, i32 110, i32 56, metadata !129, i32 4} ; [ DW_TAG_lexical_block ]
!2741 = metadata !{i32 786443, metadata !2732, i32 110, i32 2, metadata !129, i32 3} ; [ DW_TAG_lexical_block ]
!2742 = metadata !{i32 103, i32 57, metadata !2743, null}
!2743 = metadata !{i32 786443, metadata !2737, i32 103, i32 56, metadata !129, i32 2} ; [ DW_TAG_lexical_block ]
!2744 = metadata !{i32 104, i32 1, metadata !2743, null}
!2745 = metadata !{i32 790531, metadata !2746, metadata !"stream<ap_axiu<32, 2, 5, 6> >.V.data.V", null, i32 129, metadata !2749, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2746 = metadata !{i32 786689, metadata !2747, metadata !"this", metadata !135, i32 16777345, metadata !2748, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2747 = metadata !{i32 786478, i32 0, metadata !134, metadata !"read", metadata !"read", metadata !"_ZN3hls6streamI7ap_axiuILi32ELi2ELi5ELi6EEE4readEv", metadata !135, i32 129, metadata !2631, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2630, metadata !159, i32 129} ; [ DW_TAG_subprogram ]
!2748 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !133} ; [ DW_TAG_pointer_type ]
!2749 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !2650} ; [ DW_TAG_pointer_type ]
!2750 = metadata !{i32 129, i32 56, metadata !2747, metadata !2751}
!2751 = metadata !{i32 105, i32 19, metadata !2743, null}
!2752 = metadata !{i32 790531, metadata !2746, metadata !"stream<ap_axiu<32, 2, 5, 6> >.V.keep.V", null, i32 129, metadata !2753, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2753 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !2663} ; [ DW_TAG_pointer_type ]
!2754 = metadata !{i32 790531, metadata !2746, metadata !"stream<ap_axiu<32, 2, 5, 6> >.V.strb.V", null, i32 129, metadata !2753, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2755 = metadata !{i32 790531, metadata !2746, metadata !"stream<ap_axiu<32, 2, 5, 6> >.V.user.V", null, i32 129, metadata !2756, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2756 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !2676} ; [ DW_TAG_pointer_type ]
!2757 = metadata !{i32 790531, metadata !2746, metadata !"stream<ap_axiu<32, 2, 5, 6> >.V.last.V", null, i32 129, metadata !2758, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2758 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !2688} ; [ DW_TAG_pointer_type ]
!2759 = metadata !{i32 790531, metadata !2746, metadata !"stream<ap_axiu<32, 2, 5, 6> >.V.id.V", null, i32 129, metadata !2760, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2760 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !2700} ; [ DW_TAG_pointer_type ]
!2761 = metadata !{i32 790531, metadata !2746, metadata !"stream<ap_axiu<32, 2, 5, 6> >.V.dest.V", null, i32 129, metadata !2762, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2762 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !2712} ; [ DW_TAG_pointer_type ]
!2763 = metadata !{i32 131, i32 9, metadata !2764, metadata !2751}
!2764 = metadata !{i32 786443, metadata !2747, i32 129, i32 63, metadata !135, i32 51} ; [ DW_TAG_lexical_block ]
!2765 = metadata !{i32 790529, metadata !2766, metadata !"tmp.data.V", null, i32 130, metadata !2652, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2766 = metadata !{i32 786688, metadata !2764, metadata !"tmp", metadata !135, i32 130, metadata !2597, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2767 = metadata !{i32 106, i32 44, metadata !2743, null}
!2768 = metadata !{i32 790529, metadata !2769, metadata !"lineBuffer[0][2]", null, i32 95, metadata !2775, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2769 = metadata !{i32 786688, metadata !2732, metadata !"lineBuffer", metadata !129, i32 95, metadata !2770, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2770 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 256, i64 32, i32 0, i32 0, metadata !2771, metadata !2772, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2771 = metadata !{i32 786454, null, metadata !"ufixp32_t", metadata !129, i32 30, i64 0, i64 0, i64 0, i32 0, metadata !2645} ; [ DW_TAG_typedef ]
!2772 = metadata !{metadata !2773, metadata !2774}
!2773 = metadata !{i32 786465, i64 0, i64 1}      ; [ DW_TAG_subrange_type ]
!2774 = metadata !{i32 786465, i64 0, i64 3}      ; [ DW_TAG_subrange_type ]
!2775 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 32, i64 32, i32 0, i32 0, metadata !2771, metadata !2772, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2776 = metadata !{i32 790529, metadata !2769, metadata !"lineBuffer[0][3]", null, i32 95, metadata !2775, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2777 = metadata !{i32 107, i32 2, metadata !2743, null}
!2778 = metadata !{i32 103, i32 51, metadata !2737, null}
!2779 = metadata !{i32 786688, metadata !2737, metadata !"x", metadata !129, i32 103, metadata !168, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2780 = metadata !{i32 111, i32 26, metadata !2739, null}
!2781 = metadata !{i32 111, i32 32, metadata !2782, null}
!2782 = metadata !{i32 786443, metadata !2739, i32 111, i32 31, metadata !129, i32 6} ; [ DW_TAG_lexical_block ]
!2783 = metadata !{i32 112, i32 1, metadata !2782, null}
!2784 = metadata !{i32 129, i32 56, metadata !2747, metadata !2785}
!2785 = metadata !{i32 113, i32 19, metadata !2782, null}
!2786 = metadata !{i32 131, i32 9, metadata !2764, metadata !2785}
!2787 = metadata !{i32 790529, metadata !2769, metadata !"lineBuffer[1][3]", null, i32 95, metadata !2775, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2788 = metadata !{i32 114, i32 23, metadata !2782, null}
!2789 = metadata !{i32 790529, metadata !2769, metadata !"lineBuffer[1][0]", null, i32 95, metadata !2775, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2790 = metadata !{i32 790529, metadata !2769, metadata !"lineBuffer[1][1]", null, i32 95, metadata !2775, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2791 = metadata !{i32 790529, metadata !2769, metadata !"lineBuffer[1][2]", null, i32 95, metadata !2775, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2792 = metadata !{i32 115, i32 3, metadata !2782, null}
!2793 = metadata !{i32 790533, metadata !2794, metadata !"window[0][0]", null, i32 51, metadata !2804, i32 0, metadata !2806} ; [ DW_TAG_arg_variable_field_ro ]
!2794 = metadata !{i32 786689, metadata !2795, metadata !"window", null, i32 51, metadata !2802, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2795 = metadata !{i32 786478, i32 0, metadata !129, metadata !"singleOperation", metadata !"singleOperation", metadata !"_Z15singleOperationPA3_jiii", metadata !129, i32 51, metadata !2796, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !159, i32 52} ; [ DW_TAG_subprogram ]
...
!2797 = metadata !{metadata !2771, metadata !2798, metadata !168, metadata !168, metadata !168}
!2798 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 32, i64 32, i64 0, i32 0, metadata !2799} ; [ DW_TAG_pointer_type ]
!2799 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 96, i64 32, i32 0, i32 0, metadata !2771, metadata !2800, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2800 = metadata !{metadata !2801}
!2801 = metadata !{i32 786465, i64 0, i64 2}      ; [ DW_TAG_subrange_type ]
!2802 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 288, i64 32, i32 0, i32 0, metadata !2771, metadata !2803, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2803 = metadata !{metadata !2801, metadata !2801}
!2804 = metadata !{i32 786447, null, metadata !"", null, i32 0, i64 64, i64 64, i64 0, i32 0, metadata !2805} ; [ DW_TAG_pointer_type ]
!2805 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 32, i64 32, i32 0, i32 0, metadata !2771, metadata !2803, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2806 = metadata !{i32 141, i32 19, metadata !2807, null}
!2807 = metadata !{i32 786443, metadata !2808, i32 135, i32 25, metadata !129, i32 15} ; [ DW_TAG_lexical_block ]
!2808 = metadata !{i32 786443, metadata !2809, i32 131, i32 31, metadata !129, i32 14} ; [ DW_TAG_lexical_block ]
!2809 = metadata !{i32 786443, metadata !2810, i32 131, i32 3, metadata !129, i32 13} ; [ DW_TAG_lexical_block ]
!2810 = metadata !{i32 786443, metadata !2811, i32 130, i32 30, metadata !129, i32 12} ; [ DW_TAG_lexical_block ]
!2811 = metadata !{i32 786443, metadata !2732, i32 130, i32 2, metadata !129, i32 11} ; [ DW_TAG_lexical_block ]
!2812 = metadata !{i32 790529, metadata !2813, metadata !"window[0][0]", null, i32 96, metadata !2805, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2813 = metadata !{i32 786688, metadata !2732, metadata !"window", metadata !129, i32 96, metadata !2802, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2814 = metadata !{i32 790529, metadata !2813, metadata !"window[0][1]", null, i32 96, metadata !2805, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2815 = metadata !{i32 790533, metadata !2794, metadata !"window[1][0]", null, i32 51, metadata !2804, i32 0, metadata !2806} ; [ DW_TAG_arg_variable_field_ro ]
!2816 = metadata !{i32 786689, metadata !2817, metadata !"writeCount", metadata !129, i32 16777291, metadata !168, i32 0, metadata !2820} ; [ DW_TAG_arg_variable ]
!2817 = metadata !{i32 786478, i32 0, metadata !129, metadata !"isLast", metadata !"isLast", metadata !"_Z6isLasti", metadata !129, i32 75, metadata !2818, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !159, i32 75} ; [ DW_TAG_subprogram ]
...
!2819 = metadata !{metadata !170, metadata !168}
!2820 = metadata !{i32 147, i32 19, metadata !2807, null}
!2821 = metadata !{i32 786688, metadata !2732, metadata !"readCount", metadata !129, i32 118, metadata !168, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2822 = metadata !{i32 790529, metadata !2813, metadata !"window[2][2]", null, i32 96, metadata !2805, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2823 = metadata !{i32 130, i32 16, metadata !2811, null}
!2824 = metadata !{i32 123, i32 35, metadata !2825, null}
!2825 = metadata !{i32 786443, metadata !2826, i32 123, i32 3, metadata !129, i32 9} ; [ DW_TAG_lexical_block ]
!2826 = metadata !{i32 786443, metadata !2827, i32 122, i32 52, metadata !129, i32 8} ; [ DW_TAG_lexical_block ]
!2827 = metadata !{i32 786443, metadata !2732, i32 122, i32 2, metadata !129, i32 7} ; [ DW_TAG_lexical_block ]
!2828 = metadata !{i32 122, i32 47, metadata !2827, null}
!2829 = metadata !{i32 125, i32 2, metadata !2830, null}
!2830 = metadata !{i32 786443, metadata !2825, i32 123, i32 53, metadata !129, i32 10} ; [ DW_TAG_lexical_block ]
!2831 = metadata !{i32 123, i32 54, metadata !2830, null}
!2832 = metadata !{i32 124, i32 1, metadata !2830, null}
!2833 = metadata !{i32 790529, metadata !2813, metadata !"window[2][1]", null, i32 96, metadata !2805, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2834 = metadata !{i32 790529, metadata !2813, metadata !"window[1][1]", null, i32 96, metadata !2805, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2835 = metadata !{i32 790529, metadata !2813, metadata !"window[1][2]", null, i32 96, metadata !2805, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2836 = metadata !{i32 126, i32 3, metadata !2830, null}
!2837 = metadata !{i32 123, i32 48, metadata !2825, null}
!2838 = metadata !{i32 786688, metadata !2825, metadata !"x", metadata !129, i32 123, metadata !168, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2839 = metadata !{i32 62, i32 4, metadata !2840, metadata !2806}
!2840 = metadata !{i32 786443, metadata !2841, i32 58, i32 51, metadata !129, i32 58} ; [ DW_TAG_lexical_block ]
!2841 = metadata !{i32 786443, metadata !2842, i32 58, i32 3, metadata !129, i32 57} ; [ DW_TAG_lexical_block ]
!2842 = metadata !{i32 786443, metadata !2843, i32 57, i32 50, metadata !129, i32 56} ; [ DW_TAG_lexical_block ]
!2843 = metadata !{i32 786443, metadata !2844, i32 57, i32 2, metadata !129, i32 55} ; [ DW_TAG_lexical_block ]
!2844 = metadata !{i32 786443, metadata !2795, i32 52, i32 1, metadata !129, i32 54} ; [ DW_TAG_lexical_block ]
!2845 = metadata !{i32 139, i32 5, metadata !2807, null}
!2846 = metadata !{i32 786688, metadata !2732, metadata !"writeCount", metadata !129, i32 119, metadata !168, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2847 = metadata !{i32 790533, metadata !2794, metadata !"window[1][1]", null, i32 51, metadata !2804, i32 0, metadata !2806} ; [ DW_TAG_arg_variable_field_ro ]
!2848 = metadata !{i32 51, i32 44, metadata !2795, metadata !2806}
!2849 = metadata !{i32 786689, metadata !2795, metadata !"op", metadata !129, i32 67108915, metadata !168, i32 0, metadata !2806} ; [ DW_TAG_arg_variable ]
!2850 = metadata !{i32 51, i32 84, metadata !2795, metadata !2806}
!2851 = metadata !{i32 59, i32 4, metadata !2840, metadata !2806}
!2852 = metadata !{i32 786689, metadata !2853, metadata !"a", metadata !2854, i32 16777285, metadata !2771, i32 0, metadata !2857} ; [ DW_TAG_arg_variable ]
!2853 = metadata !{i32 786478, i32 0, metadata !2854, metadata !"fixed_point_div", metadata !"fixed_point_div", metadata !"_Z15fixed_point_divjj", metadata !2854, i32 69, metadata !2855, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !159, i32 70} ; [ DW_TAG_subprogram ]
!2854 = metadata !{i32 786473, metadata !"cnn_pool_d4x4_p2x2/fixed_point.h", metadata !"D:\5CSchool\5CProject\5Cnew_repo\5CHLS", null} ; [ DW_TAG_file_type ]
...
!2856 = metadata !{metadata !2771, metadata !2771, metadata !2771}
!2857 = metadata !{i32 69, i32 12, metadata !2858, metadata !2806}
!2858 = metadata !{i32 786443, metadata !2844, i32 68, i32 9, metadata !129, i32 61} ; [ DW_TAG_lexical_block ]
!2859 = metadata !{i32 69, i32 44, metadata !2853, metadata !2857}
!2860 = metadata !{i32 74, i32 2, metadata !2861, metadata !2857}
!2861 = metadata !{i32 786443, metadata !2853, i32 70, i32 1, metadata !2854, i32 62} ; [ DW_TAG_lexical_block ]
!2862 = metadata !{i32 77, i32 2, metadata !2861, metadata !2857}
!2863 = metadata !{i32 786688, metadata !2861, metadata !"result", metadata !2854, i32 71, metadata !2771, i32 0, metadata !2857} ; [ DW_TAG_auto_variable ]
!2864 = metadata !{i32 79, i32 2, metadata !2861, metadata !2857}
!2865 = metadata !{i32 786688, metadata !2844, metadata !"result", metadata !129, i32 55, metadata !2771, i32 0, metadata !2806} ; [ DW_TAG_auto_variable ]
!2866 = metadata !{i32 145, i32 31, metadata !2867, metadata !2869}
!2867 = metadata !{i32 786443, metadata !2868, i32 144, i32 79, metadata !135, i32 25} ; [ DW_TAG_lexical_block ]
!2868 = metadata !{i32 786478, i32 0, metadata !134, metadata !"write", metadata !"write", metadata !"_ZN3hls6streamI7ap_axiuILi32ELi2ELi5ELi6EEE5writeERKS2_", metadata !135, i32 144, metadata !2622, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !2636, metadata !159, i32 144} ; [ DW_TAG_subprogram ]
!2869 = metadata !{i32 149, i32 5, metadata !2807, null}
...
!2871 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi32EEC1Ej", metadata !143, i32 251, metadata !817, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !816, metadata !159, i32 251} ; [ DW_TAG_subprogram ]
!2872 = metadata !{i32 251, i32 64, metadata !2871, metadata !2806}
!2873 = metadata !{i32 786689, metadata !2874, metadata !"val", metadata !143, i32 33554683, metadata !214, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2874 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi32EEC2Ej", metadata !143, i32 251, metadata !817, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !816, metadata !159, i32 251} ; [ DW_TAG_subprogram ]
!2875 = metadata !{i32 251, i32 64, metadata !2874, metadata !2876}
!2876 = metadata !{i32 251, i32 86, metadata !2871, metadata !2806}
!2877 = metadata !{i32 75, i32 24, metadata !2817, metadata !2820}
!2878 = metadata !{i32 76, i32 2, metadata !2879, metadata !2820}
!2879 = metadata !{i32 786443, metadata !2817, i32 75, i32 36, metadata !129, i32 53} ; [ DW_TAG_lexical_block ]
...
!2881 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi1EEC1Eb", metadata !143, i32 245, metadata !1848, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1847, metadata !159, i32 245} ; [ DW_TAG_subprogram ]
!2882 = metadata !{i32 245, i32 56, metadata !2881, metadata !2820}
!2883 = metadata !{i32 786689, metadata !2884, metadata !"val", metadata !143, i32 33554677, metadata !170, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2884 = metadata !{i32 786478, i32 0, null, metadata !"ap_uint", metadata !"ap_uint", metadata !"_ZN7ap_uintILi1EEC2Eb", metadata !143, i32 245, metadata !1848, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !1847, metadata !159, i32 245} ; [ DW_TAG_subprogram ]
!2885 = metadata !{i32 245, i32 56, metadata !2884, metadata !2886}
!2886 = metadata !{i32 245, i32 78, metadata !2881, metadata !2820}
!2887 = metadata !{i32 790531, metadata !2888, metadata !"stream<ap_axiu<32, 2, 5, 6> >.V.data.V", null, i32 144, metadata !2749, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2888 = metadata !{i32 786689, metadata !2868, metadata !"this", metadata !135, i32 16777360, metadata !2748, i32 64, i32 0} ; [ DW_TAG_arg_variable ]
!2889 = metadata !{i32 144, i32 48, metadata !2868, metadata !2869}
!2890 = metadata !{i32 790531, metadata !2888, metadata !"stream<ap_axiu<32, 2, 5, 6> >.V.keep.V", null, i32 144, metadata !2753, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2891 = metadata !{i32 790531, metadata !2888, metadata !"stream<ap_axiu<32, 2, 5, 6> >.V.strb.V", null, i32 144, metadata !2753, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2892 = metadata !{i32 790531, metadata !2888, metadata !"stream<ap_axiu<32, 2, 5, 6> >.V.user.V", null, i32 144, metadata !2756, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2893 = metadata !{i32 790531, metadata !2888, metadata !"stream<ap_axiu<32, 2, 5, 6> >.V.last.V", null, i32 144, metadata !2758, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2894 = metadata !{i32 790531, metadata !2888, metadata !"stream<ap_axiu<32, 2, 5, 6> >.V.id.V", null, i32 144, metadata !2760, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2895 = metadata !{i32 790531, metadata !2888, metadata !"stream<ap_axiu<32, 2, 5, 6> >.V.dest.V", null, i32 144, metadata !2762, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2896 = metadata !{i32 790529, metadata !2897, metadata !"tmp.data.V", null, i32 145, metadata !2652, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2897 = metadata !{i32 786688, metadata !2867, metadata !"tmp", metadata !135, i32 145, metadata !138, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2898 = metadata !{i32 790529, metadata !2897, metadata !"tmp.last.V", null, i32 145, metadata !2690, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2899 = metadata !{i32 146, i32 9, metadata !2867, metadata !2869}
!2900 = metadata !{i32 150, i32 4, metadata !2807, null}
!2901 = metadata !{i32 160, i32 4, metadata !2808, null}
!2902 = metadata !{i32 790529, metadata !2903, metadata !"windowRightCol[0]", null, i32 97, metadata !2904, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2903 = metadata !{i32 786688, metadata !2732, metadata !"windowRightCol", metadata !129, i32 97, metadata !2799, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2904 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 32, i64 32, i32 0, i32 0, metadata !2771, metadata !2800, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2905 = metadata !{i32 153, i32 4, metadata !2808, null}
!2906 = metadata !{i32 155, i32 5, metadata !2907, null}
!2907 = metadata !{i32 786443, metadata !2908, i32 154, i32 40, metadata !129, i32 17} ; [ DW_TAG_lexical_block ]
!2908 = metadata !{i32 786443, metadata !2808, i32 154, i32 4, metadata !129, i32 16} ; [ DW_TAG_lexical_block ]
!2909 = metadata !{i32 790529, metadata !2769, metadata !"lineBuffer[0][0]", null, i32 95, metadata !2775, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2910 = metadata !{i32 790529, metadata !2769, metadata !"lineBuffer[0][1]", null, i32 95, metadata !2775, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2911 = metadata !{i32 790529, metadata !2903, metadata !"windowRightCol[1]", null, i32 97, metadata !2904, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2912 = metadata !{i32 129, i32 56, metadata !2747, metadata !2913}
!2913 = metadata !{i32 161, i32 13, metadata !2914, null}
!2914 = metadata !{i32 786443, metadata !2808, i32 160, i32 27, metadata !129, i32 18} ; [ DW_TAG_lexical_block ]
!2915 = metadata !{i32 131, i32 9, metadata !2764, metadata !2913}
!2916 = metadata !{i32 790529, metadata !2917, metadata !"valIn.data.V", null, i32 159, metadata !2652, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2917 = metadata !{i32 786688, metadata !2808, metadata !"valIn", metadata !129, i32 159, metadata !2918, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2918 = metadata !{i32 786454, null, metadata !"axiu32_t", metadata !129, i32 38, i64 0, i64 0, i64 0, i32 0, metadata !138} ; [ DW_TAG_typedef ]
!2919 = metadata !{i32 277, i32 10, metadata !2920, metadata !2922}
!2920 = metadata !{i32 786443, metadata !2921, i32 276, i32 92, metadata !143, i32 49} ; [ DW_TAG_lexical_block ]
!2921 = metadata !{i32 786478, i32 0, null, metadata !"operator=", metadata !"operator=", metadata !"_ZN7ap_uintILi32EEaSERKS0_", metadata !143, i32 276, metadata !855, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, metadata !854, metadata !159, i32 276} ; [ DW_TAG_subprogram ]
!2922 = metadata !{i32 100, i32 10, metadata !2923, metadata !2913}
!2923 = metadata !{i32 786443, metadata !2924, i32 100, i32 10, metadata !139, i32 52} ; [ DW_TAG_lexical_block ]
!2924 = metadata !{i32 786478, i32 0, null, metadata !"operator=", metadata !"operator=", metadata !"_ZN7ap_axiuILi32ELi2ELi5ELi6EEaSERKS0_", metadata !139, i32 100, metadata !2595, i1 false, i1 true, i32 0, i32 0, null, i32 320, i1 false, null, null, metadata !2594, metadata !159, i32 100} ; [ DW_TAG_subprogram ]
!2925 = metadata !{i32 162, i32 5, metadata !2914, null}
!2926 = metadata !{i32 163, i32 4, metadata !2914, null}
!2927 = metadata !{i32 164, i32 59, metadata !2808, null}
!2928 = metadata !{i32 790529, metadata !2813, metadata !"window[1][0]", null, i32 96, metadata !2805, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2929 = metadata !{i32 169, i32 6, metadata !2930, null}
!2930 = metadata !{i32 786443, metadata !2931, i32 168, i32 41, metadata !129, i32 22} ; [ DW_TAG_lexical_block ]
!2931 = metadata !{i32 786443, metadata !2932, i32 168, i32 5, metadata !129, i32 21} ; [ DW_TAG_lexical_block ]
!2932 = metadata !{i32 786443, metadata !2933, i32 167, i32 36, metadata !129, i32 20} ; [ DW_TAG_lexical_block ]
!2933 = metadata !{i32 786443, metadata !2808, i32 167, i32 4, metadata !129, i32 19} ; [ DW_TAG_lexical_block ]
!2934 = metadata !{i32 790529, metadata !2813, metadata !"window[0][2]", null, i32 96, metadata !2805, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2935 = metadata !{i32 175, i32 5, metadata !2936, null}
!2936 = metadata !{i32 786443, metadata !2937, i32 174, i32 36, metadata !129, i32 24} ; [ DW_TAG_lexical_block ]
!2937 = metadata !{i32 786443, metadata !2808, i32 174, i32 4, metadata !129, i32 23} ; [ DW_TAG_lexical_block ]
!2938 = metadata !{i32 177, i32 3, metadata !2808, null}
!2939 = metadata !{i32 131, i32 26, metadata !2809, null}
!2940 = metadata !{i32 786688, metadata !2809, metadata !"x", metadata !129, i32 131, metadata !168, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2941 = metadata !{i32 131, i32 17, metadata !2809, null}
!2942 = metadata !{i32 130, i32 25, metadata !2811, null}
!2943 = metadata !{i32 131, i32 32, metadata !2808, null}
!2944 = metadata !{i32 132, i32 1, metadata !2808, null}
!2945 = metadata !{i32 786689, metadata !2946, metadata !"x", metadata !129, i32 16777261, metadata !168, i32 0, metadata !2949} ; [ DW_TAG_arg_variable ]
!2946 = metadata !{i32 786478, i32 0, metadata !129, metadata !"poolSkip", metadata !"poolSkip", metadata !"_Z8poolSkipii", metadata !129, i32 45, metadata !2947, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !159, i32 46} ; [ DW_TAG_subprogram ]
...
!2948 = metadata !{metadata !170, metadata !168, metadata !168}
!2949 = metadata !{i32 135, i32 9, metadata !2808, null}
!2950 = metadata !{i32 45, i32 26, metadata !2946, metadata !2949}
!2951 = metadata !{i32 786689, metadata !2946, metadata !"y", metadata !129, i32 33554477, metadata !168, i32 0, metadata !2949} ; [ DW_TAG_arg_variable ]
!2952 = metadata !{i32 45, i32 33, metadata !2946, metadata !2949}
!2953 = metadata !{i32 47, i32 2, metadata !2954, metadata !2949}
!2954 = metadata !{i32 786443, metadata !2946, i32 46, i32 1, metadata !129, i32 70} ; [ DW_TAG_lexical_block ]
!2955 = metadata !{i32 179, i32 1, metadata !2732, null}
