...
set Library     "hls"
set IPName      "cnn_fc_i50_o10"
set Version     "1.0"
set DisplayName "cnn_fc_i50_o10"
set Revision    "2104211611"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "cnn_fc_i50_o10"
...
set Interfaces {
    s_axi_CTRL {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0xb40 ctrl W 0x0 "Data signal of ctrl" {{0 32 ctrl W 0 "Bit 31 to 0 Data signal of ctrl"}}}}
        memories "weight_0 {base_address 256 range 256} weight_1 {base_address 512 range 256} weight_2 {base_address 768 range 256} weight_3 {base_address 1024 range 256} weight_4 {base_address 1280 range 256} weight_5 {base_address 1536 range 256} weight_6 {base_address 1792 range 256} weight_7 {base_address 2048 range 256} weight_8 {base_address 2304 range 256} weight_9 {base_address 2560 range 256} bias {base_address 2816 range 64}"
        ctype {
            AWVALID {
                Type "bool"
                Width "1"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 96 II x}
...
set enable_xo_gen 0
set kernel_files {D:/School/Project/new_repo/HLS/cnn_fc_i50_o10/core.cpp}
if {$enable_xo_gen} {
