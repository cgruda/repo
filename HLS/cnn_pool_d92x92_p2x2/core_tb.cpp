...
int main()
{
	...
	ufixp32_t output[POOL_OUTPUT_ROWS][POOL_OUTPUT_COLS] = {0};
	uint32_t ctrl = 0;
	...
	// Call core
	cnn_pool_d92x92_p2x2(inputStream, outputStream, ctrl);

	// Get results from core and print them out
	for (int i = 0; i < POOL_OUTPUT_ROWS; i++) {
		for (int j = 0; j < POOL_OUTPUT_COLS; j++) {
			axiu32_t valOut;
