...
if (AESL_DEBUG_TRACE)
printf("\n  %%puts1 = call i32 @puts(i8* getelementptr inbounds ([16 x i8]* @aesl_internal_str1, i32 0, i32 0)), !dbg !10 for 0x%I64xth hint within @user_input_get  --> \n", ++aesl_llvm_cbe_puts1_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = getelementptr inbounds %%struct.env* %%cnn_env, i32 0, i32 3, !dbg !9 for 0x%I64xth hint within @free_resources  --> \n", ++aesl_llvm_cbe_27_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = tail call i32 @matrix_init(%%struct.matrix* %%1, i8* getelementptr inbounds ([6 x i8]* @aesl_internal_.str3, i32 0, i32 0), i32 4, i32 4, i32 4, i32 4, i32 255, i32 0) nounwind, !dbg !9 for 0x%I64xth hint within @init_matrices  --> \n", ++aesl_llvm_cbe_41_count);
...
if (AESL_DEBUG_TRACE)
printf("\n  %%1 = getelementptr inbounds %%struct.env* %%cnn_env, i32 0, i32 0, !dbg !9 for 0x%I64xth hint within @init_matrices_demo  --> \n", ++aesl_llvm_cbe_78_count);
  llvm_cbe_tmp__23 = (l_struct_OC_matrix *)(&llvm_cbe_cnn_env->field0);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%2 = tail call i32 @matrix_init_demo(%%struct.matrix* %%1, i8* getelementptr inbounds ([6 x i8]* @aesl_internal_.str3, i32 0, i32 0), i32 4, i32 4, i32 4, i32 4) nounwind, !dbg !9 for 0x%I64xth hint within @init_matrices_demo  --> \n", ++aesl_llvm_cbe_79_count);
...
llvm_cbe_tmp__30:
if (AESL_DEBUG_TRACE)
printf("\n  %%5 = getelementptr inbounds %%struct.env* %%cnn_env, i32 0, i32 1, !dbg !9 for 0x%I64xth hint within @init_matrices_demo  --> \n", ++aesl_llvm_cbe_89_count);
  llvm_cbe_tmp__25 = (l_struct_OC_matrix *)(&llvm_cbe_cnn_env->field1);
if (AESL_DEBUG_TRACE) {
}
if (AESL_DEBUG_TRACE)
printf("\n  %%6 = tail call i32 @matrix_init(%%struct.matrix* %%5, i8* getelementptr inbounds ([7 x i8]* @aesl_internal_.str4, i32 0, i32 0), i32 3, i32 3, i32 3, i32 3, i32 1, i32 1) nounwind, !dbg !9 for 0x%I64xth hint within @init_matrices_demo  --> \n", ++aesl_llvm_cbe_90_count);
