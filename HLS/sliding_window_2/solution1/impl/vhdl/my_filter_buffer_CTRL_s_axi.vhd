...
entity my_filter_buffer_CTRL_s_axi is
generic (
...
end entity my_filter_buffer_CTRL_s_axi;
...
architecture behave of my_filter_buffer_CTRL_s_axi is
    ...
    signal int_ctrl            : UNSIGNED(7 downto 0);
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_CTRL_DATA_0 =>
                        rdata_data <= RESIZE(int_ctrl(7 downto 0), 32);
                    when others =>
                        rdata_data <= (others => '0');
                    end case;
                end if;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_CTRL_DATA_0) then
                    int_ctrl(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_ctrl(7 downto 0));
                end if;
            end if;
        end if;
    end process;
