...
architecture behave of my_filter_buffer_KERNEL_BUS_s_axi is
    ...
    constant ADDR_BIAS_3_DATA_0   : INTEGER := 16#70#;
    constant ADDR_BIAS_3_CTRL     : INTEGER := 16#74#;
    constant ADDR_BIAS_4_DATA_0   : INTEGER := 16#78#;
    constant ADDR_BIAS_4_CTRL     : INTEGER := 16#7c#;
    constant ADDR_BIAS_5_DATA_0   : INTEGER := 16#80#;
    constant ADDR_BIAS_5_CTRL     : INTEGER := 16#84#;
    constant ADDR_BIAS_6_DATA_0   : INTEGER := 16#88#;
    constant ADDR_BIAS_6_CTRL     : INTEGER := 16#8c#;
    constant ADDR_BIAS_7_DATA_0   : INTEGER := 16#90#;
    constant ADDR_BIAS_7_CTRL     : INTEGER := 16#94#;
    constant ADDR_BIAS_8_DATA_0   : INTEGER := 16#98#;
    constant ADDR_BIAS_8_CTRL     : INTEGER := 16#9c#;
    ...
    signal int_bias_0          : UNSIGNED(7 downto 0);
    signal int_bias_1          : UNSIGNED(7 downto 0);
    signal int_bias_2          : UNSIGNED(7 downto 0);
    signal int_bias_3          : UNSIGNED(7 downto 0);
    signal int_bias_4          : UNSIGNED(7 downto 0);
    signal int_bias_5          : UNSIGNED(7 downto 0);
    signal int_bias_6          : UNSIGNED(7 downto 0);
    signal int_bias_7          : UNSIGNED(7 downto 0);
    signal int_bias_8          : UNSIGNED(7 downto 0);
            ...
            if (ACLK_EN = '1') then
                if (ar_hs = '1') then
                    ...
                    when ADDR_BIAS_0_DATA_0 =>
                        rdata_data <= RESIZE(int_bias_0(7 downto 0), 32);
                    when ADDR_BIAS_1_DATA_0 =>
                        rdata_data <= RESIZE(int_bias_1(7 downto 0), 32);
                    when ADDR_BIAS_2_DATA_0 =>
                        rdata_data <= RESIZE(int_bias_2(7 downto 0), 32);
                    when ADDR_BIAS_3_DATA_0 =>
                        rdata_data <= RESIZE(int_bias_3(7 downto 0), 32);
                    when ADDR_BIAS_4_DATA_0 =>
                        rdata_data <= RESIZE(int_bias_4(7 downto 0), 32);
                    when ADDR_BIAS_5_DATA_0 =>
                        rdata_data <= RESIZE(int_bias_5(7 downto 0), 32);
                    when ADDR_BIAS_6_DATA_0 =>
                        rdata_data <= RESIZE(int_bias_6(7 downto 0), 32);
                    when ADDR_BIAS_7_DATA_0 =>
                        rdata_data <= RESIZE(int_bias_7(7 downto 0), 32);
                    when ADDR_BIAS_8_DATA_0 =>
                        rdata_data <= RESIZE(int_bias_8(7 downto 0), 32);
                    when others =>
                        rdata_data <= (others => '0');
                    end case;
                end if;
...
-- ----------------------- Register logic ----------------
    ...
    bias_4               <= STD_LOGIC_VECTOR(int_bias_4);
    bias_5               <= STD_LOGIC_VECTOR(int_bias_5);
    bias_6               <= STD_LOGIC_VECTOR(int_bias_6);
    bias_7               <= STD_LOGIC_VECTOR(int_bias_7);
    bias_8               <= STD_LOGIC_VECTOR(int_bias_8);
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_BIAS_0_DATA_0) then
                    int_bias_0(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_bias_0(7 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_BIAS_1_DATA_0) then
                    int_bias_1(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_bias_1(7 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_BIAS_2_DATA_0) then
                    int_bias_2(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_bias_2(7 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_BIAS_3_DATA_0) then
                    int_bias_3(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_bias_3(7 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_BIAS_4_DATA_0) then
                    int_bias_4(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_bias_4(7 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_BIAS_5_DATA_0) then
                    int_bias_5(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_bias_5(7 downto 0));
                end if;
            end if;
        end if;
    end process;
        ...
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_BIAS_6_DATA_0) then
                    int_bias_6(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_bias_6(7 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_BIAS_7_DATA_0) then
                    int_bias_7(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_bias_7(7 downto 0));
                end if;
            end if;
        end if;
    end process;
    ...
    begin
        if (ACLK'event and ACLK = '1') then
            if (ACLK_EN = '1') then
                if (w_hs = '1' and waddr = ADDR_BIAS_8_DATA_0) then
                    int_bias_8(7 downto 0) <= (UNSIGNED(WDATA(7 downto 0)) and wmask(7 downto 0)) or ((not wmask(7 downto 0)) and int_bias_8(7 downto 0));
                end if;
            end if;
        end if;
    end process;
