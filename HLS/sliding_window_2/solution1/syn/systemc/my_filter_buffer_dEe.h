...
#ifndef __my_filter_buffer_dEe__HH__
#define __my_filter_buffer_dEe__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(my_filter_buffer_dEe) {
    ...
    SC_CTOR(my_filter_buffer_dEe):  ACMP_mul_su_U ("ACMP_mul_su_U") {
