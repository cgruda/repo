...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "my_filter_buffer.autotvin.dat"
	set constFileTvOut       "my_filter_buffer.autotvout.dat"
	set constFileHdlTvIn     "my_filter_buffer.autohdltvin.dat"
	set constFileHdlTvOut    "my_filter_buffer.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
