# 1 "D:/School/Project/new_repo/HLS/sliding_window_2/cnn.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "D:/School/Project/new_repo/HLS/sliding_window_2/cnn.c"
# 15 "D:/School/Project/new_repo/HLS/sliding_window_2/cnn.c"
# 1 "D:/School/Project/new_repo/HLS/sliding_window_2/cnn.h" 1
# 18 "D:/School/Project/new_repo/HLS/sliding_window_2/cnn.h"
...
# 19 "D:/School/Project/new_repo/HLS/sliding_window_2/cnn.h" 2
...
# 16 "D:/School/Project/new_repo/HLS/sliding_window_2/cnn.c" 2
...
# 18 "D:/School/Project/new_repo/HLS/sliding_window_2/cnn.c" 2
...
# 21 "D:/School/Project/new_repo/HLS/sliding_window_2/cnn.c" 2
# 1 "c:\\xilinx\\vivado_hls\\2016.4\\msys\\bin\\../lib/gcc/mingw32/4.6.2/include/stdbool.h" 1 3 4
# 22 "D:/School/Project/new_repo/HLS/sliding_window_2/cnn.c" 2
# 1 "c:\\xilinx\\vivado_hls\\2016.4\\msys\\bin\\../lib/gcc/mingw32/4.6.2/../../../../include/time.h" 1 3
# 21 "c:\\xilinx\\vivado_hls\\2016.4\\msys\\bin\\../lib/gcc/mingw32/4.6.2/../../../../include/time.h" 3
# 1 "c:\\xilinx\\vivado_hls\\2016.4\\msys\\bin\\../lib/gcc/mingw32/4.6.2/include/stddef.h" 1 3 4
# 22 "c:\\xilinx\\vivado_hls\\2016.4\\msys\\bin\\../lib/gcc/mingw32/4.6.2/../../../../include/time.h" 2 3
# 71 "c:\\xilinx\\vivado_hls\\2016.4\\msys\\bin\\../lib/gcc/mingw32/4.6.2/../../../../include/time.h" 3
typedef long clock_t;
# 80 "c:\\xilinx\\vivado_hls\\2016.4\\msys\\bin\\../lib/gcc/mingw32/4.6.2/../../../../include/time.h" 3
struct tm
{
 int tm_sec;
 int tm_min;
...
# 117 "c:\\xilinx\\vivado_hls\\2016.4\\msys\\bin\\../lib/gcc/mingw32/4.6.2/../../../../include/time.h" 3
...
# 186 "c:\\xilinx\\vivado_hls\\2016.4\\msys\\bin\\../lib/gcc/mingw32/4.6.2/../../../../include/time.h" 3
...
# 226 "c:\\xilinx\\vivado_hls\\2016.4\\msys\\bin\\../lib/gcc/mingw32/4.6.2/../../../../include/time.h" 3
...
# 250 "c:\\xilinx\\vivado_hls\\2016.4\\msys\\bin\\../lib/gcc/mingw32/4.6.2/../../../../include/time.h" 3
...
# 269 "c:\\xilinx\\vivado_hls\\2016.4\\msys\\bin\\../lib/gcc/mingw32/4.6.2/../../../../include/time.h" 3
 size_t __attribute__((__cdecl__)) __attribute__ ((__nothrow__)) wcsftime (wchar_t*, size_t, const wchar_t*, const struct tm*);
# 23 "D:/School/Project/new_repo/HLS/sliding_window_2/cnn.c" 2
...
int conv_2D(matrix_t *input, matrix_t *kernel, matrix_t *bias, matrix_t *output)
{
 ...
 if (!input || !kernel || !bias || !output) {
  do {printf("[%-14s;%-3d] ", (strrchr("D:/School/Project/new_repo/HLS/sliding_window_2/cnn.c", '\\') ? strrchr("D:/School/Project/new_repo/HLS/sliding_window_2/cnn.c", '\\') + 1 : "D:/School/Project/new_repo/HLS/sliding_window_2/cnn.c"), 33); print_error((E_FAILURE));} while (0);
  return E_FAILURE;
 }
...
int conv_2D_norm(matrixf_t *input, matrix_t *kernel, matrix_t *bias, matrixf_t *output)
{
 ...
 if (!input || !kernel || !bias || !output) {
  do {printf("[%-14s;%-3d] ", (strrchr("D:/School/Project/new_repo/HLS/sliding_window_2/cnn.c", '\\') ? strrchr("D:/School/Project/new_repo/HLS/sliding_window_2/cnn.c", '\\') + 1 : "D:/School/Project/new_repo/HLS/sliding_window_2/cnn.c"), 55); print_error((E_FAILURE));} while (0);
  return E_FAILURE;
 }
...
int pool_2D(matrix_t *input, int pool_dim, matrix_t *output, int max_pool)
{
 ...
 if (!input || !output) {
  do {printf("[%-14s;%-3d] ", (strrchr("D:/School/Project/new_repo/HLS/sliding_window_2/cnn.c", '\\') ? strrchr("D:/School/Project/new_repo/HLS/sliding_window_2/cnn.c", '\\') + 1 : "D:/School/Project/new_repo/HLS/sliding_window_2/cnn.c"), 80); print_error((E_FAILURE));} while (0);
  return E_FAILURE;
 }


 if ((input->cols % pool_dim) || (input->rows % pool_dim)) {
  do {printf("[%-14s;%-3d] ", (strrchr("D:/School/Project/new_repo/HLS/sliding_window_2/cnn.c", '\\') ? strrchr("D:/School/Project/new_repo/HLS/sliding_window_2/cnn.c", '\\') + 1 : "D:/School/Project/new_repo/HLS/sliding_window_2/cnn.c"), 86); print_error((E_INTERNAL));} while (0);
  return E_INTERNAL;
 }
   ...
   for (int n = 0; n < pool_dim; n++) {
    for (int m = 0; m < pool_dim; m++) {
     output->data[i * output->cols + j] =
       (((output->data[i * output->cols + j]) > (input->data[((pool_dim * i) + n) * input->cols + ((j * pool_dim) + m)])) ? (output->data[i * output->cols + j]) : (input->data[((pool_dim * i) + n) * input->cols + ((j * pool_dim) + m)]))
                                                                               ;
    }
   }
  }
