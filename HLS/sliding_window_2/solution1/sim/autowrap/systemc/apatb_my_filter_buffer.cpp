...
#define AUTOTB_TVOUT_PC_out_stream_V_data_V  "../tv/rtldatafile/rtl.my_filter_buffer.autotvout_out_stream_V_data_V.dat"
// tvout file define: "out_stream_V_keep_V"
#define AUTOTB_TVOUT_PC_out_stream_V_keep_V  "../tv/rtldatafile/rtl.my_filter_buffer.autotvout_out_stream_V_keep_V.dat"
// tvout file define: "out_stream_V_strb_V"
#define AUTOTB_TVOUT_PC_out_stream_V_strb_V  "../tv/rtldatafile/rtl.my_filter_buffer.autotvout_out_stream_V_strb_V.dat"
// tvout file define: "out_stream_V_user_V"
#define AUTOTB_TVOUT_PC_out_stream_V_user_V  "../tv/rtldatafile/rtl.my_filter_buffer.autotvout_out_stream_V_user_V.dat"
// tvout file define: "out_stream_V_last_V"
#define AUTOTB_TVOUT_PC_out_stream_V_last_V  "../tv/rtldatafile/rtl.my_filter_buffer.autotvout_out_stream_V_last_V.dat"
// tvout file define: "out_stream_V_id_V"
#define AUTOTB_TVOUT_PC_out_stream_V_id_V  "../tv/rtldatafile/rtl.my_filter_buffer.autotvout_out_stream_V_id_V.dat"
// tvout file define: "out_stream_V_dest_V"
#define AUTOTB_TVOUT_PC_out_stream_V_dest_V  "../tv/rtldatafile/rtl.my_filter_buffer.autotvout_out_stream_V_dest_V.dat"
...
unsigned char kernel[9])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			if (i > 0)
			{
				// RTL Name: out_stream_V_data_V
				{
					// bitslice(31, 0)
					// {
						// celement: out_stream.V.data.V(31, 0)
						// {
							sc_lv<32>* out_stream_V_data_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<32>[aesl_tmp_4 - aesl_tmp_5];
						// }
					// }
						...
						// celement: out_stream.V.data.V(31, 0)
						{
							...
							for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									{
										out_stream_V_data_V_lv0_0_0_1_lv1_0_0_1[hls_map_index++].range(31, 0) = sc_bv<32>(out_stream_V_data_V_pc_buffer[hls_map_index].range(31, 0));
									}
								}
							}
						}
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			std::vector<sc_bv<4> > out_stream_V_keep_V_pc_buffer;
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_stream_V_keep_V
				{
					// bitslice(3, 0)
					// {
						// celement: out_stream.V.keep.V(3, 0)
						// {
							sc_lv<4>* out_stream_V_keep_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<4>[aesl_tmp_4 - aesl_tmp_5];
						// }
					// }
						...
						// celement: out_stream.V.keep.V(3, 0)
						{
							...
							for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									{
										out_stream_V_keep_V_lv0_0_0_1_lv1_0_0_1[hls_map_index++].range(3, 0) = sc_bv<4>(out_stream_V_keep_V_pc_buffer[hls_map_index].range(3, 0));
									}
								}
							}
						}
		...
		if (atoi(AESL_num.c_str()) == AESL_transaction_pc)
		{
			...
			std::vector<sc_bv<4> > out_stream_V_strb_V_pc_buffer;
			int i = 0;
			...
			if (i > 0)
			{
				// RTL Name: out_stream_V_strb_V
				{
					// bitslice(3, 0)
					// {
						// celement: out_stream.V.strb.V(3, 0)
						// {
							sc_lv<4>* out_stream_V_strb_V_lv0_0_0_1_lv1_0_0_1 = new sc_lv<4>[aesl_tmp_4 - aesl_tmp_5];
						// }
					// }
						...
						// celement: out_stream.V.strb.V(3, 0)
						{
							...
							for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
							{
								...
								for (int i_1 = 0; i_1 <= 0; i_1 += 1)
								{
									...
									{
										out_stream_V_strb_V_lv0_0_0_1_lv1_0_0_1[hls_map_index++].range(3, 0) = sc_bv<4>(out_stream_V_strb_V_pc_buffer[hls_map_index].range(3, 0));
									}
								}
							}
						}
...
// [call_c_dut] ---------->
     ...
     aesl_tmp_3.clear();
		...
		sc_bv<32>* out_stream_V_data_V_tvout_wrapc_buffer = new sc_bv<32>[aesl_tmp_4 - aesl_tmp_5];
				...
				// celement: out_stream.V.data.V(31, 0)
				{
					...
					for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_3[0].data) != NULL) // check the null address if the c port is array or others
							{
								sc_lv<32> out_stream_V_data_V_tmp_mem;
								out_stream_V_data_V_tmp_mem = (aesl_tmp_3[i_0].data).to_string(2).c_str();
								out_stream_V_data_V_tvout_wrapc_buffer[hls_map_index++].range(31, 0) = out_stream_V_data_V_tmp_mem.range(31, 0);
							}
						}
					}
				}
		...
		sc_bv<4>* out_stream_V_keep_V_tvout_wrapc_buffer = new sc_bv<4>[aesl_tmp_4 - aesl_tmp_5];
				...
				// celement: out_stream.V.keep.V(3, 0)
				{
					...
					for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_3[0].keep) != NULL) // check the null address if the c port is array or others
							{
								sc_lv<4> out_stream_V_keep_V_tmp_mem;
								out_stream_V_keep_V_tmp_mem = (aesl_tmp_3[i_0].keep).to_string(2).c_str();
								out_stream_V_keep_V_tvout_wrapc_buffer[hls_map_index++].range(3, 0) = out_stream_V_keep_V_tmp_mem.range(3, 0);
							}
						}
					}
				}
		...
		sc_bv<4>* out_stream_V_strb_V_tvout_wrapc_buffer = new sc_bv<4>[aesl_tmp_4 - aesl_tmp_5];
				...
				// celement: out_stream.V.strb.V(3, 0)
				{
					...
					for (int i_0 = aesl_tmp_5; i_0 <= aesl_tmp_4 - 1; i_0 += 1)
					{
						...
						for (int i_1 = 0; i_1 <= 0; i_1 += 1)
						{
							...
							if (&(aesl_tmp_3[0].strb) != NULL) // check the null address if the c port is array or others
							{
								sc_lv<4> out_stream_V_strb_V_tmp_mem;
								out_stream_V_strb_V_tmp_mem = (aesl_tmp_3[i_0].strb).to_string(2).c_str();
								out_stream_V_strb_V_tvout_wrapc_buffer[hls_map_index++].range(3, 0) = out_stream_V_strb_V_tmp_mem.range(3, 0);
							}
						}
					}
				}
