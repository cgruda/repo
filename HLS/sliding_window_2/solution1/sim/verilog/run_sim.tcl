...
if {[file isfile my_filter_buffer.autotvin.dat]} {
	file delete -force my_filter_buffer.autotvin.dat
}

if {[file isfile my_filter_buffer.autotvout.dat]} {
	file delete -force my_filter_buffer.autotvout.dat
}
