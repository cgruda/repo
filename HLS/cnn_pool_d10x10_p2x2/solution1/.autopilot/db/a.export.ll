; ModuleID = 'D:/School/Project/new_repo/HLS/cnn_pool_d10x10_p2x2/solution1/.autopilot/db/a.o.2.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-f80:128:128-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S32"
target triple = "i686-pc-mingw32"

@llvm_global_ctors_1 = appending global [1 x void ()*] [void ()* @_GLOBAL__I_a]
@llvm_global_ctors_0 = appending global [1 x i32] [i32 65535]
@cnn_pool_d10x10_p2x2_1 = internal unnamed_addr constant [21 x i8] c"cnn_pool_d10x10_p2x2\00"
...
.preheader85:                                     ; preds = %.preheader84
  ...
  %lineBuffer_0_addr_1 = getelementptr [10 x i32]* %lineBuffer_0, i32 0, i32 %tmp_5_cast
  %lineBuffer_1_addr_1 = getelementptr [10 x i32]* %lineBuffer_1, i32 0, i32 %tmp_5_cast
...
_ifconv1:                                         ; preds = %.preheader83
  ...
  %tmp_last_V = icmp eq i32 %writeCount, 25
...
._crit_edge:                                      ; preds = %_ifconv1, %.preheader83
  ...
  %lineBuffer_0_addr_2 = getelementptr [10 x i32]* %lineBuffer_0, i32 0, i32 %x_assign_cast5
  %windowRightCol_0 = load i32* %lineBuffer_0_addr_2, align 4
  %lineBuffer_1_addr_2 = getelementptr [10 x i32]* %lineBuffer_1, i32 0, i32 %x_assign_cast5
  %windowRightCol_1 = load i32* %lineBuffer_1_addr_2, align 4
  store i32 %windowRightCol_1, i32* %lineBuffer_0_addr_2, align 4
  %tmp_7 = icmp slt i32 %readCount_1_load, 100
