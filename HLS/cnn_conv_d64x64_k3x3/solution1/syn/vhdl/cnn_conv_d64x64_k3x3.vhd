...
entity cnn_conv_d64x64_k3x3 is
generic (
...
architecture behav of cnn_conv_d64x64_k3x3 is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "cnn_conv_d64x64_k3x3,hls_ip_2016_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.045500,HLS_SYN_LAT=4183,HLS_SYN_TPT=none,HLS_SYN_MEM=4,HLS_SYN_DSP=36,HLS_SYN_FF=2693,HLS_SYN_LUT=4428}";
    ...
    constant ap_const_lv32_F04 : STD_LOGIC_VECTOR (31 downto 0) := "00000000000000000000111100000100";
    ...
    signal x_reg_371 : STD_LOGIC_VECTOR (6 downto 0);
    signal x1_reg_383 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal indvar_flatten6_reg_464 : STD_LOGIC_VECTOR (12 downto 0);
    signal y_assign_reg_475 : STD_LOGIC_VECTOR (6 downto 0);
    signal x_assign_reg_486 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal x_1_fu_612_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal x_1_reg_1210 : STD_LOGIC_VECTOR (6 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal exitcond4_fu_623_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal x_2_fu_629_p2 : STD_LOGIC_VECTOR (6 downto 0);
    signal x_2_reg_1219 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal indvar_flatten_next7_fu_828_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_enable_reg_pp3_iter0 : STD_LOGIC := '0';
    signal y_assign_mid2_fu_894_p3 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal lineBuffer_0_addr_2_reg_1371 : STD_LOGIC_VECTOR (5 downto 0);
    signal lineBuffer_1_addr_2_reg_1377 : STD_LOGIC_VECTOR (5 downto 0);
    signal ap_pipeline_reg_pp3_iter1_lineBuffer_1_addr_2_reg_1377 : STD_LOGIC_VECTOR (5 downto 0);
    signal icmp_fu_951_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal x_4_fu_968_p2 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal x_phi_fu_375_p4 : STD_LOGIC_VECTOR (6 downto 0);
    signal x1_phi_fu_387_p4 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_cast1_fu_714_p1 : STD_LOGIC_VECTOR (5 downto 0);
    ...
    signal y_s_fu_848_p2 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal x_assign_mid2_fu_840_p3 : STD_LOGIC_VECTOR (6 downto 0);
    ...
    signal tmp_11_fu_941_p4 : STD_LOGIC_VECTOR (19 downto 0);
    ...
    component cnn_conv_d64x64_kcud IS
    generic (
        DataWidth : INTEGER;
    ...
    component cnn_conv_d64x64_k3x3_CTRL_s_axi IS
    generic (
...
begin
    cnn_conv_d64x64_k3x3_CTRL_s_axi_U : component cnn_conv_d64x64_k3x3_CTRL_s_axi
    generic map (
    ...
    lineBuffer_0_U : component cnn_conv_d64x64_kcud
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    lineBuffer_1_U : component cnn_conv_d64x64_kcud
    generic map (
        DataWidth => 32,
        AddressRange => 64,
        AddressWidth => 6)
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_lv1_1 = ap_CS_fsm_pp3_stage0) and not((((ap_const_logic_1 = ap_enable_reg_pp3_iter1) and (ap_condition_965 = ap_const_boolean_1)) or ((ap_const_logic_1 = ap_enable_reg_pp3_iter9) and (ap_const_lv1_0 = ap_pipeline_reg_pp3_iter8_p_i_reg_1367) and (ap_const_logic_0 = outStream_V_data_V_1_ack_in)) or ((ap_const_logic_1 = ap_enable_reg_pp3_iter10) and (ap_const_lv1_0 = ap_pipeline_reg_pp3_iter9_p_i_reg_1367) and (ap_const_logic_0 = outStream_V_data_V_1_ack_in)))) and (ap_const_lv1_0 = exitcond_flatten8_fu_822_p2))) then
                ...
                lineBuffer_0_addr_2_reg_1371 <= x_assign_cast_fu_902_p1(6 - 1 downto 0);
                lineBuffer_1_addr_2_reg_1377 <= x_assign_cast_fu_902_p1(6 - 1 downto 0);
    ...
    cond_mid2_fu_696_p3 <= 
        ...
        cond_fu_690_p2;
    exitcond1_fu_606_p2 <= "1" when (x_phi_fu_375_p4 = ap_const_lv7_40) else "0";
    exitcond2_fu_834_p2 <= "1" when (x_assign_reg_486 = ap_const_lv7_40) else "0";
    exitcond4_fu_623_p2 <= "1" when (x1_phi_fu_387_p4 = ap_const_lv7_40) else "0";
    exitcond_flatten8_fu_822_p2 <= "1" when (indvar_flatten6_reg_464 = ap_const_lv13_1000) else "0";
    ...
    icmp_fu_951_p2 <= "1" when (signed(tmp_11_fu_941_p4) < signed(ap_const_lv20_1)) else "0";
    ...
    indvar_flatten_next7_fu_828_p2 <= std_logic_vector(unsigned(indvar_flatten6_reg_464) + unsigned(ap_const_lv13_1));
    ...
    begin
        if (((ap_const_lv1_1 = ap_CS_fsm_pp3_stage0) and (ap_const_logic_1 = ap_enable_reg_pp3_iter0))) then 
            lineBuffer_1_address0 <= x_assign_cast_fu_902_p1(6 - 1 downto 0);
        elsif (((ap_const_lv1_1 = ap_CS_fsm_pp2_stage0) and (ap_const_logic_1 = ap_enable_reg_pp2_iter0))) then 
            lineBuffer_1_address0 <= tmp_cast_fu_718_p1(6 - 1 downto 0);
        elsif (((ap_const_lv1_1 = ap_CS_fsm_pp1_stage0) and (ap_const_logic_1 = ap_enable_reg_pp1_iter1))) then 
            lineBuffer_1_address0 <= x1_cast_fu_635_p1(6 - 1 downto 0);
        else 
    ...
    tmp_11_fu_941_p4 <= readCount_1_fu_202(31 downto 12);
    tmp_1_i_fu_914_p2 <= "1" when (unsigned(x_assign_mid2_fu_840_p3) > unsigned(ap_const_lv7_3E)) else "0";
    tmp_2_i_fu_880_p2 <= "1" when (unsigned(y_assign_reg_475) > unsigned(ap_const_lv7_3E)) else "0";
    tmp_2_i_mid1_fu_874_p2 <= "1" when (unsigned(y_s_fu_848_p2) > unsigned(ap_const_lv7_3E)) else "0";
    ...
    tmp_9_fu_680_p1 <= tmp_2_mid2_v_fu_672_p3(1 - 1 downto 0);
        tmp_cast1_fu_714_p1 <= std_logic_vector(resize(signed(tmp_s_fu_708_p2),6));
    ...
    tmp_i_15_fu_908_p2 <= "1" when (x_assign_mid2_fu_840_p3 = ap_const_lv7_0) else "0";
    tmp_i_fu_860_p2 <= "1" when (y_assign_reg_475 = ap_const_lv7_0) else "0";
    tmp_i_mid1_fu_854_p2 <= "1" when (y_s_fu_848_p2 = ap_const_lv7_0) else "0";
    tmp_i_mid2_fu_866_p3 <= 
        tmp_i_mid1_fu_854_p2 when (exitcond2_fu_834_p2(0) = '1') else 
        tmp_i_fu_860_p2;
    tmp_last_V_fu_1189_p2 <= "1" when (writeCount_fu_1122_p2 = ap_const_lv32_F04) else "0";
    ...
    x4_mid2_fu_658_p3 <= 
        ...
        x4_reg_453;
    x_1_fu_612_p2 <= std_logic_vector(unsigned(x_phi_fu_375_p4) + unsigned(ap_const_lv7_1));
    x_2_fu_629_p2 <= std_logic_vector(unsigned(x1_phi_fu_387_p4) + unsigned(ap_const_lv7_1));
    x_3_fu_730_p2 <= std_logic_vector(unsigned(ap_const_lv2_1) + unsigned(x4_mid2_fu_658_p3));
    x_4_fu_968_p2 <= std_logic_vector(unsigned(x_assign_mid2_fu_840_p3) + unsigned(ap_const_lv7_1));
    x_assign_cast_fu_902_p1 <= std_logic_vector(resize(unsigned(x_assign_mid2_fu_840_p3),32));
    x_assign_mid2_fu_840_p3 <= 
        ap_const_lv7_0 when (exitcond2_fu_834_p2(0) = '1') else 
        x_assign_reg_486;
    ...
    y_assign_mid2_fu_894_p3 <= 
        ...
        y_assign_reg_475;
    y_s_fu_848_p2 <= std_logic_vector(unsigned(y_assign_reg_475) + unsigned(ap_const_lv7_1));
end behav;
