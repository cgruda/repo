...
#ifndef _cnn_conv_d64x64_k3x3_HH_
#define _cnn_conv_d64x64_k3x3_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "fixed_point_mul.h"
#include "cnn_conv_d64x64_kcud.h"
#include "cnn_conv_d64x64_k3x3_CTRL_s_axi.h"

namespace ap_rtl {

template<unsigned int C_S_AXI_CTRL_ADDR_WIDTH = 7,
         unsigned int C_S_AXI_CTRL_DATA_WIDTH = 32>
struct cnn_conv_d64x64_k3x3 : public sc_module {
    ...
    // Module declarations
    cnn_conv_d64x64_k3x3(sc_module_name name);
    SC_HAS_PROCESS(cnn_conv_d64x64_k3x3);
    ...
    cnn_conv_d64x64_k3x3_CTRL_s_axi<C_S_AXI_CTRL_ADDR_WIDTH,C_S_AXI_CTRL_DATA_WIDTH>* cnn_conv_d64x64_k3x3_CTRL_s_axi_U;
    cnn_conv_d64x64_kcud* lineBuffer_0_U;
    cnn_conv_d64x64_kcud* lineBuffer_1_U;
    ...
    sc_signal< sc_lv<7> > x_reg_371;
    sc_signal< sc_lv<7> > x1_reg_383;
    ...
    sc_signal< sc_lv<13> > indvar_flatten6_reg_464;
    sc_signal< sc_lv<7> > y_assign_reg_475;
    sc_signal< sc_lv<7> > x_assign_reg_486;
    ...
    sc_signal< sc_lv<7> > x_1_fu_612_p2;
    sc_signal< sc_lv<7> > x_1_reg_1210;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter0;
    sc_signal< sc_lv<1> > exitcond4_fu_623_p2;
    sc_signal< sc_lv<7> > x_2_fu_629_p2;
    sc_signal< sc_lv<7> > x_2_reg_1219;
    ...
    sc_signal< sc_lv<13> > indvar_flatten_next7_fu_828_p2;
    sc_signal< sc_logic > ap_enable_reg_pp3_iter0;
    sc_signal< sc_lv<7> > y_assign_mid2_fu_894_p3;
    ...
    sc_signal< sc_lv<6> > lineBuffer_0_addr_2_reg_1371;
    sc_signal< sc_lv<6> > lineBuffer_1_addr_2_reg_1377;
    sc_signal< sc_lv<6> > ap_pipeline_reg_pp3_iter1_lineBuffer_1_addr_2_reg_1377;
    sc_signal< sc_lv<1> > icmp_fu_951_p2;
    sc_signal< sc_lv<7> > x_4_fu_968_p2;
    ...
    sc_signal< sc_lv<7> > x_phi_fu_375_p4;
    sc_signal< sc_lv<7> > x1_phi_fu_387_p4;
    ...
    sc_signal< sc_lv<6> > tmp_cast1_fu_714_p1;
    ...
    sc_signal< sc_lv<7> > y_s_fu_848_p2;
    ...
    sc_signal< sc_lv<7> > x_assign_mid2_fu_840_p3;
    ...
    sc_signal< sc_lv<20> > tmp_11_fu_941_p4;
