; ModuleID = 'D:/School/Project/new_repo/HLS/cnn_conv_d8x8_k3x3/solution1/.autopilot/db/a.o.3.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-f80:128:128-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S32"
target triple = "i686-pc-mingw32"

@llvm_global_ctors_1 = appending global [1 x void ()*] [void ()* @_GLOBAL__I_a] ; [#uses=0 type=[1 x void ()*]*]
@llvm_global_ctors_0 = appending global [1 x i32] [i32 65535] ; [#uses=0 type=[1 x i32]*]
@cnn_conv_d8x8_k3x3_s = internal unnamed_addr constant [19 x i8] c"cnn_conv_d8x8_k3x3\00" ; [#uses=1 type=[19 x i8]*]
...
define void @cnn_conv_d8x8_k3x3(i32* %inStream_V_data_V, i4* %inStream_V_keep_V, i4* %inStream_V_strb_V, i2* %inStream_V_user_V, i1* %inStream_V_last_V, i5* %inStream_V_id_V, i6* %inStream_V_dest_V, i32* %outStream_V_data_V, i4* %outStream_V_keep_V, i4* %outStream_V_strb_V, i2* %outStream_V_user_V, i1* %outStream_V_last_V, i5* %outStream_V_id_V, i6* %outStream_V_dest_V, i32 %ctrl, i32* %kernel_0, i32* %kernel_1, i32* %kernel_2, i32* %kernel_3, i32* %kernel_4, i32* %kernel_5, i32* %kernel_6, i32* %kernel_7, i32* %kernel_8) {
  ...
  call void (...)* @_ssdm_op_SpecTopModule([19 x i8]* @cnn_conv_d8x8_k3x3_s) nounwind
  ...
  %lineBuffer_0 = alloca [8 x i32], align 4       ; [#uses=3 type=[8 x i32]*]
  ...
  call void @llvm.dbg.declare(metadata !{[8 x i32]* %lineBuffer_0}, metadata !2837), !dbg !2844 ; [debug line = 89:12] [debug variable = lineBuffer[0]]
  call void @llvm.dbg.declare(metadata !{[8 x i32]* %lineBuffer_1}, metadata !2845), !dbg !2844 ; [debug line = 89:12] [debug variable = lineBuffer[1]]
  br label %1, !dbg !2846                         ; [debug line = 97:38]

; <label>:1                                       ; preds = %2, %0
  %x = phi i4 [ 6, %0 ], [ %x_1, %2 ]             ; [#uses=3 type=i4]
  %exitcond1 = icmp eq i4 %x, -8, !dbg !2846      ; [#uses=1 type=i1] [debug line = 97:38]
  br i1 %exitcond1, label %.preheader86.0.preheader, label %2, !dbg !2846 ; [debug line = 97:38]

.preheader86.0.preheader:                         ; preds = %1
  br label %.preheader86.0, !dbg !2848            ; [debug line = 105:17]

; <label>:2                                       ; preds = %1
  %x_cast = zext i4 %x to i32, !dbg !2846         ; [#uses=1 type=i32] [debug line = 97:38]
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 2, i64 2, i64 2) ; [#uses=0 type=i32]
  %tmp = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str6), !dbg !2852 ; [#uses=1 type=i32] [debug line = 97:53]
  ...
  %lineBuffer_0_addr = getelementptr [8 x i32]* %lineBuffer_0, i32 0, i32 %x_cast ; [#uses=1 type=i32*]
  ...
  %x_1 = add i4 %x, 1, !dbg !2879                 ; [#uses=1 type=i4] [debug line = 97:47]
  call void @llvm.dbg.value(metadata !{i4 %x_1}, i64 0, metadata !2880), !dbg !2879 ; [debug line = 97:47] [debug variable = x]
  br label %1, !dbg !2879                         ; [debug line = 97:47]

.preheader86.0:                                   ; preds = %3, %.preheader86.0.preheader
  %x1 = phi i4 [ %x_2, %3 ], [ 0, %.preheader86.0.preheader ] ; [#uses=3 type=i4]
  %exitcond4 = icmp eq i4 %x1, -8, !dbg !2848     ; [#uses=1 type=i1] [debug line = 105:17]
  %x_2 = add i4 %x1, 1, !dbg !2881                ; [#uses=1 type=i4] [debug line = 105:26]
...
; <label>:3                                       ; preds = %.preheader86.0
  ...
  %tmp_1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str7), !dbg !2887 ; [#uses=1 type=i32] [debug line = 105:32]
  ...
  %lineBuffer_1_addr = getelementptr [8 x i32]* %lineBuffer_1, i32 0, i32 %x1_cast ; [#uses=1 type=i32*]
  ...
  br label %.preheader86.0, !dbg !2881            ; [debug line = 105:26]
...
.preheader85:                                     ; preds = %.preheader84
  ...
  %x4_cast = zext i2 %x4_mid2 to i3, !dbg !2917   ; [#uses=1 type=i3] [debug line = 117:31]
  ...
  %tmp_s = add i3 -3, %x4_cast, !dbg !2902        ; [#uses=1 type=i3] [debug line = 119:2]
  %tmp_cast = zext i3 %tmp_s to i32, !dbg !2902   ; [#uses=2 type=i32] [debug line = 119:2]
  %lineBuffer_0_addr_1 = getelementptr [8 x i32]* %lineBuffer_0, i32 0, i32 %tmp_cast, !dbg !2902 ; [#uses=1 type=i32*] [debug line = 119:2]
  %lineBuffer_1_addr_1 = getelementptr [8 x i32]* %lineBuffer_1, i32 0, i32 %tmp_cast, !dbg !2902 ; [#uses=1 type=i32*] [debug line = 119:2]
...
.preheader82:                                     ; preds = %._crit_edge88, %.preheader83.preheader
  ...
  %exitcond_flatten8 = icmp eq i7 %indvar_flatten6, -64 ; [#uses=1 type=i1]
...
_ifconv1:                                         ; preds = %.preheader83
  ...
  %tmp11_trunc24_ext_ca = sext i23 %tmp_9_2_1_i to i24, !dbg !2926 ; [#uses=1 type=i24] [debug line = 53:14@135:19]
  %tmp1 = add i24 %tmp11_trunc24_ext_ca, %tmp11_trunc_ext_cast, !dbg !2926 ; [#uses=1 type=i24] [debug line = 53:14@135:19]
  ...
  %tmp12_trunc23_ext_ca = sext i23 %tmp_9_1_2_i to i24, !dbg !2926 ; [#uses=1 type=i24] [debug line = 53:14@135:19]
  %tmp4 = add i24 %tmp12_trunc_ext_cast, %tmp12_trunc23_ext_ca, !dbg !2926 ; [#uses=1 type=i24] [debug line = 53:14@135:19]
  ...
  %tmp14_trunc22_ext_ca = sext i23 %tmp_9_0_1_i to i24, !dbg !2926 ; [#uses=1 type=i24] [debug line = 53:14@135:19]
  %tmp6 = add i24 %tmp14_trunc22_ext_ca, %tmp14_trunc_ext_cast, !dbg !2926 ; [#uses=1 type=i24] [debug line = 53:14@135:19]
  ...
  %tmp16_trunc25_ext_ca = sext i23 %tmp_9_2_2_i to i24, !dbg !2926 ; [#uses=1 type=i24] [debug line = 53:14@135:19]
  %tmp7 = add i24 %tmp16_trunc25_ext_ca, %tmp16_trunc_ext_cast, !dbg !2926 ; [#uses=1 type=i24] [debug line = 53:14@135:19]
  ...
  %tmp_last_V = icmp eq i32 %writeCount, 36, !dbg !2964 ; [#uses=1 type=i1] [debug line = 66:2@141:19]
...
._crit_edge:                                      ; preds = %.preheader83, %_ifconv1
  ...
  %lineBuffer_0_addr_2 = getelementptr [8 x i32]* %lineBuffer_0, i32 0, i32 %x_assign_cast ; [#uses=2 type=i32*]
  ...
  %tmp_11 = call i26 @_ssdm_op_PartSelect.i26.i32.i32.i32(i32 %readCount_1_load, i32 6, i32 31), !dbg !2987 ; [#uses=1 type=i26] [debug line = 154:4]
  %icmp = icmp slt i26 %tmp_11, 1, !dbg !2987     ; [#uses=1 type=i1] [debug line = 154:4]
  store i32 %windowRightCol_0, i32* %window_0_1
  br i1 %icmp, label %4, label %._crit_edge88, !dbg !2987 ; [debug line = 154:4]
...
._crit_edge88:                                    ; preds = %4, %._crit_edge
  ...
  %x_4 = add i4 %x_assign_mid2, 1, !dbg !3024     ; [#uses=1 type=i4] [debug line = 125:26]
  call void @llvm.dbg.value(metadata !{i4 %x_4}, i64 0, metadata !3025), !dbg !3024 ; [debug line = 125:26] [debug variable = x]
  br label %.preheader82, !dbg !3024              ; [debug line = 125:26]

.preheader83:                                     ; preds = %.preheader82
  %empty_14 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 64, i64 64, i64 64) ; [#uses=0 type=i32]
  %exitcond2 = icmp eq i4 %x_assign, -8, !dbg !3026 ; [#uses=4 type=i1] [debug line = 125:17]
  %x_assign_mid2 = select i1 %exitcond2, i4 0, i4 %x_assign ; [#uses=4 type=i4]
  %y_s = add i4 %y_assign, 1, !dbg !3027          ; [#uses=3 type=i4] [debug line = 124:25]
  ...
  %tmp_3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str9), !dbg !3034 ; [#uses=1 type=i32] [debug line = 125:32]
...
entry:
  ...
  %empty_22 = trunc i32 %empty to i26             ; [#uses=1 type=i26]
  ret i26 %empty_22
}
...
!67 = metadata !{i32 786473, metadata !"cnn_conv_d8x8_k3x3/fixed_point.h", metadata !"D:\5CSchool\5CProject\5Cnew_repo\5CHLS", null} ; [ DW_TAG_file_type ]
...
!71 = metadata !{i32 786473, metadata !"cnn_conv_d8x8_k3x3/core.cpp", metadata !"D:\5CSchool\5CProject\5Cnew_repo\5CHLS", null} ; [ DW_TAG_file_type ]
...
!2728 = metadata !{i32 786443, metadata !2729, i32 125, i32 31, metadata !71, i32 14} ; [ DW_TAG_lexical_block ]
!2729 = metadata !{i32 786443, metadata !2730, i32 125, i32 3, metadata !71, i32 13} ; [ DW_TAG_lexical_block ]
!2730 = metadata !{i32 786443, metadata !2731, i32 124, i32 30, metadata !71, i32 12} ; [ DW_TAG_lexical_block ]
...
!2839 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 512, i64 32, i32 0, i32 0, metadata !70, metadata !2840, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2840 = metadata !{metadata !2841, metadata !2842}
!2841 = metadata !{i32 786465, i64 0, i64 1}      ; [ DW_TAG_subrange_type ]
!2842 = metadata !{i32 786465, i64 0, i64 7}      ; [ DW_TAG_subrange_type ]
!2843 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 256, i64 32, i32 0, i32 0, metadata !70, metadata !2840, i32 0, i32 0} ; [ DW_TAG_array_type ]
...
!2846 = metadata !{i32 97, i32 38, metadata !2847, null}
...
!2852 = metadata !{i32 97, i32 53, metadata !2853, null}
!2853 = metadata !{i32 786443, metadata !2847, i32 97, i32 52, metadata !71, i32 2} ; [ DW_TAG_lexical_block ]
...
!2887 = metadata !{i32 105, i32 32, metadata !2888, null}
!2888 = metadata !{i32 786443, metadata !2849, i32 105, i32 31, metadata !71, i32 6} ; [ DW_TAG_lexical_block ]
...
!2998 = metadata !{i32 786443, metadata !2728, i32 154, i32 27, metadata !71, i32 18} ; [ DW_TAG_lexical_block ]
...
!3024 = metadata !{i32 125, i32 26, metadata !2729, null}
...
!3027 = metadata !{i32 124, i32 25, metadata !2731, null}
...
!3034 = metadata !{i32 125, i32 32, metadata !2728, null}
