set C_TypeInfoList {{ 
"cnn_conv_d8x8_k3x3" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"inStream": [[], {"reference": "0"}] }, {"outStream": [[], {"reference": "0"}] }, {"ctrl": [[],"1"] }, {"kernel": [[], {"array": ["2", [9]]}] }],[],""], 
...
set moduleName cnn_conv_d8x8_k3x3
...
set C_modelName {cnn_conv_d8x8_k3x3}
...
set NewPortList {[ 
	...
	{ "name": "s_axi_CTRL_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":7, "type": "signal", "bundle":{"name": "CTRL", "role": "ARADDR" },"address":[{"name":"cnn_conv_d8x8_k3x3","role":"start","value":"0","valid_bit":"0"},{"name":"cnn_conv_d8x8_k3x3","role":"done","value":"0","valid_bit":"1"},{"name":"cnn_conv_d8x8_k3x3","role":"idle","value":"0","valid_bit":"2"},{"name":"cnn_conv_d8x8_k3x3","role":"ready","value":"0","valid_bit":"3"},{"name":"cnn_conv_d8x8_k3x3","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cnn_conv_d8x8_k3x3_CTRL_s_axi_U", "Parent" : "0"},
	...
	{"ID" : "5", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_529.cnn_conv_d8x8_k3xbkb_U0", "Parent" : "4"},
	{"ID" : "6", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_536", "Parent" : "0", "Child" : ["7"],
		...
		{"Name" : "a", "Type" : "None", "Direction" : "I"},
		{"Name" : "b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "7", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_536.cnn_conv_d8x8_k3xbkb_U0", "Parent" : "6"},
	{"ID" : "8", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_543", "Parent" : "0", "Child" : ["9"],
		...
		{"Name" : "a", "Type" : "None", "Direction" : "I"},
		{"Name" : "b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "9", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_543.cnn_conv_d8x8_k3xbkb_U0", "Parent" : "8"},
	{"ID" : "10", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_550", "Parent" : "0", "Child" : ["11"],
		...
		{"Name" : "a", "Type" : "None", "Direction" : "I"},
		{"Name" : "b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "11", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_550.cnn_conv_d8x8_k3xbkb_U0", "Parent" : "10"},
	{"ID" : "12", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_557", "Parent" : "0", "Child" : ["13"],
		...
		{"Name" : "a", "Type" : "None", "Direction" : "I"},
		{"Name" : "b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "13", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_557.cnn_conv_d8x8_k3xbkb_U0", "Parent" : "12"},
	{"ID" : "14", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_565", "Parent" : "0", "Child" : ["15"],
		...
		{"Name" : "a", "Type" : "None", "Direction" : "I"},
		{"Name" : "b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "15", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_565.cnn_conv_d8x8_k3xbkb_U0", "Parent" : "14"},
	{"ID" : "16", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_573", "Parent" : "0", "Child" : ["17"],
		...
		{"Name" : "a", "Type" : "None", "Direction" : "I"},
		{"Name" : "b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "17", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_573.cnn_conv_d8x8_k3xbkb_U0", "Parent" : "16"},
	{"ID" : "18", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_580", "Parent" : "0", "Child" : ["19"],
		...
		{"Name" : "a", "Type" : "None", "Direction" : "I"},
		{"Name" : "b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "19", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_580.cnn_conv_d8x8_k3xbkb_U0", "Parent" : "18"},
	{"ID" : "20", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_588", "Parent" : "0", "Child" : ["21"],
		...
		{"Name" : "a", "Type" : "None", "Direction" : "I"},
		{"Name" : "b", "Type" : "None", "Direction" : "I"}]},
	{"ID" : "21", "Level" : "2", "Path" : "`AUTOTB_DUT_INST.grp_fixed_point_mul_fu_588.cnn_conv_d8x8_k3xbkb_U0", "Parent" : "20"}]}
