set C_TypeInfoList {{ 
"cnn_pool_d20x20_p2x2" : [[], { "return": [[], "void"]} , [{"ExternC" : 0}], [ {"inStream": [[], {"reference": "0"}] }, {"outStream": [[], {"reference": "0"}] }, {"ctrl": [[],"1"] }],[],""], 
...
set moduleName cnn_pool_d20x20_p2x2
...
set C_modelName {cnn_pool_d20x20_p2x2}
...
set NewPortList {[ 
	{ "name": "s_axi_CTRL_AWADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CTRL", "role": "AWADDR" },"address":[{"name":"cnn_pool_d20x20_p2x2","role":"start","value":"0","valid_bit":"0"},{"name":"cnn_pool_d20x20_p2x2","role":"continue","value":"0","valid_bit":"4"},{"name":"cnn_pool_d20x20_p2x2","role":"auto_start","value":"0","valid_bit":"7"},{"name":"ctrl","role":"data","value":"16"}] },
	...
	{ "name": "s_axi_CTRL_ARADDR", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "CTRL", "role": "ARADDR" },"address":[{"name":"cnn_pool_d20x20_p2x2","role":"start","value":"0","valid_bit":"0"},{"name":"cnn_pool_d20x20_p2x2","role":"done","value":"0","valid_bit":"1"},{"name":"cnn_pool_d20x20_p2x2","role":"idle","value":"0","valid_bit":"2"},{"name":"cnn_pool_d20x20_p2x2","role":"ready","value":"0","valid_bit":"3"},{"name":"cnn_pool_d20x20_p2x2","role":"auto_start","value":"0","valid_bit":"7"}] },
...
set RtlHierarchyInfo {[
	...
	{"ID" : "1", "Level" : "1", "Path" : "`AUTOTB_DUT_INST.cnn_pool_d20x20_p2x2_CTRL_s_axi_U", "Parent" : "0"},
