...
#ifndef __cnn_conv_d16x16_kbkb__HH__
#define __cnn_conv_d16x16_kbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_conv_d16x16_kbkb) {
    ...
    SC_CTOR(cnn_conv_d16x16_kbkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
