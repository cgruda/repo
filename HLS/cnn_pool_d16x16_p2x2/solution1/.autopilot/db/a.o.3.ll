; ModuleID = 'D:/School/Project/new_repo/HLS/cnn_pool_d16x16_p2x2/solution1/.autopilot/db/a.o.3.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-f80:128:128-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S32"
target triple = "i686-pc-mingw32"

@llvm_global_ctors_1 = appending global [1 x void ()*] [void ()* @_GLOBAL__I_a] ; [#uses=0 type=[1 x void ()*]*]
@llvm_global_ctors_0 = appending global [1 x i32] [i32 65535] ; [#uses=0 type=[1 x i32]*]
@cnn_pool_d16x16_p2x2_1 = internal unnamed_addr constant [21 x i8] c"cnn_pool_d16x16_p2x2\00" ; [#uses=1 type=[21 x i8]*]
...
define void @cnn_pool_d16x16_p2x2(i32* %inStream_V_data_V, i4* %inStream_V_keep_V, i4* %inStream_V_strb_V, i2* %inStream_V_user_V, i1* %inStream_V_last_V, i5* %inStream_V_id_V, i6* %inStream_V_dest_V, i32* %outStream_V_data_V, i4* %outStream_V_keep_V, i4* %outStream_V_strb_V, i2* %outStream_V_user_V, i1* %outStream_V_last_V, i5* %outStream_V_id_V, i6* %outStream_V_dest_V, i32 %ctrl) {
  ...
  call void (...)* @_ssdm_op_SpecTopModule([21 x i8]* @cnn_pool_d16x16_p2x2_1) nounwind
  %ctrl_read = call i32 @_ssdm_op_Read.s_axilite.i32(i32 %ctrl) ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %ctrl_read}, i64 0, metadata !127), !dbg !2646 ; [debug line = 86:18] [debug variable = ctrl]
  %lineBuffer_0 = alloca [16 x i32], align 4      ; [#uses=3 type=[16 x i32]*]
  %lineBuffer_1 = alloca [16 x i32], align 4      ; [#uses=3 type=[16 x i32]*]
  call void @llvm.dbg.value(metadata !{i32* %inStream_V_data_V}, i64 0, metadata !2647), !dbg !2660 ; [debug line = 84:50] [debug variable = inStream.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_keep_V}, i64 0, metadata !2661), !dbg !2660 ; [debug line = 84:50] [debug variable = inStream.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_strb_V}, i64 0, metadata !2673), !dbg !2660 ; [debug line = 84:50] [debug variable = inStream.V.strb.V]
  call void @llvm.dbg.value(metadata !{i2* %inStream_V_user_V}, i64 0, metadata !2674), !dbg !2660 ; [debug line = 84:50] [debug variable = inStream.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %inStream_V_last_V}, i64 0, metadata !2686), !dbg !2660 ; [debug line = 84:50] [debug variable = inStream.V.last.V]
  call void @llvm.dbg.value(metadata !{i5* %inStream_V_id_V}, i64 0, metadata !2698), !dbg !2660 ; [debug line = 84:50] [debug variable = inStream.V.id.V]
  call void @llvm.dbg.value(metadata !{i6* %inStream_V_dest_V}, i64 0, metadata !2710), !dbg !2660 ; [debug line = 84:50] [debug variable = inStream.V.dest.V]
  call void @llvm.dbg.value(metadata !{i32* %outStream_V_data_V}, i64 0, metadata !2722), !dbg !2724 ; [debug line = 85:38] [debug variable = outStream.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %outStream_V_keep_V}, i64 0, metadata !2725), !dbg !2724 ; [debug line = 85:38] [debug variable = outStream.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %outStream_V_strb_V}, i64 0, metadata !2726), !dbg !2724 ; [debug line = 85:38] [debug variable = outStream.V.strb.V]
  call void @llvm.dbg.value(metadata !{i2* %outStream_V_user_V}, i64 0, metadata !2727), !dbg !2724 ; [debug line = 85:38] [debug variable = outStream.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %outStream_V_last_V}, i64 0, metadata !2728), !dbg !2724 ; [debug line = 85:38] [debug variable = outStream.V.last.V]
  call void @llvm.dbg.value(metadata !{i5* %outStream_V_id_V}, i64 0, metadata !2729), !dbg !2724 ; [debug line = 85:38] [debug variable = outStream.V.id.V]
  call void @llvm.dbg.value(metadata !{i6* %outStream_V_dest_V}, i64 0, metadata !2730), !dbg !2724 ; [debug line = 85:38] [debug variable = outStream.V.dest.V]
  call void @llvm.dbg.value(metadata !{i32 %ctrl}, i64 0, metadata !127), !dbg !2646 ; [debug line = 86:18] [debug variable = ctrl]
  call void (...)* @_ssdm_op_SpecInterface(i32* %outStream_V_data_V, i4* %outStream_V_keep_V, i4* %outStream_V_strb_V, i2* %outStream_V_user_V, i1* %outStream_V_last_V, i5* %outStream_V_id_V, i6* %outStream_V_dest_V, [5 x i8]* @p_str, i32 1, i32 1, [5 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str2, [1 x i8]* @p_str2, [1 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str2, [1 x i8]* @p_str2) nounwind, !dbg !2731 ; [debug line = 88:1]
  call void (...)* @_ssdm_op_SpecInterface(i32* %inStream_V_data_V, i4* %inStream_V_keep_V, i4* %inStream_V_strb_V, i2* %inStream_V_user_V, i1* %inStream_V_last_V, i5* %inStream_V_id_V, i6* %inStream_V_dest_V, [5 x i8]* @p_str, i32 1, i32 1, [5 x i8]* @p_str1, i32 0, i32 0, [1 x i8]* @p_str2, [1 x i8]* @p_str2, [1 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str2, [1 x i8]* @p_str2) nounwind, !dbg !2733 ; [debug line = 89:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 %ctrl, [10 x i8]* @p_str3, i32 0, i32 0, [1 x i8]* @p_str2, i32 0, i32 0, [5 x i8]* @p_str4, [1 x i8]* @p_str2, [1 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str2, [1 x i8]* @p_str2) nounwind, !dbg !2734 ; [debug line = 90:1]
  call void (...)* @_ssdm_op_SpecInterface(i32 0, [10 x i8]* @p_str3, i32 0, i32 0, [1 x i8]* @p_str2, i32 0, i32 0, [5 x i8]* @p_str4, [1 x i8]* @p_str2, [1 x i8]* @p_str2, i32 0, i32 0, i32 0, i32 0, [1 x i8]* @p_str2, [1 x i8]* @p_str2) nounwind, !dbg !2735 ; [debug line = 91:1]
  call void @llvm.dbg.declare(metadata !{[16 x i32]* %lineBuffer_0}, metadata !2736), !dbg !2744 ; [debug line = 93:12] [debug variable = lineBuffer[0]]
  call void @llvm.dbg.declare(metadata !{[16 x i32]* %lineBuffer_1}, metadata !2745), !dbg !2744 ; [debug line = 93:12] [debug variable = lineBuffer[1]]
  br label %1, !dbg !2746                         ; [debug line = 101:43]

; <label>:1                                       ; preds = %2, %0
  %x = phi i5 [ 14, %0 ], [ %x_1, %2 ]            ; [#uses=3 type=i5]
  %exitcond1 = icmp eq i5 %x, -16, !dbg !2746     ; [#uses=1 type=i1] [debug line = 101:43]
  br i1 %exitcond1, label %.preheader86.0.preheader, label %2, !dbg !2746 ; [debug line = 101:43]

.preheader86.0.preheader:                         ; preds = %1
  br label %.preheader86.0, !dbg !2748            ; [debug line = 109:17]

; <label>:2                                       ; preds = %1
  %x_cast = zext i5 %x to i32, !dbg !2746         ; [#uses=1 type=i32] [debug line = 101:43]
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 2, i64 2, i64 2) ; [#uses=0 type=i32]
  %tmp_1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str6), !dbg !2752 ; [#uses=1 type=i32] [debug line = 101:59]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind, !dbg !2754 ; [debug line = 102:1]
  call void @llvm.dbg.value(metadata !{i32* %inStream_V_data_V}, i64 0, metadata !2755), !dbg !2760 ; [debug line = 129:56@103:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_keep_V}, i64 0, metadata !2762), !dbg !2760 ; [debug line = 129:56@103:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_strb_V}, i64 0, metadata !2764), !dbg !2760 ; [debug line = 129:56@103:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.strb.V]
  call void @llvm.dbg.value(metadata !{i2* %inStream_V_user_V}, i64 0, metadata !2765), !dbg !2760 ; [debug line = 129:56@103:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %inStream_V_last_V}, i64 0, metadata !2767), !dbg !2760 ; [debug line = 129:56@103:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.last.V]
  call void @llvm.dbg.value(metadata !{i5* %inStream_V_id_V}, i64 0, metadata !2769), !dbg !2760 ; [debug line = 129:56@103:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.id.V]
  call void @llvm.dbg.value(metadata !{i6* %inStream_V_dest_V}, i64 0, metadata !2771), !dbg !2760 ; [debug line = 129:56@103:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.dest.V]
  %empty_5 = call { i32, i4, i4, i2, i1, i5, i6 } @_ssdm_op_Read.axis.volatile.i32P.i4P.i4P.i2P.i1P.i5P.i6P(i32* %inStream_V_data_V, i4* %inStream_V_keep_V, i4* %inStream_V_strb_V, i2* %inStream_V_user_V, i1* %inStream_V_last_V, i5* %inStream_V_id_V, i6* %inStream_V_dest_V), !dbg !2773 ; [#uses=1 type={ i32, i4, i4, i2, i1, i5, i6 }] [debug line = 131:9@103:19]
  %tmp_data_V = extractvalue { i32, i4, i4, i2, i1, i5, i6 } %empty_5, 0, !dbg !2773 ; [#uses=1 type=i32] [debug line = 131:9@103:19]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V}, i64 0, metadata !2775), !dbg !2773 ; [debug line = 131:9@103:19] [debug variable = tmp.data.V]
  %lineBuffer_0_addr = getelementptr [16 x i32]* %lineBuffer_0, i32 0, i32 %x_cast ; [#uses=1 type=i32*]
  store i32 %tmp_data_V, i32* %lineBuffer_0_addr, align 4, !dbg !2777 ; [debug line = 104:44]
  %empty_6 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str6, i32 %tmp_1), !dbg !2778 ; [#uses=0 type=i32] [debug line = 105:2]
  %x_1 = add i5 %x, 1, !dbg !2779                 ; [#uses=1 type=i5] [debug line = 101:53]
  call void @llvm.dbg.value(metadata !{i5 %x_1}, i64 0, metadata !2780), !dbg !2779 ; [debug line = 101:53] [debug variable = x]
  br label %1, !dbg !2779                         ; [debug line = 101:53]

.preheader86.0:                                   ; preds = %3, %.preheader86.0.preheader
  %x1 = phi i5 [ %x_2, %3 ], [ 0, %.preheader86.0.preheader ] ; [#uses=3 type=i5]
  %exitcond4 = icmp eq i5 %x1, -16, !dbg !2748    ; [#uses=1 type=i1] [debug line = 109:17]
  %x_2 = add i5 %x1, 1, !dbg !2781                ; [#uses=1 type=i5] [debug line = 109:27]
  br i1 %exitcond4, label %.preheader84.preheader, label %3, !dbg !2748 ; [debug line = 109:17]

.preheader84.preheader:                           ; preds = %.preheader86.0
  br label %.preheader84

; <label>:3                                       ; preds = %.preheader86.0
  %x1_cast = zext i5 %x1 to i32, !dbg !2748       ; [#uses=1 type=i32] [debug line = 109:17]
  %empty_7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 16, i64 16, i64 16) ; [#uses=0 type=i32]
  %tmp_2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str7), !dbg !2782 ; [#uses=1 type=i32] [debug line = 109:33]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind, !dbg !2784 ; [debug line = 110:1]
  call void @llvm.dbg.value(metadata !{i32* %inStream_V_data_V}, i64 0, metadata !2755), !dbg !2785 ; [debug line = 129:56@111:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_keep_V}, i64 0, metadata !2762), !dbg !2785 ; [debug line = 129:56@111:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_strb_V}, i64 0, metadata !2764), !dbg !2785 ; [debug line = 129:56@111:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.strb.V]
  call void @llvm.dbg.value(metadata !{i2* %inStream_V_user_V}, i64 0, metadata !2765), !dbg !2785 ; [debug line = 129:56@111:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %inStream_V_last_V}, i64 0, metadata !2767), !dbg !2785 ; [debug line = 129:56@111:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.last.V]
  call void @llvm.dbg.value(metadata !{i5* %inStream_V_id_V}, i64 0, metadata !2769), !dbg !2785 ; [debug line = 129:56@111:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.id.V]
  call void @llvm.dbg.value(metadata !{i6* %inStream_V_dest_V}, i64 0, metadata !2771), !dbg !2785 ; [debug line = 129:56@111:19] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.dest.V]
  %empty_8 = call { i32, i4, i4, i2, i1, i5, i6 } @_ssdm_op_Read.axis.volatile.i32P.i4P.i4P.i2P.i1P.i5P.i6P(i32* %inStream_V_data_V, i4* %inStream_V_keep_V, i4* %inStream_V_strb_V, i2* %inStream_V_user_V, i1* %inStream_V_last_V, i5* %inStream_V_id_V, i6* %inStream_V_dest_V), !dbg !2787 ; [#uses=1 type={ i32, i4, i4, i2, i1, i5, i6 }] [debug line = 131:9@111:19]
  %tmp_data_V_1 = extractvalue { i32, i4, i4, i2, i1, i5, i6 } %empty_8, 0, !dbg !2787 ; [#uses=1 type=i32] [debug line = 131:9@111:19]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_1}, i64 0, metadata !2775), !dbg !2787 ; [debug line = 131:9@111:19] [debug variable = tmp.data.V]
  %lineBuffer_1_addr = getelementptr [16 x i32]* %lineBuffer_1, i32 0, i32 %x1_cast ; [#uses=1 type=i32*]
  store i32 %tmp_data_V_1, i32* %lineBuffer_1_addr, align 4, !dbg !2788 ; [debug line = 112:23]
  %empty_9 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str7, i32 %tmp_2), !dbg !2789 ; [#uses=0 type=i32] [debug line = 113:3]
  br label %.preheader86.0, !dbg !2781            ; [debug line = 109:27]
...
.preheader83.preheader:                           ; preds = %.preheader84
  ...
  %tmp_7 = trunc i32 %ctrl_read to i1, !dbg !2803 ; [#uses=1 type=i1] [debug line = 139:19]
  store i32 18, i32* %readCount_1
  store i32 0, i32* %writeCount_1
  br label %.preheader82, !dbg !2820              ; [debug line = 128:16]
...
.preheader85:                                     ; preds = %.preheader84
  ...
  %exitcond = icmp eq i2 %x4, -1, !dbg !2821      ; [#uses=3 type=i1] [debug line = 121:35]
  %x4_mid2 = select i1 %exitcond, i2 1, i2 %x4    ; [#uses=3 type=i2]
  %y9 = add i2 1, %y3, !dbg !2825                 ; [#uses=1 type=i2] [debug line = 120:47]
  %tmp_3_mid2_v = select i1 %exitcond, i2 %y9, i2 %y3, !dbg !2826 ; [#uses=2 type=i2] [debug line = 123:2]
  %tmp_9 = trunc i2 %tmp_3_mid2_v to i1, !dbg !2826 ; [#uses=1 type=i1] [debug line = 123:2]
  %cond_mid1 = icmp eq i2 %y3, 0, !dbg !2826      ; [#uses=1 type=i1] [debug line = 123:2]
  %cond = icmp eq i2 %y3, 1, !dbg !2826           ; [#uses=1 type=i1] [debug line = 123:2]
  %cond_mid2 = select i1 %exitcond, i1 %cond_mid1, i1 %cond, !dbg !2826 ; [#uses=2 type=i1] [debug line = 123:2]
  %x4_cast9 = zext i2 %x4_mid2 to i5, !dbg !2821  ; [#uses=1 type=i5] [debug line = 121:35]
  %tmp_4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str8), !dbg !2828 ; [#uses=1 type=i32] [debug line = 121:54]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind, !dbg !2829 ; [debug line = 122:1]
  %tmp_5 = add i5 15, %x4_cast9, !dbg !2826       ; [#uses=1 type=i5] [debug line = 123:2]
  %tmp_5_cast = zext i5 %tmp_5 to i32, !dbg !2826 ; [#uses=2 type=i32] [debug line = 123:2]
  %lineBuffer_0_addr_1 = getelementptr [16 x i32]* %lineBuffer_0, i32 0, i32 %tmp_5_cast, !dbg !2826 ; [#uses=1 type=i32*] [debug line = 123:2]
  %lineBuffer_1_addr_1 = getelementptr [16 x i32]* %lineBuffer_1, i32 0, i32 %tmp_5_cast, !dbg !2826 ; [#uses=1 type=i32*] [debug line = 123:2]
  %lineBuffer_0_load = load i32* %lineBuffer_0_addr_1, align 4, !dbg !2826 ; [#uses=1 type=i32] [debug line = 123:2]
  %lineBuffer_1_load = load i32* %lineBuffer_1_addr_1, align 4, !dbg !2826 ; [#uses=1 type=i32] [debug line = 123:2]
  %window_2_2_7 = select i1 %tmp_9, i32 %lineBuffer_0_load, i32 %lineBuffer_1_load, !dbg !2826 ; [#uses=2 type=i32] [debug line = 123:2]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_7}, i64 0, metadata !2819), !dbg !2826 ; [debug line = 123:2] [debug variable = window[2][2]]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_7}, i64 0, metadata !2830), !dbg !2826 ; [debug line = 123:2] [debug variable = window[2][1]]
  %cond1 = icmp eq i2 %x4_mid2, 1, !dbg !2826     ; [#uses=2 type=i1] [debug line = 123:2]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_7}, i64 0, metadata !2831), !dbg !2826 ; [debug line = 123:2] [debug variable = window[1][1]]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_7}, i64 0, metadata !2832), !dbg !2826 ; [debug line = 123:2] [debug variable = window[1][2]]
  %window_2_2 = select i1 %cond1, i32 %window_1_2_1, i32 %window_2_2_7, !dbg !2826 ; [#uses=1 type=i32] [debug line = 123:2]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2}, i64 0, metadata !2819), !dbg !2826 ; [debug line = 123:2] [debug variable = window[2][2]]
  %window_2_2_1 = select i1 %cond1, i32 %window_2_2_7, i32 %window_1_1_1, !dbg !2826 ; [#uses=1 type=i32] [debug line = 123:2]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_1}, i64 0, metadata !2819), !dbg !2826 ; [debug line = 123:2] [debug variable = window[2][2]]
  %window_2_2_4 = select i1 %cond_mid2, i32 %window_2_2, i32 %window_1_2_1 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_4}, i64 0, metadata !2819), !dbg !2826 ; [debug line = 123:2] [debug variable = window[2][2]]
  %window_2_2_5 = select i1 %cond_mid2, i32 %window_2_2_1, i32 %window_1_1_1 ; [#uses=1 type=i32]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_5}, i64 0, metadata !2819), !dbg !2826 ; [debug line = 123:2] [debug variable = window[2][2]]
  %empty_11 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str8, i32 %tmp_4), !dbg !2833 ; [#uses=0 type=i32] [debug line = 124:3]
  %x_3 = add i2 1, %x4_mid2, !dbg !2834           ; [#uses=1 type=i2] [debug line = 121:48]
  call void @llvm.dbg.value(metadata !{i2 %x_3}, i64 0, metadata !2835), !dbg !2834 ; [debug line = 121:48] [debug variable = x]
  br label %.preheader84, !dbg !2834              ; [debug line = 121:48]
...
.preheader82:                                     ; preds = %._crit_edge88, %.preheader83.preheader
  ...
  %y_assign = phi i5 [ 0, %.preheader83.preheader ], [ %y_assign_cast7_mid2_s, %._crit_edge88 ] ; [#uses=2 type=i5]
  ...
  %window_0_0_read_as_1 = load i32* %window_0_0_read_as, !dbg !2836 ; [#uses=3 type=i32] [debug line = 62:4@139:19]
  %window_0_0_load = load i32* %window_0_0, !dbg !2836 ; [#uses=4 type=i32] [debug line = 62:4@139:19]
  %window_0_1_load = load i32* %window_0_1        ; [#uses=1 type=i32]
  %window_1_0_read_as_1 = load i32* %window_1_0_read_as, !dbg !2836 ; [#uses=3 type=i32] [debug line = 62:4@139:19]
...
_ifconv1:                                         ; preds = %.preheader83
  %writeCount_1_load = load i32* %writeCount_1, !dbg !2842 ; [#uses=1 type=i32] [debug line = 137:5]
  %writeCount = add nsw i32 %writeCount_1_load, 1, !dbg !2842 ; [#uses=2 type=i32] [debug line = 137:5]
  call void @llvm.dbg.value(metadata !{i32 %writeCount}, i64 0, metadata !2843), !dbg !2842 ; [debug line = 137:5] [debug variable = writeCount]
  call void @llvm.dbg.value(metadata !{i32 %window_1_0}, i64 0, metadata !2844), !dbg !2845 ; [debug line = 51:44@139:19] [debug variable = window[1][1]]
  call void @llvm.dbg.value(metadata !{i1 %tmp_7}, i64 0, metadata !2846), !dbg !2847 ; [debug line = 51:84@139:19] [debug variable = op]
  %tmp_4_0_1_i = icmp ugt i32 %window_0_0_load, %window_0_0_read_as_1, !dbg !2848 ; [#uses=1 type=i1] [debug line = 59:4@139:19]
  %maxValue_0_1_maxVal = select i1 %tmp_4_0_1_i, i32 %window_0_0_load, i32 %window_0_0_read_as_1, !dbg !2848 ; [#uses=2 type=i32] [debug line = 59:4@139:19]
  %tmp_4_1_i = icmp ult i32 %maxValue_0_1_maxVal, %window_1_0_read_as_1, !dbg !2848 ; [#uses=1 type=i1] [debug line = 59:4@139:19]
  %maxValue_17_0_maxVal = select i1 %tmp_4_1_i, i32 %window_1_0_read_as_1, i32 %maxValue_0_1_maxVal, !dbg !2848 ; [#uses=2 type=i32] [debug line = 59:4@139:19]
  %tmp_4_1_1_i = icmp ult i32 %maxValue_17_0_maxVal, %window_1_0, !dbg !2848 ; [#uses=1 type=i1] [debug line = 59:4@139:19]
  %sel_SEBB_i = select i1 %tmp_4_1_1_i, i32 %window_1_0, i32 %maxValue_17_0_maxVal, !dbg !2848 ; [#uses=1 type=i32] [debug line = 59:4@139:19]
  %tmp3 = add i32 %window_0_0_read_as_1, %window_1_0_read_as_1, !dbg !2836 ; [#uses=1 type=i32] [debug line = 62:4@139:19]
  %tmp4 = add i32 %window_0_0_load, %window_1_0, !dbg !2836 ; [#uses=1 type=i32] [debug line = 62:4@139:19]
  %a_assign = add i32 %tmp4, %tmp3, !dbg !2836    ; [#uses=3 type=i32] [debug line = 62:4@139:19]
  call void @llvm.dbg.value(metadata !{i32 %a_assign}, i64 0, metadata !2849), !dbg !2856 ; [debug line = 69:44@69:12@139:19] [debug variable = a]
  %tmp_12 = call i1 @_ssdm_op_BitSelect.i1.i32.i32(i32 %a_assign, i32 31), !dbg !2857 ; [#uses=2 type=i1] [debug line = 74:2@69:12@139:19]
  %tmp_1_i_i = sub i32 0, %a_assign, !dbg !2857   ; [#uses=1 type=i32] [debug line = 74:2@69:12@139:19]
  %tmp_3 = call i20 @_ssdm_op_PartSelect.i20.i32.i32.i32(i32 %tmp_1_i_i, i32 2, i32 21), !dbg !2859 ; [#uses=1 type=i20] [debug line = 77:2@69:12@139:19]
  %tmp_6 = call i20 @_ssdm_op_PartSelect.i20.i32.i32.i32(i32 %a_assign, i32 2, i32 21), !dbg !2859 ; [#uses=1 type=i20] [debug line = 77:2@69:12@139:19]
  %result = select i1 %tmp_12, i20 %tmp_3, i20 %tmp_6, !dbg !2857 ; [#uses=1 type=i20] [debug line = 74:2@69:12@139:19]
  %result_cast = zext i20 %result to i21, !dbg !2859 ; [#uses=2 type=i21] [debug line = 77:2@69:12@139:19]
  call void @llvm.dbg.value(metadata !{i20 %result}, i64 0, metadata !2860), !dbg !2859 ; [debug line = 77:2@69:12@139:19] [debug variable = result]
  %tmp_4_i_i = sub i21 0, %result_cast, !dbg !2861 ; [#uses=1 type=i21] [debug line = 79:2@69:12@139:19]
  %result_1 = select i1 %tmp_12, i21 %tmp_4_i_i, i21 %result_cast, !dbg !2861 ; [#uses=1 type=i21] [debug line = 79:2@69:12@139:19]
  %result_1_cast = sext i21 %result_1 to i32, !dbg !2861 ; [#uses=1 type=i32] [debug line = 79:2@69:12@139:19]
  call void @llvm.dbg.value(metadata !{i21 %result_1}, i64 0, metadata !2860), !dbg !2861 ; [debug line = 79:2@69:12@139:19] [debug variable = result]
  call void @llvm.dbg.value(metadata !{i21 %result_1}, i64 0, metadata !2862), !dbg !2854 ; [debug line = 69:12@139:19] [debug variable = result]
  %tmp_data_V_2 = select i1 %tmp_7, i32 %result_1_cast, i32 %sel_SEBB_i, !dbg !2863 ; [#uses=1 type=i32] [debug line = 145:31@147:5]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_2}, i64 0, metadata !2867), !dbg !2869 ; [debug line = 251:64@139:19] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_2}, i64 0, metadata !2870), !dbg !2872 ; [debug line = 251:64@251:86@139:19] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32 %writeCount}, i64 0, metadata !2813), !dbg !2874 ; [debug line = 75:24@145:19] [debug variable = writeCount]
  %tmp_last_V = icmp eq i32 %writeCount, 64, !dbg !2875 ; [#uses=1 type=i1] [debug line = 76:2@145:19]
  call void @llvm.dbg.value(metadata !{i1 %tmp_last_V}, i64 0, metadata !2877), !dbg !2879 ; [debug line = 245:56@145:19] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i1 %tmp_last_V}, i64 0, metadata !2880), !dbg !2882 ; [debug line = 245:56@245:78@145:19] [debug variable = val]
  call void @llvm.dbg.value(metadata !{i32* %outStream_V_data_V}, i64 0, metadata !2884), !dbg !2886 ; [debug line = 144:48@147:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %outStream_V_keep_V}, i64 0, metadata !2887), !dbg !2886 ; [debug line = 144:48@147:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %outStream_V_strb_V}, i64 0, metadata !2888), !dbg !2886 ; [debug line = 144:48@147:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.strb.V]
  call void @llvm.dbg.value(metadata !{i2* %outStream_V_user_V}, i64 0, metadata !2889), !dbg !2886 ; [debug line = 144:48@147:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %outStream_V_last_V}, i64 0, metadata !2890), !dbg !2886 ; [debug line = 144:48@147:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.last.V]
  call void @llvm.dbg.value(metadata !{i5* %outStream_V_id_V}, i64 0, metadata !2891), !dbg !2886 ; [debug line = 144:48@147:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.id.V]
  call void @llvm.dbg.value(metadata !{i6* %outStream_V_dest_V}, i64 0, metadata !2892), !dbg !2886 ; [debug line = 144:48@147:5] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.dest.V]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_2}, i64 0, metadata !2893), !dbg !2863 ; [debug line = 145:31@147:5] [debug variable = tmp.data.V]
  call void @llvm.dbg.value(metadata !{i1 %tmp_last_V}, i64 0, metadata !2895), !dbg !2863 ; [debug line = 145:31@147:5] [debug variable = tmp.last.V]
  call void @_ssdm_op_Write.axis.volatile.i32P.i4P.i4P.i2P.i1P.i5P.i6P(i32* %outStream_V_data_V, i4* %outStream_V_keep_V, i4* %outStream_V_strb_V, i2* %outStream_V_user_V, i1* %outStream_V_last_V, i5* %outStream_V_id_V, i6* %outStream_V_dest_V, i32 %tmp_data_V_2, i4 -1, i4 0, i2 0, i1 %tmp_last_V, i5 0, i6 0), !dbg !2896 ; [debug line = 146:9@147:5]
  store i32 %writeCount, i32* %writeCount_1, !dbg !2874 ; [debug line = 75:24@145:19]
  br label %._crit_edge, !dbg !2897               ; [debug line = 148:4]

._crit_edge:                                      ; preds = %.preheader83, %_ifconv1
  %readCount_1_load = load i32* %readCount_1, !dbg !2898 ; [#uses=2 type=i32] [debug line = 158:4]
  %lineBuffer_0_addr_2 = getelementptr [16 x i32]* %lineBuffer_0, i32 0, i32 %x_assign_cast5 ; [#uses=2 type=i32*]
  %windowRightCol_0 = load i32* %lineBuffer_0_addr_2, align 4, !dbg !2899 ; [#uses=1 type=i32] [debug line = 151:4]
  call void @llvm.dbg.value(metadata !{i32 %windowRightCol_0}, i64 0, metadata !2900), !dbg !2899 ; [debug line = 151:4] [debug variable = windowRightCol[0]]
  %lineBuffer_1_addr_2 = getelementptr [16 x i32]* %lineBuffer_1, i32 0, i32 %x_assign_cast5 ; [#uses=2 type=i32*]
  %windowRightCol_1 = load i32* %lineBuffer_1_addr_2, align 4, !dbg !2903 ; [#uses=2 type=i32] [debug line = 153:5]
  store i32 %windowRightCol_1, i32* %lineBuffer_0_addr_2, align 4, !dbg !2903 ; [debug line = 153:5]
  call void @llvm.dbg.value(metadata !{i32 %windowRightCol_1}, i64 0, metadata !2906), !dbg !2903 ; [debug line = 153:5] [debug variable = windowRightCol[1]]
  %tmp_13 = call i24 @_ssdm_op_PartSelect.i24.i32.i32.i32(i32 %readCount_1_load, i32 8, i32 31), !dbg !2898 ; [#uses=1 type=i24] [debug line = 158:4]
  %icmp = icmp slt i24 %tmp_13, 1, !dbg !2898     ; [#uses=1 type=i1] [debug line = 158:4]
  store i32 %windowRightCol_0, i32* %window_0_1
  br i1 %icmp, label %4, label %._crit_edge88, !dbg !2898 ; [debug line = 158:4]

; <label>:4                                       ; preds = %._crit_edge
  call void @llvm.dbg.value(metadata !{i32* %inStream_V_data_V}, i64 0, metadata !2755), !dbg !2907 ; [debug line = 129:56@159:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.data.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_keep_V}, i64 0, metadata !2762), !dbg !2907 ; [debug line = 129:56@159:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.keep.V]
  call void @llvm.dbg.value(metadata !{i4* %inStream_V_strb_V}, i64 0, metadata !2764), !dbg !2907 ; [debug line = 129:56@159:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.strb.V]
  call void @llvm.dbg.value(metadata !{i2* %inStream_V_user_V}, i64 0, metadata !2765), !dbg !2907 ; [debug line = 129:56@159:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.user.V]
  call void @llvm.dbg.value(metadata !{i1* %inStream_V_last_V}, i64 0, metadata !2767), !dbg !2907 ; [debug line = 129:56@159:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.last.V]
  call void @llvm.dbg.value(metadata !{i5* %inStream_V_id_V}, i64 0, metadata !2769), !dbg !2907 ; [debug line = 129:56@159:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.id.V]
  call void @llvm.dbg.value(metadata !{i6* %inStream_V_dest_V}, i64 0, metadata !2771), !dbg !2907 ; [debug line = 129:56@159:13] [debug variable = stream<ap_axiu<32, 2, 5, 6> >.V.dest.V]
  %empty_12 = call { i32, i4, i4, i2, i1, i5, i6 } @_ssdm_op_Read.axis.volatile.i32P.i4P.i4P.i2P.i1P.i5P.i6P(i32* %inStream_V_data_V, i4* %inStream_V_keep_V, i4* %inStream_V_strb_V, i2* %inStream_V_user_V, i1* %inStream_V_last_V, i5* %inStream_V_id_V, i6* %inStream_V_dest_V), !dbg !2910 ; [#uses=1 type={ i32, i4, i4, i2, i1, i5, i6 }] [debug line = 131:9@159:13]
  %tmp_data_V_4 = extractvalue { i32, i4, i4, i2, i1, i5, i6 } %empty_12, 0, !dbg !2910 ; [#uses=1 type=i32] [debug line = 131:9@159:13]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_4}, i64 0, metadata !2775), !dbg !2910 ; [debug line = 131:9@159:13] [debug variable = tmp.data.V]
  call void @llvm.dbg.value(metadata !{i32 %tmp_data_V_4}, i64 0, metadata !2911), !dbg !2914 ; [debug line = 277:10@100:10@159:13] [debug variable = valIn.data.V]
  %readCount = add nsw i32 %readCount_1_load, 1, !dbg !2920 ; [#uses=1 type=i32] [debug line = 160:5]
  call void @llvm.dbg.value(metadata !{i32 %readCount}, i64 0, metadata !2818), !dbg !2920 ; [debug line = 160:5] [debug variable = readCount]
  store i32 %tmp_data_V_4, i32* %window_2_2_2, !dbg !2910 ; [debug line = 131:9@159:13]
  store i32 %readCount, i32* %readCount_1, !dbg !2920 ; [debug line = 160:5]
  br label %._crit_edge88, !dbg !2921             ; [debug line = 161:4]

._crit_edge88:                                    ; preds = %4, %._crit_edge
  %window_2_2_6 = load i32* %window_2_2_2         ; [#uses=1 type=i32]
  store i32 %window_2_2_6, i32* %lineBuffer_1_addr_2, align 4, !dbg !2922 ; [debug line = 162:59]
  call void @llvm.dbg.value(metadata !{i32 %window_1_0}, i64 0, metadata !2923), !dbg !2924 ; [debug line = 167:6] [debug variable = window[1][0]]
  call void @llvm.dbg.value(metadata !{i32 %window_1_1}, i64 0, metadata !2831), !dbg !2924 ; [debug line = 167:6] [debug variable = window[1][1]]
  call void @llvm.dbg.value(metadata !{i32 %windowRightCol_0}, i64 0, metadata !2929), !dbg !2930 ; [debug line = 173:5] [debug variable = window[0][2]]
  call void @llvm.dbg.value(metadata !{i32 %windowRightCol_1}, i64 0, metadata !2832), !dbg !2930 ; [debug line = 173:5] [debug variable = window[1][2]]
  call void @llvm.dbg.value(metadata !{i32 %window_2_2_6}, i64 0, metadata !2819), !dbg !2930 ; [debug line = 173:5] [debug variable = window[2][2]]
  %empty_13 = call i32 (...)* @_ssdm_op_SpecRegionEnd([12 x i8]* @p_str9, i32 %tmp_8), !dbg !2933 ; [#uses=0 type=i32] [debug line = 175:3]
  %x_4 = add i5 %x_assign_mid2, 1, !dbg !2934     ; [#uses=1 type=i5] [debug line = 129:27]
  call void @llvm.dbg.value(metadata !{i5 %x_4}, i64 0, metadata !2935), !dbg !2934 ; [debug line = 129:27] [debug variable = x]
  br label %.preheader82, !dbg !2934              ; [debug line = 129:27]

.preheader83:                                     ; preds = %.preheader82
  %empty_14 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 256, i64 256, i64 256) ; [#uses=0 type=i32]
  %exitcond2 = icmp eq i5 %x_assign, -16, !dbg !2936 ; [#uses=2 type=i1] [debug line = 129:17]
  %x_assign_mid2 = select i1 %exitcond2, i5 0, i5 %x_assign ; [#uses=3 type=i5]
  %y_s = add i5 1, %y_assign, !dbg !2937          ; [#uses=1 type=i5] [debug line = 128:26]
  %y_assign_cast7_mid2_s = select i1 %exitcond2, i5 %y_s, i5 %y_assign, !dbg !2820 ; [#uses=2 type=i5] [debug line = 128:16]
  %tmp_10 = trunc i5 %y_assign_cast7_mid2_s to i1, !dbg !2820 ; [#uses=1 type=i1] [debug line = 128:16]
  %tmp_11 = trunc i5 %x_assign_mid2 to i1, !dbg !2936 ; [#uses=1 type=i1] [debug line = 129:17]
  %x_assign_cast5 = zext i5 %x_assign_mid2 to i32, !dbg !2936 ; [#uses=2 type=i32] [debug line = 129:17]
  %tmp_8 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str9), !dbg !2938 ; [#uses=1 type=i32] [debug line = 129:33]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind, !dbg !2939 ; [debug line = 130:1]
  call void @llvm.dbg.value(metadata !{i5 %x_assign}, i64 0, metadata !2940), !dbg !2945 ; [debug line = 45:26@133:9] [debug variable = x]
  call void @llvm.dbg.value(metadata !{i5 %y_assign}, i64 0, metadata !2946), !dbg !2947 ; [debug line = 45:33@133:9] [debug variable = y]
  %tmp = and i1 %tmp_10, %tmp_11, !dbg !2948      ; [#uses=1 type=i1] [debug line = 47:2@133:9]
  br i1 %tmp, label %_ifconv1, label %._crit_edge, !dbg !2948 ; [debug line = 47:2@133:9]

; <label>:5                                       ; preds = %.preheader82
  ret void, !dbg !2950                            ; [debug line = 177:1]
}
...
entry:
  ...
  %empty_21 = trunc i32 %empty to i24             ; [#uses=1 type=i24]
  ret i24 %empty_21
}
...
!127 = metadata !{i32 786689, metadata !128, metadata !"ctrl", metadata !129, i32 50331734, metadata !2645, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!128 = metadata !{i32 786478, i32 0, metadata !129, metadata !"cnn_pool_d16x16_p2x2", metadata !"cnn_pool_d16x16_p2x2", metadata !"_Z20cnn_pool_d16x16_p2x2RN3hls6streamI7ap_axiuILi32ELi2ELi5ELi6EEEES4_j", metadata !129, i32 84, metadata !130, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !159, i32 87} ; [ DW_TAG_subprogram ]
!129 = metadata !{i32 786473, metadata !"cnn_pool_d16x16_p2x2/core.cpp", metadata !"D:\5CSchool\5CProject\5Cnew_repo\5CHLS", null} ; [ DW_TAG_file_type ]
...
!2646 = metadata !{i32 86, i32 18, metadata !128, null}
!2647 = metadata !{i32 790531, metadata !2648, metadata !"inStream.V.data.V", null, i32 84, metadata !2649, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2648 = metadata !{i32 786689, metadata !128, metadata !"inStream", metadata !129, i32 16777300, metadata !132, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
...
!2660 = metadata !{i32 84, i32 50, metadata !128, null}
!2661 = metadata !{i32 790531, metadata !2648, metadata !"inStream.V.keep.V", null, i32 84, metadata !2662, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
...
!2673 = metadata !{i32 790531, metadata !2648, metadata !"inStream.V.strb.V", null, i32 84, metadata !2662, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2674 = metadata !{i32 790531, metadata !2648, metadata !"inStream.V.user.V", null, i32 84, metadata !2675, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
...
!2686 = metadata !{i32 790531, metadata !2648, metadata !"inStream.V.last.V", null, i32 84, metadata !2687, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
...
!2698 = metadata !{i32 790531, metadata !2648, metadata !"inStream.V.id.V", null, i32 84, metadata !2699, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
...
!2710 = metadata !{i32 790531, metadata !2648, metadata !"inStream.V.dest.V", null, i32 84, metadata !2711, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
...
!2722 = metadata !{i32 790531, metadata !2723, metadata !"outStream.V.data.V", null, i32 85, metadata !2649, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2723 = metadata !{i32 786689, metadata !128, metadata !"outStream", metadata !129, i32 33554517, metadata !132, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2724 = metadata !{i32 85, i32 38, metadata !128, null}
!2725 = metadata !{i32 790531, metadata !2723, metadata !"outStream.V.keep.V", null, i32 85, metadata !2662, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2726 = metadata !{i32 790531, metadata !2723, metadata !"outStream.V.strb.V", null, i32 85, metadata !2662, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2727 = metadata !{i32 790531, metadata !2723, metadata !"outStream.V.user.V", null, i32 85, metadata !2675, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2728 = metadata !{i32 790531, metadata !2723, metadata !"outStream.V.last.V", null, i32 85, metadata !2687, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2729 = metadata !{i32 790531, metadata !2723, metadata !"outStream.V.id.V", null, i32 85, metadata !2699, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2730 = metadata !{i32 790531, metadata !2723, metadata !"outStream.V.dest.V", null, i32 85, metadata !2711, i32 0, i32 0} ; [ DW_TAG_arg_variable_field ]
!2731 = metadata !{i32 88, i32 1, metadata !2732, null}
!2732 = metadata !{i32 786443, metadata !128, i32 87, i32 1, metadata !129, i32 0} ; [ DW_TAG_lexical_block ]
!2733 = metadata !{i32 89, i32 1, metadata !2732, null}
!2734 = metadata !{i32 90, i32 1, metadata !2732, null}
!2735 = metadata !{i32 91, i32 1, metadata !2732, null}
!2736 = metadata !{i32 790529, metadata !2737, metadata !"lineBuffer[0]", null, i32 93, metadata !2743, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2737 = metadata !{i32 786688, metadata !2732, metadata !"lineBuffer", metadata !129, i32 93, metadata !2738, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2738 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1024, i64 32, i32 0, i32 0, metadata !2739, metadata !2740, i32 0, i32 0} ; [ DW_TAG_array_type ]
...
!2742 = metadata !{i32 786465, i64 0, i64 15}     ; [ DW_TAG_subrange_type ]
!2743 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 512, i64 32, i32 0, i32 0, metadata !2739, metadata !2740, i32 0, i32 0} ; [ DW_TAG_array_type ]
!2744 = metadata !{i32 93, i32 12, metadata !2732, null}
!2745 = metadata !{i32 790529, metadata !2737, metadata !"lineBuffer[1]", null, i32 93, metadata !2743, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2746 = metadata !{i32 101, i32 43, metadata !2747, null}
!2747 = metadata !{i32 786443, metadata !2732, i32 101, i32 2, metadata !129, i32 1} ; [ DW_TAG_lexical_block ]
!2748 = metadata !{i32 109, i32 17, metadata !2749, null}
!2749 = metadata !{i32 786443, metadata !2750, i32 109, i32 3, metadata !129, i32 5} ; [ DW_TAG_lexical_block ]
!2750 = metadata !{i32 786443, metadata !2751, i32 108, i32 56, metadata !129, i32 4} ; [ DW_TAG_lexical_block ]
!2751 = metadata !{i32 786443, metadata !2732, i32 108, i32 2, metadata !129, i32 3} ; [ DW_TAG_lexical_block ]
!2752 = metadata !{i32 101, i32 59, metadata !2753, null}
!2753 = metadata !{i32 786443, metadata !2747, i32 101, i32 58, metadata !129, i32 2} ; [ DW_TAG_lexical_block ]
!2754 = metadata !{i32 102, i32 1, metadata !2753, null}
...
!2761 = metadata !{i32 103, i32 19, metadata !2753, null}
...
!2777 = metadata !{i32 104, i32 44, metadata !2753, null}
!2778 = metadata !{i32 105, i32 2, metadata !2753, null}
!2779 = metadata !{i32 101, i32 53, metadata !2747, null}
!2780 = metadata !{i32 786688, metadata !2747, metadata !"x", metadata !129, i32 101, metadata !168, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2781 = metadata !{i32 109, i32 27, metadata !2749, null}
!2782 = metadata !{i32 109, i32 33, metadata !2783, null}
!2783 = metadata !{i32 786443, metadata !2749, i32 109, i32 32, metadata !129, i32 6} ; [ DW_TAG_lexical_block ]
!2784 = metadata !{i32 110, i32 1, metadata !2783, null}
!2785 = metadata !{i32 129, i32 56, metadata !2757, metadata !2786}
!2786 = metadata !{i32 111, i32 19, metadata !2783, null}
!2787 = metadata !{i32 131, i32 9, metadata !2774, metadata !2786}
!2788 = metadata !{i32 112, i32 23, metadata !2783, null}
!2789 = metadata !{i32 113, i32 3, metadata !2783, null}
...
!2803 = metadata !{i32 139, i32 19, metadata !2804, null}
!2804 = metadata !{i32 786443, metadata !2805, i32 133, i32 25, metadata !129, i32 15} ; [ DW_TAG_lexical_block ]
!2805 = metadata !{i32 786443, metadata !2806, i32 129, i32 32, metadata !129, i32 14} ; [ DW_TAG_lexical_block ]
!2806 = metadata !{i32 786443, metadata !2807, i32 129, i32 3, metadata !129, i32 13} ; [ DW_TAG_lexical_block ]
!2807 = metadata !{i32 786443, metadata !2808, i32 128, i32 31, metadata !129, i32 12} ; [ DW_TAG_lexical_block ]
!2808 = metadata !{i32 786443, metadata !2732, i32 128, i32 2, metadata !129, i32 11} ; [ DW_TAG_lexical_block ]
!2809 = metadata !{i32 790529, metadata !2810, metadata !"window[0][0]", null, i32 94, metadata !2802, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2810 = metadata !{i32 786688, metadata !2732, metadata !"window", metadata !129, i32 94, metadata !2799, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2811 = metadata !{i32 790529, metadata !2810, metadata !"window[0][1]", null, i32 94, metadata !2802, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
...
!2817 = metadata !{i32 145, i32 19, metadata !2804, null}
!2818 = metadata !{i32 786688, metadata !2732, metadata !"readCount", metadata !129, i32 116, metadata !168, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2819 = metadata !{i32 790529, metadata !2810, metadata !"window[2][2]", null, i32 94, metadata !2802, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2820 = metadata !{i32 128, i32 16, metadata !2808, null}
!2821 = metadata !{i32 121, i32 35, metadata !2822, null}
!2822 = metadata !{i32 786443, metadata !2823, i32 121, i32 3, metadata !129, i32 9} ; [ DW_TAG_lexical_block ]
!2823 = metadata !{i32 786443, metadata !2824, i32 120, i32 52, metadata !129, i32 8} ; [ DW_TAG_lexical_block ]
!2824 = metadata !{i32 786443, metadata !2732, i32 120, i32 2, metadata !129, i32 7} ; [ DW_TAG_lexical_block ]
!2825 = metadata !{i32 120, i32 47, metadata !2824, null}
!2826 = metadata !{i32 123, i32 2, metadata !2827, null}
!2827 = metadata !{i32 786443, metadata !2822, i32 121, i32 53, metadata !129, i32 10} ; [ DW_TAG_lexical_block ]
!2828 = metadata !{i32 121, i32 54, metadata !2827, null}
!2829 = metadata !{i32 122, i32 1, metadata !2827, null}
!2830 = metadata !{i32 790529, metadata !2810, metadata !"window[2][1]", null, i32 94, metadata !2802, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2831 = metadata !{i32 790529, metadata !2810, metadata !"window[1][1]", null, i32 94, metadata !2802, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2832 = metadata !{i32 790529, metadata !2810, metadata !"window[1][2]", null, i32 94, metadata !2802, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2833 = metadata !{i32 124, i32 3, metadata !2827, null}
!2834 = metadata !{i32 121, i32 48, metadata !2822, null}
!2835 = metadata !{i32 786688, metadata !2822, metadata !"x", metadata !129, i32 121, metadata !168, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!2842 = metadata !{i32 137, i32 5, metadata !2804, null}
!2843 = metadata !{i32 786688, metadata !2732, metadata !"writeCount", metadata !129, i32 117, metadata !168, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!2851 = metadata !{i32 786473, metadata !"cnn_pool_d16x16_p2x2/fixed_point.h", metadata !"D:\5CSchool\5CProject\5Cnew_repo\5CHLS", null} ; [ DW_TAG_file_type ]
...
!2866 = metadata !{i32 147, i32 5, metadata !2804, null}
...
!2897 = metadata !{i32 148, i32 4, metadata !2804, null}
!2898 = metadata !{i32 158, i32 4, metadata !2805, null}
!2899 = metadata !{i32 151, i32 4, metadata !2805, null}
!2900 = metadata !{i32 790529, metadata !2901, metadata !"windowRightCol[0]", null, i32 95, metadata !2902, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2901 = metadata !{i32 786688, metadata !2732, metadata !"windowRightCol", metadata !129, i32 95, metadata !2796, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!2903 = metadata !{i32 153, i32 5, metadata !2904, null}
!2904 = metadata !{i32 786443, metadata !2905, i32 152, i32 40, metadata !129, i32 17} ; [ DW_TAG_lexical_block ]
!2905 = metadata !{i32 786443, metadata !2805, i32 152, i32 4, metadata !129, i32 16} ; [ DW_TAG_lexical_block ]
!2906 = metadata !{i32 790529, metadata !2901, metadata !"windowRightCol[1]", null, i32 95, metadata !2902, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2907 = metadata !{i32 129, i32 56, metadata !2757, metadata !2908}
!2908 = metadata !{i32 159, i32 13, metadata !2909, null}
!2909 = metadata !{i32 786443, metadata !2805, i32 158, i32 29, metadata !129, i32 18} ; [ DW_TAG_lexical_block ]
!2910 = metadata !{i32 131, i32 9, metadata !2774, metadata !2908}
!2911 = metadata !{i32 790529, metadata !2912, metadata !"valIn.data.V", null, i32 157, metadata !2652, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2912 = metadata !{i32 786688, metadata !2805, metadata !"valIn", metadata !129, i32 157, metadata !2913, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
...
!2920 = metadata !{i32 160, i32 5, metadata !2909, null}
!2921 = metadata !{i32 161, i32 4, metadata !2909, null}
!2922 = metadata !{i32 162, i32 59, metadata !2805, null}
!2923 = metadata !{i32 790529, metadata !2810, metadata !"window[1][0]", null, i32 94, metadata !2802, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2924 = metadata !{i32 167, i32 6, metadata !2925, null}
!2925 = metadata !{i32 786443, metadata !2926, i32 166, i32 41, metadata !129, i32 22} ; [ DW_TAG_lexical_block ]
!2926 = metadata !{i32 786443, metadata !2927, i32 166, i32 5, metadata !129, i32 21} ; [ DW_TAG_lexical_block ]
!2927 = metadata !{i32 786443, metadata !2928, i32 165, i32 36, metadata !129, i32 20} ; [ DW_TAG_lexical_block ]
!2928 = metadata !{i32 786443, metadata !2805, i32 165, i32 4, metadata !129, i32 19} ; [ DW_TAG_lexical_block ]
!2929 = metadata !{i32 790529, metadata !2810, metadata !"window[0][2]", null, i32 94, metadata !2802, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2930 = metadata !{i32 173, i32 5, metadata !2931, null}
!2931 = metadata !{i32 786443, metadata !2932, i32 172, i32 36, metadata !129, i32 24} ; [ DW_TAG_lexical_block ]
!2932 = metadata !{i32 786443, metadata !2805, i32 172, i32 4, metadata !129, i32 23} ; [ DW_TAG_lexical_block ]
!2933 = metadata !{i32 175, i32 3, metadata !2805, null}
!2934 = metadata !{i32 129, i32 27, metadata !2806, null}
!2935 = metadata !{i32 786688, metadata !2806, metadata !"x", metadata !129, i32 129, metadata !168, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2936 = metadata !{i32 129, i32 17, metadata !2806, null}
!2937 = metadata !{i32 128, i32 26, metadata !2808, null}
!2938 = metadata !{i32 129, i32 33, metadata !2805, null}
!2939 = metadata !{i32 130, i32 1, metadata !2805, null}
...
!2944 = metadata !{i32 133, i32 9, metadata !2805, null}
...
!2950 = metadata !{i32 177, i32 1, metadata !2732, null}
