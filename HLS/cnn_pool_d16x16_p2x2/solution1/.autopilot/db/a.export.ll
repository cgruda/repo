; ModuleID = 'D:/School/Project/new_repo/HLS/cnn_pool_d16x16_p2x2/solution1/.autopilot/db/a.o.2.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-f80:128:128-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S32"
target triple = "i686-pc-mingw32"

@llvm_global_ctors_1 = appending global [1 x void ()*] [void ()* @_GLOBAL__I_a]
@llvm_global_ctors_0 = appending global [1 x i32] [i32 65535]
@cnn_pool_d16x16_p2x2_1 = internal unnamed_addr constant [21 x i8] c"cnn_pool_d16x16_p2x2\00"
...
.preheader83.preheader:                           ; preds = %.preheader84
  ...
  %tmp_7 = trunc i32 %ctrl_read to i1
...
.preheader85:                                     ; preds = %.preheader84
  ...
  %tmp_9 = trunc i2 %tmp_3_mid2_v to i1
  %cond_mid1 = icmp eq i2 %y3, 0
  %cond = icmp eq i2 %y3, 1
  %cond_mid2 = select i1 %exitcond, i1 %cond_mid1, i1 %cond
  %x4_cast9 = zext i2 %x4_mid2 to i5
  %tmp_4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str8)
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind
  %tmp_5 = add i5 15, %x4_cast9
  %tmp_5_cast = zext i5 %tmp_5 to i32
  %lineBuffer_0_addr_1 = getelementptr [16 x i32]* %lineBuffer_0, i32 0, i32 %tmp_5_cast
  %lineBuffer_1_addr_1 = getelementptr [16 x i32]* %lineBuffer_1, i32 0, i32 %tmp_5_cast
  %lineBuffer_0_load = load i32* %lineBuffer_0_addr_1, align 4
  %lineBuffer_1_load = load i32* %lineBuffer_1_addr_1, align 4
  %window_2_2_7 = select i1 %tmp_9, i32 %lineBuffer_0_load, i32 %lineBuffer_1_load
...
.preheader82:                                     ; preds = %.preheader83.preheader, %._crit_edge88
  ...
  %y_assign = phi i5 [ 0, %.preheader83.preheader ], [ %y_assign_cast7_mid2_s, %._crit_edge88 ]
...
_ifconv1:                                         ; preds = %.preheader83
  ...
  %tmp_12 = call i1 @_ssdm_op_BitSelect.i1.i32.i32(i32 %a_assign, i32 31)
  ...
  %result = select i1 %tmp_12, i20 %tmp_3, i20 %tmp_6
  %result_cast = zext i20 %result to i21
  %tmp_4_i_i = sub i21 0, %result_cast
  %result_1 = select i1 %tmp_12, i21 %tmp_4_i_i, i21 %result_cast
  %result_1_cast = sext i21 %result_1 to i32
  %tmp_data_V_2 = select i1 %tmp_7, i32 %result_1_cast, i32 %sel_SEBB_i
...
._crit_edge:                                      ; preds = %_ifconv1, %.preheader83
  ...
  %lineBuffer_0_addr_2 = getelementptr [16 x i32]* %lineBuffer_0, i32 0, i32 %x_assign_cast5
  %windowRightCol_0 = load i32* %lineBuffer_0_addr_2, align 4
  %lineBuffer_1_addr_2 = getelementptr [16 x i32]* %lineBuffer_1, i32 0, i32 %x_assign_cast5
  %windowRightCol_1 = load i32* %lineBuffer_1_addr_2, align 4
  store i32 %windowRightCol_1, i32* %lineBuffer_0_addr_2, align 4
  %tmp_13 = call i24 @_ssdm_op_PartSelect.i24.i32.i32.i32(i32 %readCount_1_load, i32 8, i32 31)
  %icmp = icmp slt i24 %tmp_13, 1
...
.preheader83:                                     ; preds = %.preheader82
  ...
  %y_s = add i5 1, %y_assign
  %y_assign_cast7_mid2_s = select i1 %exitcond2, i5 %y_s, i5 %y_assign
  %tmp_10 = trunc i5 %y_assign_cast7_mid2_s to i1
  %tmp_11 = trunc i5 %x_assign_mid2 to i1
  %x_assign_cast5 = zext i5 %x_assign_mid2 to i32
  %tmp_8 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str9)
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind
  %tmp = and i1 %tmp_10, %tmp_11
...
entry:
  ...
  %empty_21 = trunc i32 %empty to i24
  ret i24 %empty_21
}
