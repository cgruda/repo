...
#ifndef _cnn_pool_d16x16_p2x2_HH_
#define _cnn_pool_d16x16_p2x2_HH_

#include "systemc.h"
#include "AESL_pkg.h"

#include "cnn_pool_d16x16_pbkb.h"
#include "cnn_pool_d16x16_p2x2_CTRL_s_axi.h"

namespace ap_rtl {

template<unsigned int C_S_AXI_CTRL_ADDR_WIDTH = 5,
         unsigned int C_S_AXI_CTRL_DATA_WIDTH = 32>
struct cnn_pool_d16x16_p2x2 : public sc_module {
    ...
    // Module declarations
    cnn_pool_d16x16_p2x2(sc_module_name name);
    SC_HAS_PROCESS(cnn_pool_d16x16_p2x2);
    ...
    cnn_pool_d16x16_p2x2_CTRL_s_axi<C_S_AXI_CTRL_ADDR_WIDTH,C_S_AXI_CTRL_DATA_WIDTH>* cnn_pool_d16x16_p2x2_CTRL_s_axi_U;
    cnn_pool_d16x16_pbkb* lineBuffer_0_U;
    cnn_pool_d16x16_pbkb* lineBuffer_1_U;
    ...
    sc_signal< sc_lv<1> > exitcond1_reg_897;
    sc_signal< sc_lv<1> > ap_CS_fsm_pp1_stage0;
    sc_signal< sc_logic > ap_enable_reg_pp1_iter1;
    sc_signal< sc_lv<1> > exitcond4_reg_906;
    sc_signal< sc_lv<1> > ap_CS_fsm_pp3_stage0;
    sc_signal< sc_logic > ap_enable_reg_pp3_iter1;
    sc_signal< sc_lv<1> > exitcond_flatten8_reg_1020;
    sc_signal< sc_lv<1> > icmp_reg_1050;
    sc_signal< sc_logic > outStream_TDATA_blk_n;
    sc_signal< sc_logic > ap_enable_reg_pp3_iter2;
    sc_signal< sc_lv<1> > tmp_reg_1034;
    sc_signal< sc_lv<1> > ap_pipeline_reg_pp3_iter1_tmp_reg_1034;
    sc_signal< sc_logic > ap_enable_reg_pp3_iter3;
    sc_signal< sc_lv<1> > ap_pipeline_reg_pp3_iter2_tmp_reg_1034;
    sc_signal< sc_lv<5> > x_reg_289;
    sc_signal< sc_lv<5> > x1_reg_301;
    ...
    sc_signal< sc_lv<9> > indvar_flatten6_reg_370;
    sc_signal< sc_lv<5> > y_assign_reg_381;
    sc_signal< sc_lv<5> > x_assign_reg_392;
    sc_signal< sc_lv<32> > window_1_1_reg_403;
    sc_signal< sc_lv<32> > window_1_0_reg_414;
    sc_signal< sc_lv<32> > ctrl_read_reg_892;
    sc_signal< sc_lv<1> > exitcond1_fu_432_p2;
    sc_signal< sc_lv<5> > x_1_fu_438_p2;
    sc_signal< sc_lv<5> > x_1_reg_901;
    sc_signal< sc_logic > ap_enable_reg_pp0_iter0;
    sc_signal< sc_lv<1> > exitcond4_fu_449_p2;
    sc_signal< sc_lv<5> > x_2_fu_455_p2;
    sc_signal< sc_lv<5> > x_2_reg_910;
    sc_signal< sc_logic > ap_enable_reg_pp1_iter0;
    sc_signal< sc_lv<1> > exitcond_flatten_fu_466_p2;
    sc_signal< sc_lv<1> > exitcond_flatten_reg_915;
    ...
    sc_signal< sc_lv<2> > tmp_3_mid2_v_reg_924;
    sc_signal< sc_lv<1> > tmp_9_fu_506_p1;
    sc_signal< sc_lv<1> > tmp_9_reg_929;
    sc_signal< sc_lv<1> > cond_mid2_fu_522_p3;
    sc_signal< sc_lv<1> > cond_mid2_reg_934;
    sc_signal< sc_lv<1> > cond1_fu_546_p2;
    sc_signal< sc_lv<1> > cond1_reg_950;
    sc_signal< sc_lv<2> > x_3_fu_552_p2;
    sc_signal< sc_lv<32> > window_2_2_4_fu_579_p3;
    sc_signal< sc_logic > ap_enable_reg_pp2_iter1;
    sc_signal< sc_lv<32> > window_2_2_5_fu_586_p3;
    sc_signal< sc_lv<1> > tmp_7_fu_593_p1;
    sc_signal< sc_lv<1> > tmp_7_reg_1015;
    sc_signal< sc_lv<1> > ap_CS_fsm_state10;
    sc_signal< sc_lv<1> > exitcond_flatten8_fu_606_p2;
    sc_signal< bool > ap_condition_1038;
    sc_signal< sc_lv<1> > ap_pipeline_reg_pp3_iter1_exitcond_flatten8_reg_1020;
    sc_signal< sc_lv<9> > indvar_flatten_next7_fu_612_p2;
    sc_signal< sc_logic > ap_enable_reg_pp3_iter0;
    sc_signal< sc_lv<5> > y_assign_cast7_mid2_s_fu_638_p3;
    sc_signal< sc_lv<5> > y_assign_cast7_mid2_s_reg_1029;
    sc_signal< sc_lv<1> > tmp_fu_660_p2;
    sc_signal< sc_lv<4> > lineBuffer_0_addr_2_reg_1038;
    sc_signal< sc_lv<4> > lineBuffer_1_addr_2_reg_1044;
    sc_signal< sc_lv<4> > ap_pipeline_reg_pp3_iter1_lineBuffer_1_addr_2_reg_1044;
    sc_signal< sc_lv<1> > icmp_fu_679_p2;
    sc_signal< sc_lv<5> > x_4_fu_696_p2;
    sc_signal< sc_lv<32> > maxValue_17_0_maxVal_fu_749_p3;
    sc_signal< sc_lv<32> > maxValue_17_0_maxVal_reg_1059;
    sc_signal< sc_lv<1> > tmp_12_fu_775_p3;
    sc_signal< sc_lv<1> > tmp_12_reg_1065;
    sc_signal< sc_lv<20> > result_fu_809_p3;
    sc_signal< sc_lv<20> > result_reg_1070;
    sc_signal< sc_lv<32> > lineBuffer_1_q0;
    sc_signal< sc_lv<32> > windowRightCol_1_reg_1075;
    sc_signal< sc_lv<32> > tmp_data_V_2_fu_868_p3;
    sc_signal< sc_lv<1> > tmp_last_V_fu_876_p2;
    ...
    sc_signal< sc_lv<5> > x_phi_fu_293_p4;
    sc_signal< sc_lv<5> > x1_phi_fu_305_p4;
    sc_signal< sc_lv<2> > y3_phi_fu_328_p4;
    sc_signal< sc_lv<5> > y_assign_phi_fu_385_p4;
    sc_signal< sc_lv<32> > window_1_0_phi_fu_417_p4;
    sc_signal< sc_lv<32> > x_cast_fu_444_p1;
    sc_signal< sc_lv<32> > x1_cast_fu_461_p1;
    sc_signal< sc_lv<32> > tmp_5_cast_fu_540_p1;
    sc_signal< sc_lv<32> > x_assign_cast5_fu_654_p1;
    ...
    sc_signal< sc_lv<32> > writeCount_fu_830_p2;
    sc_signal< sc_lv<32> > readCount_1_fu_170;
    sc_signal< sc_lv<32> > readCount_fu_685_p2;
    ...
    sc_signal< sc_lv<5> > x4_cast9_fu_530_p1;
    sc_signal< sc_lv<5> > tmp_5_fu_534_p2;
    sc_signal< sc_lv<32> > window_2_2_7_fu_558_p3;
    sc_signal< sc_lv<32> > window_2_2_fu_565_p3;
    sc_signal< sc_lv<32> > window_2_2_1_fu_572_p3;
    sc_signal< sc_lv<1> > exitcond2_fu_618_p2;
    sc_signal< sc_lv<5> > y_s_fu_632_p2;
    sc_signal< sc_lv<5> > x_assign_mid2_fu_624_p3;
    sc_signal< sc_lv<1> > tmp_10_fu_646_p1;
    sc_signal< sc_lv<1> > tmp_11_fu_650_p1;
    sc_signal< sc_lv<24> > tmp_13_fu_669_p4;
    sc_signal< sc_lv<1> > tmp_4_0_1_i_fu_729_p2;
    sc_signal< sc_lv<32> > maxValue_0_1_maxVal_fu_735_p3;
    sc_signal< sc_lv<1> > tmp_4_1_i_fu_743_p2;
    sc_signal< sc_lv<32> > tmp4_fu_763_p2;
    sc_signal< sc_lv<32> > tmp3_fu_757_p2;
    sc_signal< sc_lv<32> > a_assign_fu_769_p2;
    sc_signal< sc_lv<32> > tmp_1_i_i_fu_783_p2;
    sc_signal< sc_lv<20> > tmp_3_fu_789_p4;
    sc_signal< sc_lv<20> > tmp_6_fu_799_p4;
    sc_signal< sc_lv<1> > tmp_4_1_1_i_fu_836_p2;
    sc_signal< sc_lv<21> > result_cast_fu_848_p1;
    sc_signal< sc_lv<21> > tmp_4_i_i_fu_851_p2;
    sc_signal< sc_lv<21> > result_1_fu_857_p3;
    sc_signal< sc_lv<32> > result_1_cast_fu_864_p1;
    sc_signal< sc_lv<32> > sel_SEBB_i_fu_841_p3;
    sc_signal< sc_lv<1> > ap_CS_fsm_state15;
    sc_signal< bool > ap_condition_1532;
    ...
    void thread_a_assign_fu_769_p2();
    ...
    void thread_indvar_flatten_next7_fu_612_p2();
    ...
    void thread_maxValue_0_1_maxVal_fu_735_p3();
    void thread_maxValue_17_0_maxVal_fu_749_p3();
    ...
    void thread_readCount_fu_685_p2();
    void thread_result_1_cast_fu_864_p1();
    void thread_result_1_fu_857_p3();
    void thread_result_cast_fu_848_p1();
    void thread_result_fu_809_p3();
    void thread_sel_SEBB_i_fu_841_p3();
    void thread_tmp3_fu_757_p2();
    void thread_tmp4_fu_763_p2();
    void thread_tmp_10_fu_646_p1();
    void thread_tmp_11_fu_650_p1();
    void thread_tmp_12_fu_775_p3();
    void thread_tmp_13_fu_669_p4();
    void thread_tmp_1_i_i_fu_783_p2();
    void thread_tmp_3_fu_789_p4();
    void thread_tmp_3_mid2_v_fu_498_p3();
    void thread_tmp_4_0_1_i_fu_729_p2();
    void thread_tmp_4_1_1_i_fu_836_p2();
    void thread_tmp_4_1_i_fu_743_p2();
    void thread_tmp_4_i_i_fu_851_p2();
    void thread_tmp_5_cast_fu_540_p1();
    void thread_tmp_5_fu_534_p2();
    void thread_tmp_6_fu_799_p4();
    void thread_tmp_7_fu_593_p1();
    void thread_tmp_9_fu_506_p1();
    void thread_tmp_data_V_2_fu_868_p3();
    void thread_tmp_fu_660_p2();
    void thread_tmp_last_V_fu_876_p2();
    void thread_window_1_0_phi_fu_417_p4();
    void thread_window_2_2_1_fu_572_p3();
    void thread_window_2_2_4_fu_579_p3();
    void thread_window_2_2_5_fu_586_p3();
    void thread_window_2_2_7_fu_558_p3();
    void thread_window_2_2_fu_565_p3();
    void thread_writeCount_fu_830_p2();
    void thread_x1_cast_fu_461_p1();
    void thread_x1_phi_fu_305_p4();
    void thread_x4_cast9_fu_530_p1();
    void thread_x4_mid2_fu_484_p3();
    void thread_x_1_fu_438_p2();
    void thread_x_2_fu_455_p2();
    void thread_x_3_fu_552_p2();
    void thread_x_4_fu_696_p2();
    void thread_x_assign_cast5_fu_654_p1();
    void thread_x_assign_mid2_fu_624_p3();
    void thread_x_cast_fu_444_p1();
    void thread_x_phi_fu_293_p4();
    void thread_y3_phi_fu_328_p4();
    void thread_y9_fu_492_p2();
    void thread_y_assign_cast7_mid2_s_fu_638_p3();
    void thread_y_assign_phi_fu_385_p4();
    void thread_y_s_fu_632_p2();
