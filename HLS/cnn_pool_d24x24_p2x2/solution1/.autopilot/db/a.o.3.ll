; ModuleID = 'D:/School/Project/new_repo/HLS/cnn_pool_d24x24_p2x2/solution1/.autopilot/db/a.o.3.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-f80:128:128-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S32"
target triple = "i686-pc-mingw32"

@llvm_global_ctors_1 = appending global [1 x void ()*] [void ()* @_GLOBAL__I_a] ; [#uses=0 type=[1 x void ()*]*]
@llvm_global_ctors_0 = appending global [1 x i32] [i32 65535] ; [#uses=0 type=[1 x i32]*]
@cnn_pool_d24x24_p2x2_1 = internal unnamed_addr constant [21 x i8] c"cnn_pool_d24x24_p2x2\00" ; [#uses=1 type=[21 x i8]*]
...
define void @cnn_pool_d24x24_p2x2(i32* %inStream_V_data_V, i4* %inStream_V_keep_V, i4* %inStream_V_strb_V, i2* %inStream_V_user_V, i1* %inStream_V_last_V, i5* %inStream_V_id_V, i6* %inStream_V_dest_V, i32* %outStream_V_data_V, i4* %outStream_V_keep_V, i4* %outStream_V_strb_V, i2* %outStream_V_user_V, i1* %outStream_V_last_V, i5* %outStream_V_id_V, i6* %outStream_V_dest_V, i32 %ctrl) {
  ...
  call void (...)* @_ssdm_op_SpecTopModule([21 x i8]* @cnn_pool_d24x24_p2x2_1) nounwind
  ...
  %lineBuffer_0 = alloca [24 x i32], align 4      ; [#uses=3 type=[24 x i32]*]
  %lineBuffer_1 = alloca [24 x i32], align 4      ; [#uses=3 type=[24 x i32]*]
  ...
  call void @llvm.dbg.declare(metadata !{[24 x i32]* %lineBuffer_0}, metadata !2736), !dbg !2744 ; [debug line = 95:12] [debug variable = lineBuffer[0]]
  call void @llvm.dbg.declare(metadata !{[24 x i32]* %lineBuffer_1}, metadata !2745), !dbg !2744 ; [debug line = 95:12] [debug variable = lineBuffer[1]]
  br label %1, !dbg !2746                         ; [debug line = 103:43]

; <label>:1                                       ; preds = %2, %0
  %x = phi i5 [ -10, %0 ], [ %x_1, %2 ]           ; [#uses=3 type=i5]
  %exitcond1 = icmp eq i5 %x, -8, !dbg !2746      ; [#uses=1 type=i1] [debug line = 103:43]
...
; <label>:2                                       ; preds = %1
  %x_cast = zext i5 %x to i32, !dbg !2746         ; [#uses=1 type=i32] [debug line = 103:43]
  ...
  %lineBuffer_0_addr = getelementptr [24 x i32]* %lineBuffer_0, i32 0, i32 %x_cast ; [#uses=1 type=i32*]
...
.preheader86.0:                                   ; preds = %3, %.preheader86.0.preheader
  ...
  %exitcond4 = icmp eq i5 %x1, -8, !dbg !2748     ; [#uses=1 type=i1] [debug line = 111:17]
...
; <label>:3                                       ; preds = %.preheader86.0
  ...
  %empty_7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 24, i64 24, i64 24) ; [#uses=0 type=i32]
  ...
  %lineBuffer_1_addr = getelementptr [24 x i32]* %lineBuffer_1, i32 0, i32 %x1_cast ; [#uses=1 type=i32*]
...
.preheader85:                                     ; preds = %.preheader84
  ...
  %x4_cast9 = zext i2 %x4_mid2 to i5, !dbg !2821  ; [#uses=1 type=i5] [debug line = 123:35]
  ...
  %tmp_5 = add i5 -9, %x4_cast9, !dbg !2826       ; [#uses=1 type=i5] [debug line = 125:2]
  %tmp_5_cast = zext i5 %tmp_5 to i32, !dbg !2826 ; [#uses=2 type=i32] [debug line = 125:2]
  %lineBuffer_0_addr_1 = getelementptr [24 x i32]* %lineBuffer_0, i32 0, i32 %tmp_5_cast, !dbg !2826 ; [#uses=1 type=i32*] [debug line = 125:2]
  %lineBuffer_1_addr_1 = getelementptr [24 x i32]* %lineBuffer_1, i32 0, i32 %tmp_5_cast, !dbg !2826 ; [#uses=1 type=i32*] [debug line = 125:2]
...
.preheader82:                                     ; preds = %._crit_edge88, %.preheader83.preheader
  ...
  %exitcond_flatten8 = icmp eq i10 %indvar_flatten6, -448 ; [#uses=1 type=i1]
...
_ifconv1:                                         ; preds = %.preheader83
  ...
  %tmp_last_V = icmp eq i32 %writeCount, 144, !dbg !2875 ; [#uses=1 type=i1] [debug line = 76:2@147:19]
...
._crit_edge:                                      ; preds = %.preheader83, %_ifconv1
  ...
  %lineBuffer_0_addr_2 = getelementptr [24 x i32]* %lineBuffer_0, i32 0, i32 %x_assign_cast5 ; [#uses=2 type=i32*]
  ...
  %lineBuffer_1_addr_2 = getelementptr [24 x i32]* %lineBuffer_1, i32 0, i32 %x_assign_cast5 ; [#uses=2 type=i32*]
  ...
  %tmp_7 = icmp slt i32 %readCount_1_load, 576, !dbg !2898 ; [#uses=1 type=i1] [debug line = 160:4]
...
.preheader83:                                     ; preds = %.preheader82
  %empty_14 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 576, i64 576, i64 576) ; [#uses=0 type=i32]
  %exitcond2 = icmp eq i5 %x_assign, -8, !dbg !2936 ; [#uses=2 type=i1] [debug line = 131:17]
...
!128 = metadata !{i32 786478, i32 0, metadata !129, metadata !"cnn_pool_d24x24_p2x2", metadata !"cnn_pool_d24x24_p2x2", metadata !"_Z20cnn_pool_d24x24_p2x2RN3hls6streamI7ap_axiuILi32ELi2ELi5ELi6EEEES4_j", metadata !129, i32 85, metadata !130, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !159, i32 89} ; [ DW_TAG_subprogram ]
!129 = metadata !{i32 786473, metadata !"cnn_pool_d24x24_p2x2/core.cpp", metadata !"D:\5CSchool\5CProject\5Cnew_repo\5CHLS", null} ; [ DW_TAG_file_type ]
...
!2738 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 1536, i64 32, i32 0, i32 0, metadata !2739, metadata !2740, i32 0, i32 0} ; [ DW_TAG_array_type ]
...
!2742 = metadata !{i32 786465, i64 0, i64 23}     ; [ DW_TAG_subrange_type ]
!2743 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 768, i64 32, i32 0, i32 0, metadata !2739, metadata !2740, i32 0, i32 0} ; [ DW_TAG_array_type ]
...
!2851 = metadata !{i32 786473, metadata !"cnn_pool_d24x24_p2x2/fixed_point.h", metadata !"D:\5CSchool\5CProject\5Cnew_repo\5CHLS", null} ; [ DW_TAG_file_type ]
