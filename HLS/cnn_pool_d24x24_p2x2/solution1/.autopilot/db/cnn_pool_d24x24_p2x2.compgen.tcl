...
set ID 0
set MemName cnn_pool_d24x24_pbkb
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 1 \
			corename cnn_pool_d24x24_p2x2_CTRL_axilite \
			name cnn_pool_d24x24_p2x2_CTRL_s_axi \
			ports {$port_CTRL} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler cnn_pool_d24x24_p2x2_CTRL_s_axi
}
