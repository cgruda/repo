...
`define TV_IN_inStream_TDATA "../tv/cdatafile/c.cnn_conv_d54x54_k3x3.autotvin_inStream_V_data_V.dat"
`define INGRESS_STATUS_inStream_TDATA "../tv/stream_size/stream_ingress_status_inStream_V_data_V.dat"
`define TV_IN_inStream_TKEEP "../tv/cdatafile/c.cnn_conv_d54x54_k3x3.autotvin_inStream_V_keep_V.dat"
`define INGRESS_STATUS_inStream_TKEEP "../tv/stream_size/stream_ingress_status_inStream_V_keep_V.dat"
`define TV_IN_inStream_TSTRB "../tv/cdatafile/c.cnn_conv_d54x54_k3x3.autotvin_inStream_V_strb_V.dat"
`define INGRESS_STATUS_inStream_TSTRB "../tv/stream_size/stream_ingress_status_inStream_V_strb_V.dat"
`define TV_IN_inStream_TUSER "../tv/cdatafile/c.cnn_conv_d54x54_k3x3.autotvin_inStream_V_user_V.dat"
`define INGRESS_STATUS_inStream_TUSER "../tv/stream_size/stream_ingress_status_inStream_V_user_V.dat"
`define TV_IN_inStream_TLAST "../tv/cdatafile/c.cnn_conv_d54x54_k3x3.autotvin_inStream_V_last_V.dat"
`define INGRESS_STATUS_inStream_TLAST "../tv/stream_size/stream_ingress_status_inStream_V_last_V.dat"
`define TV_IN_inStream_TID "../tv/cdatafile/c.cnn_conv_d54x54_k3x3.autotvin_inStream_V_id_V.dat"
`define INGRESS_STATUS_inStream_TID "../tv/stream_size/stream_ingress_status_inStream_V_id_V.dat"
`define TV_IN_inStream_TDEST "../tv/cdatafile/c.cnn_conv_d54x54_k3x3.autotvin_inStream_V_dest_V.dat"
...
module AESL_axi_s_inStream (
    ...
    fifo #(2916, 32) fifo_inStream_TDATA (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(2916, 4) fifo_inStream_TKEEP (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(2916, 4) fifo_inStream_TSTRB (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(2916, 2) fifo_inStream_TUSER (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(2916, 1) fifo_inStream_TLAST (
        .reset(1'b0),
        .write_clock(clk),
    ...
    fifo #(2916, 6) fifo_inStream_TDEST (
        .reset(1'b0),
        .write_clock(clk),
