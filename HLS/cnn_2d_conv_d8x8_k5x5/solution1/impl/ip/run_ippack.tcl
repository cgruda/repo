...
set Library     "hls"
set IPName      "cnn_2d_conv_d8x8_k5x5"
set Version     "1.0"
set DisplayName "cnn_2d_conv_d8x8_k5x5"
set Revision    "2103181357"
set Description "An IP generated by Vivado HLS"
set Device      "zynq"
set Taxonomy    "/VIVADO_HLS_IP"

## Variables
set Top "cnn_2d_conv_d8x8_k5x5"
...
set Interfaces {
    s_axi_CTRL {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 ctrl W 0x0 "Data signal of ctrl" {{0 32 ctrl W 0 "Bit 31 to 0 Data signal of ctrl"}}} {0x18 kernelData_0 W 0x0 "Data signal of kernelData_0" {{0 32 kernelData_0 W 0 "Bit 31 to 0 Data signal of kernelData_0"}}} {0x20 kernelData_1 W 0x0 "Data signal of kernelData_1" {{0 32 kernelData_1 W 0 "Bit 31 to 0 Data signal of kernelData_1"}}} {0x28 kernelData_2 W 0x0 "Data signal of kernelData_2" {{0 32 kernelData_2 W 0 "Bit 31 to 0 Data signal of kernelData_2"}}} {0x30 kernelData_3 W 0x0 "Data signal of kernelData_3" {{0 32 kernelData_3 W 0 "Bit 31 to 0 Data signal of kernelData_3"}}} {0x38 kernelData_4 W 0x0 "Data signal of kernelData_4" {{0 32 kernelData_4 W 0 "Bit 31 to 0 Data signal of kernelData_4"}}} {0x40 kernelData_5 W 0x0 "Data signal of kernelData_5" {{0 32 kernelData_5 W 0 "Bit 31 to 0 Data signal of kernelData_5"}}} {0x48 kernelData_6 W 0x0 "Data signal of kernelData_6" {{0 32 kernelData_6 W 0 "Bit 31 to 0 Data signal of kernelData_6"}}} {0x50 kernelData_7 W 0x0 "Data signal of kernelData_7" {{0 32 kernelData_7 W 0 "Bit 31 to 0 Data signal of kernelData_7"}}} {0x58 kernelData_8 W 0x0 "Data signal of kernelData_8" {{0 32 kernelData_8 W 0 "Bit 31 to 0 Data signal of kernelData_8"}}} {0x60 kernelData_9 W 0x0 "Data signal of kernelData_9" {{0 32 kernelData_9 W 0 "Bit 31 to 0 Data signal of kernelData_9"}}} {0x68 kernelData_10 W 0x0 "Data signal of kernelData_10" {{0 32 kernelData_10 W 0 "Bit 31 to 0 Data signal of kernelData_10"}}} {0x70 kernelData_11 W 0x0 "Data signal of kernelData_11" {{0 32 kernelData_11 W 0 "Bit 31 to 0 Data signal of kernelData_11"}}} {0x78 kernelData_12 W 0x0 "Data signal of kernelData_12" {{0 32 kernelData_12 W 0 "Bit 31 to 0 Data signal of kernelData_12"}}} {0x80 kernelData_13 W 0x0 "Data signal of kernelData_13" {{0 32 kernelData_13 W 0 "Bit 31 to 0 Data signal of kernelData_13"}}} {0x88 kernelData_14 W 0x0 "Data signal of kernelData_14" {{0 32 kernelData_14 W 0 "Bit 31 to 0 Data signal of kernelData_14"}}} {0x90 kernelData_15 W 0x0 "Data signal of kernelData_15" {{0 32 kernelData_15 W 0 "Bit 31 to 0 Data signal of kernelData_15"}}} {0x98 kernelData_16 W 0x0 "Data signal of kernelData_16" {{0 32 kernelData_16 W 0 "Bit 31 to 0 Data signal of kernelData_16"}}} {0xa0 kernelData_17 W 0x0 "Data signal of kernelData_17" {{0 32 kernelData_17 W 0 "Bit 31 to 0 Data signal of kernelData_17"}}} {0xa8 kernelData_18 W 0x0 "Data signal of kernelData_18" {{0 32 kernelData_18 W 0 "Bit 31 to 0 Data signal of kernelData_18"}}} {0xb0 kernelData_19 W 0x0 "Data signal of kernelData_19" {{0 32 kernelData_19 W 0 "Bit 31 to 0 Data signal of kernelData_19"}}} {0xb8 kernelData_20 W 0x0 "Data signal of kernelData_20" {{0 32 kernelData_20 W 0 "Bit 31 to 0 Data signal of kernelData_20"}}} {0xc0 kernelData_21 W 0x0 "Data signal of kernelData_21" {{0 32 kernelData_21 W 0 "Bit 31 to 0 Data signal of kernelData_21"}}} {0xc8 kernelData_22 W 0x0 "Data signal of kernelData_22" {{0 32 kernelData_22 W 0 "Bit 31 to 0 Data signal of kernelData_22"}}} {0xd0 kernelData_23 W 0x0 "Data signal of kernelData_23" {{0 32 kernelData_23 W 0 "Bit 31 to 0 Data signal of kernelData_23"}}} {0xd8 kernelData_24 W 0x0 "Data signal of kernelData_24" {{0 32 kernelData_24 W 0 "Bit 31 to 0 Data signal of kernelData_24"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 10.000000 machine 64 combinational 0 latency 109 II x}
...
set enable_xo_gen 0
set kernel_files {D:/School/Project/new_repo/HLS/cnn_2d_conv_d8x8_k5x5/core.cpp}
if {$enable_xo_gen} {
