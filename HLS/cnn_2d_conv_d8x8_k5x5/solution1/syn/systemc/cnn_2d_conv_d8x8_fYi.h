...
#ifndef __cnn_2d_conv_d8x8_fYi__HH__
#define __cnn_2d_conv_d8x8_fYi__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_2d_conv_d8x8_fYi) {
    ...
    SC_CTOR(cnn_2d_conv_d8x8_fYi):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
