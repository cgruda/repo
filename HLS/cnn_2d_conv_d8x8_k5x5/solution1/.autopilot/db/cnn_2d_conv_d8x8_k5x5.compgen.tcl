...
set ID 25
set MemName cnn_2d_conv_d8x8_bkb
...
# Memory (RAM/ROM)  definition:
set ID 26
set MemName cnn_2d_conv_d8x8_cud
set CoreName ap_simcore_mem
set PortList { 2 0 }
set DataWd 32
set AddrRange 8
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 27 \
			corename cnn_2d_conv_d8x8_k5x5_CTRL_axilite \
			name cnn_2d_conv_d8x8_k5x5_CTRL_s_axi \
			ports {$port_CTRL} \
			op interface \
		} "
	} else {
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler cnn_2d_conv_d8x8_k5x5_CTRL_s_axi
}
