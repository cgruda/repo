...
// [dump_struct_tree [build_nameSpaceTree] dumpedStructList] ---------->
    ...
    template<> struct ap_axiu<32, 2, 5, 6> {
        ap_uint<32> data;
        ap_uint<4> keep;
        ap_uint<4> strb;
        ap_uint<2> user;
...
#define AUTOTB_TVOUT_PC_outStream_V_data_V  "../tv/rtldatafile/rtl.cnn_conv_d46x46_k3x3.autotvout_outStream_V_data_V.dat"
// tvout file define: "outStream_V_keep_V"
#define AUTOTB_TVOUT_PC_outStream_V_keep_V  "../tv/rtldatafile/rtl.cnn_conv_d46x46_k3x3.autotvout_outStream_V_keep_V.dat"
// tvout file define: "outStream_V_strb_V"
#define AUTOTB_TVOUT_PC_outStream_V_strb_V  "../tv/rtldatafile/rtl.cnn_conv_d46x46_k3x3.autotvout_outStream_V_strb_V.dat"
// tvout file define: "outStream_V_user_V"
#define AUTOTB_TVOUT_PC_outStream_V_user_V  "../tv/rtldatafile/rtl.cnn_conv_d46x46_k3x3.autotvout_outStream_V_user_V.dat"
// tvout file define: "outStream_V_last_V"
#define AUTOTB_TVOUT_PC_outStream_V_last_V  "../tv/rtldatafile/rtl.cnn_conv_d46x46_k3x3.autotvout_outStream_V_last_V.dat"
// tvout file define: "outStream_V_id_V"
#define AUTOTB_TVOUT_PC_outStream_V_id_V  "../tv/rtldatafile/rtl.cnn_conv_d46x46_k3x3.autotvout_outStream_V_id_V.dat"
// tvout file define: "outStream_V_dest_V"
#define AUTOTB_TVOUT_PC_outStream_V_dest_V  "../tv/rtldatafile/rtl.cnn_conv_d46x46_k3x3.autotvout_outStream_V_dest_V.dat"
...
extern void cnn_conv_d46x46_k3x3 (
hls::stream<ap_axiu<32, 2, 5, 6 > >& inStream,
hls::stream<ap_axiu<32, 2, 5, 6 > >& outStream,
unsigned int ctrl,
unsigned int kernel[9]);

void AESL_WRAP_cnn_conv_d46x46_k3x3 (
hls::stream<ap_axiu<32, 2, 5, 6 > >& inStream,
hls::stream<ap_axiu<32, 2, 5, 6 > >& outStream,
unsigned int ctrl,
unsigned int kernel[9])
{
	...
	if (wrapc_switch_file_token.good())
	{
		...
		std::vector<ap_axiu<32, 2, 5, 6 > > aesl_tmp_3;
		int aesl_tmp_4;
		int aesl_tmp_5 = 0;
	...
	else
	{
		...
		std::vector<ap_axiu<32, 2, 5, 6 > > aesl_tmp_0;
		int aesl_tmp_1 = 0;
				...
				// celement: ctrl(31, 0)
				{
					// carray: (0) => (0) @ (0)
					{
						...
						if (&(ctrl) != NULL) // check the null address if the c port is array or others
						{
							...
							ctrl_tmp_mem = ctrl;
							ctrl_tvin_wrapc_buffer.range(31, 0) = ctrl_tmp_mem.range(31, 0);
						}
					}
				}
			}
		...
		sc_bv<32>* kernel_0_tvin_wrapc_buffer = new sc_bv<32>[1];
				...
				// celement: kernel(31, 0)
				{
					...
					for (int i_0 = 0; i_0 <= 0; i_0 += 2)
					{
						...
						if (&(kernel[0]) != NULL) // check the null address if the c port is array or others
						{
							...
							kernel_0_tvin_wrapc_buffer[hls_map_index++].range(31, 0) = kernel_tmp_mem.range(31, 0);
						}
					}
				}
			}
		...
		sc_bv<32>* kernel_1_tvin_wrapc_buffer = new sc_bv<32>[1];
				...
				// celement: kernel(31, 0)
				{
					...
					for (int i_0 = 1; i_0 <= 1; i_0 += 2)
					{
						...
						if (&(kernel[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<32> kernel_tmp_mem;
							kernel_tmp_mem = kernel[i_0];
							kernel_1_tvin_wrapc_buffer[hls_map_index++].range(31, 0) = kernel_tmp_mem.range(31, 0);
						}
					}
				}
			}
		...
		sc_bv<32>* kernel_2_tvin_wrapc_buffer = new sc_bv<32>[1];
				...
				// celement: kernel(31, 0)
				{
					...
					for (int i_0 = 2; i_0 <= 2; i_0 += 2)
					{
						...
						if (&(kernel[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<32> kernel_tmp_mem;
							kernel_tmp_mem = kernel[i_0];
							kernel_2_tvin_wrapc_buffer[hls_map_index++].range(31, 0) = kernel_tmp_mem.range(31, 0);
						}
					}
				}
			}
		...
		sc_bv<32>* kernel_3_tvin_wrapc_buffer = new sc_bv<32>[1];
				...
				// celement: kernel(31, 0)
				{
					...
					for (int i_0 = 3; i_0 <= 3; i_0 += 2)
					{
						...
						if (&(kernel[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<32> kernel_tmp_mem;
							kernel_tmp_mem = kernel[i_0];
							kernel_3_tvin_wrapc_buffer[hls_map_index++].range(31, 0) = kernel_tmp_mem.range(31, 0);
						}
					}
				}
			}
		...
		sc_bv<32>* kernel_4_tvin_wrapc_buffer = new sc_bv<32>[1];
				...
				// celement: kernel(31, 0)
				{
					...
					for (int i_0 = 4; i_0 <= 4; i_0 += 2)
					{
						...
						if (&(kernel[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<32> kernel_tmp_mem;
							kernel_tmp_mem = kernel[i_0];
							kernel_4_tvin_wrapc_buffer[hls_map_index++].range(31, 0) = kernel_tmp_mem.range(31, 0);
						}
					}
				}
			}
		...
		sc_bv<32>* kernel_5_tvin_wrapc_buffer = new sc_bv<32>[1];
				...
				// celement: kernel(31, 0)
				{
					...
					for (int i_0 = 5; i_0 <= 5; i_0 += 2)
					{
						...
						if (&(kernel[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<32> kernel_tmp_mem;
							kernel_tmp_mem = kernel[i_0];
							kernel_5_tvin_wrapc_buffer[hls_map_index++].range(31, 0) = kernel_tmp_mem.range(31, 0);
						}
					}
				}
			}
		...
		sc_bv<32>* kernel_6_tvin_wrapc_buffer = new sc_bv<32>[1];
				...
				// celement: kernel(31, 0)
				{
					...
					for (int i_0 = 6; i_0 <= 6; i_0 += 2)
					{
						...
						if (&(kernel[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<32> kernel_tmp_mem;
							kernel_tmp_mem = kernel[i_0];
							kernel_6_tvin_wrapc_buffer[hls_map_index++].range(31, 0) = kernel_tmp_mem.range(31, 0);
						}
					}
				}
			}
		...
		sc_bv<32>* kernel_7_tvin_wrapc_buffer = new sc_bv<32>[1];
				...
				// celement: kernel(31, 0)
				{
					...
					for (int i_0 = 7; i_0 <= 7; i_0 += 2)
					{
						...
						if (&(kernel[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<32> kernel_tmp_mem;
							kernel_tmp_mem = kernel[i_0];
							kernel_7_tvin_wrapc_buffer[hls_map_index++].range(31, 0) = kernel_tmp_mem.range(31, 0);
						}
					}
				}
			}
		...
		sc_bv<32>* kernel_8_tvin_wrapc_buffer = new sc_bv<32>[1];
				...
				// celement: kernel(31, 0)
				{
					...
					for (int i_0 = 8; i_0 <= 8; i_0 += 2)
					{
						...
						if (&(kernel[0]) != NULL) // check the null address if the c port is array or others
						{
							sc_lv<32> kernel_tmp_mem;
							kernel_tmp_mem = kernel[i_0];
							kernel_8_tvin_wrapc_buffer[hls_map_index++].range(31, 0) = kernel_tmp_mem.range(31, 0);
						}
					}
				}
			}
...
// [call_c_dut] ---------->
		...
		cnn_conv_d46x46_k3x3(inStream, outStream, ctrl, kernel);
