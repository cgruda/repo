...
if {[file isfile cnn_conv_d46x46_k3x3.autotvin.dat]} {
	file delete -force cnn_conv_d46x46_k3x3.autotvin.dat
}

if {[file isfile cnn_conv_d46x46_k3x3.autotvout.dat]} {
	file delete -force cnn_conv_d46x46_k3x3.autotvout.dat
}
