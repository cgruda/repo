...
(* CORE_GENERATION_INFO="cnn_pool_d8x8_p2x2,hls_ip_2016_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.220000,HLS_SYN_LAT=88,HLS_SYN_TPT=none,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=784,HLS_SYN_LUT=1045}" *)
...
reg   [1:0] x4_reg_359;
reg   [6:0] indvar_flatten6_reg_370;
reg   [3:0] y_assign_reg_381;
reg   [3:0] x_assign_reg_392;
...
wire   [3:0] y_assign_cast7_mid2_s_fu_638_p3;
reg   [3:0] y_assign_cast7_mid2_s_reg_1029;
wire   [0:0] tmp_fu_660_p2;
reg   [2:0] lineBuffer_0_addr_2_reg_1038;
reg   [2:0] lineBuffer_1_addr_2_reg_1044;
reg   [2:0] ap_pipeline_reg_pp3_iter1_lineBuffer_1_addr_2_reg_1044;
...
reg   [3:0] x_phi_fu_293_p4;
reg   [3:0] x1_phi_fu_305_p4;
reg   [1:0] y3_phi_fu_328_p4;
reg   [3:0] y_assign_phi_fu_385_p4;
...
wire   [3:0] x4_cast9_fu_530_p1;
wire   [3:0] tmp_5_fu_534_p2;
...
wire   [3:0] y_s_fu_632_p2;
wire   [3:0] x_assign_mid2_fu_624_p3;
...
cnn_pool_d8x8_p2x2_CTRL_s_axi #(
    .C_S_AXI_ADDR_WIDTH( C_S_AXI_CTRL_ADDR_WIDTH ),
    .C_S_AXI_DATA_WIDTH( C_S_AXI_CTRL_DATA_WIDTH ))
cnn_pool_d8x8_p2x2_CTRL_s_axi_U(
...
assign exitcond1_fu_432_p2 = ((x_phi_fu_293_p4 == ap_const_lv4_8) ? 1'b1 : 1'b0);

assign exitcond2_fu_618_p2 = ((x_assign_reg_392 == ap_const_lv4_8) ? 1'b1 : 1'b0);

assign exitcond4_fu_449_p2 = ((x1_phi_fu_305_p4 == ap_const_lv4_8) ? 1'b1 : 1'b0);

assign exitcond_flatten8_fu_606_p2 = ((indvar_flatten6_reg_370 == ap_const_lv7_40) ? 1'b1 : 1'b0);
...
assign icmp_fu_679_p2 = (($signed(tmp_13_fu_669_p4) < $signed(26'b1)) ? 1'b1 : 1'b0);
...
assign indvar_flatten_next7_fu_612_p2 = (indvar_flatten6_reg_370 + ap_const_lv7_1);
...
assign tmp_13_fu_669_p4 = {{readCount_1_fu_170[ap_const_lv32_1F : ap_const_lv32_6]}};
...
assign tmp_5_fu_534_p2 = (ap_const_lv4_7 + x4_cast9_fu_530_p1);
...
assign tmp_last_V_fu_876_p2 = ((writeCount_fu_830_p2 == ap_const_lv32_10) ? 1'b1 : 1'b0);
...
assign x_1_fu_438_p2 = (x_phi_fu_293_p4 + ap_const_lv4_1);

assign x_2_fu_455_p2 = (x1_phi_fu_305_p4 + ap_const_lv4_1);

assign x_3_fu_552_p2 = (ap_const_lv2_1 + x4_mid2_fu_484_p3);

assign x_4_fu_696_p2 = (x_assign_mid2_fu_624_p3 + ap_const_lv4_1);

assign x_assign_cast5_fu_654_p1 = x_assign_mid2_fu_624_p3;

assign x_assign_mid2_fu_624_p3 = ((exitcond2_fu_618_p2[0:0] === 1'b1) ? ap_const_lv4_0 : x_assign_reg_392);
...
assign y_s_fu_632_p2 = (ap_const_lv4_1 + y_assign_phi_fu_385_p4);

endmodule //cnn_pool_d8x8_p2x2
