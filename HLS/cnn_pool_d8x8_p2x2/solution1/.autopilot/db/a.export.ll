; ModuleID = 'D:/School/Project/new_repo/HLS/cnn_pool_d8x8_p2x2/solution1/.autopilot/db/a.o.2.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-f80:128:128-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S32"
target triple = "i686-pc-mingw32"

@llvm_global_ctors_1 = appending global [1 x void ()*] [void ()* @_GLOBAL__I_a]
@llvm_global_ctors_0 = appending global [1 x i32] [i32 65535]
@cnn_pool_d8x8_p2x2_s = internal unnamed_addr constant [19 x i8] c"cnn_pool_d8x8_p2x2\00"
...
; <label>:2                                       ; preds = %1
  ...
  %lineBuffer_0_addr = getelementptr [8 x i32]* %lineBuffer_0, i32 0, i32 %x_cast
...
; <label>:3                                       ; preds = %.preheader86.0
  ...
  %lineBuffer_1_addr = getelementptr [8 x i32]* %lineBuffer_1, i32 0, i32 %x1_cast
...
.preheader85:                                     ; preds = %.preheader84
  ...
  %x4_cast9 = zext i2 %x4_mid2 to i4
  %tmp_4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str8)
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind
  %tmp_5 = add i4 7, %x4_cast9
  %tmp_5_cast = zext i4 %tmp_5 to i32
  %lineBuffer_0_addr_1 = getelementptr [8 x i32]* %lineBuffer_0, i32 0, i32 %tmp_5_cast
  %lineBuffer_1_addr_1 = getelementptr [8 x i32]* %lineBuffer_1, i32 0, i32 %tmp_5_cast
...
.preheader82:                                     ; preds = %.preheader83.preheader, %._crit_edge88
  ...
  %y_assign = phi i4 [ 0, %.preheader83.preheader ], [ %y_assign_cast7_mid2_s, %._crit_edge88 ]
...
._crit_edge:                                      ; preds = %_ifconv1, %.preheader83
  ...
  %lineBuffer_0_addr_2 = getelementptr [8 x i32]* %lineBuffer_0, i32 0, i32 %x_assign_cast5
  %windowRightCol_0 = load i32* %lineBuffer_0_addr_2, align 4
  %lineBuffer_1_addr_2 = getelementptr [8 x i32]* %lineBuffer_1, i32 0, i32 %x_assign_cast5
  %windowRightCol_1 = load i32* %lineBuffer_1_addr_2, align 4
  store i32 %windowRightCol_1, i32* %lineBuffer_0_addr_2, align 4
  %tmp_13 = call i26 @_ssdm_op_PartSelect.i26.i32.i32.i32(i32 %readCount_1_load, i32 6, i32 31)
  %icmp = icmp slt i26 %tmp_13, 1
...
.preheader83:                                     ; preds = %.preheader82
  ...
  %exitcond2 = icmp eq i4 %x_assign, -8
  %x_assign_mid2 = select i1 %exitcond2, i4 0, i4 %x_assign
  %y_s = add i4 1, %y_assign
  %y_assign_cast7_mid2_s = select i1 %exitcond2, i4 %y_s, i4 %y_assign
  %tmp_10 = trunc i4 %y_assign_cast7_mid2_s to i1
  %tmp_11 = trunc i4 %x_assign_mid2 to i1
  %x_assign_cast5 = zext i4 %x_assign_mid2 to i32
