; ModuleID = 'D:/School/Project/new_repo/HLS/cnn_pool_d8x8_p2x2/solution1/.autopilot/db/a.o.3.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-f80:128:128-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S32"
target triple = "i686-pc-mingw32"

@llvm_global_ctors_1 = appending global [1 x void ()*] [void ()* @_GLOBAL__I_a] ; [#uses=0 type=[1 x void ()*]*]
@llvm_global_ctors_0 = appending global [1 x i32] [i32 65535] ; [#uses=0 type=[1 x i32]*]
@cnn_pool_d8x8_p2x2_s = internal unnamed_addr constant [19 x i8] c"cnn_pool_d8x8_p2x2\00" ; [#uses=1 type=[19 x i8]*]
...
define void @cnn_pool_d8x8_p2x2(i32* %inStream_V_data_V, i4* %inStream_V_keep_V, i4* %inStream_V_strb_V, i2* %inStream_V_user_V, i1* %inStream_V_last_V, i5* %inStream_V_id_V, i6* %inStream_V_dest_V, i32* %outStream_V_data_V, i4* %outStream_V_keep_V, i4* %outStream_V_strb_V, i2* %outStream_V_user_V, i1* %outStream_V_last_V, i5* %outStream_V_id_V, i6* %outStream_V_dest_V, i32 %ctrl) {
  ...
  call void (...)* @_ssdm_op_SpecTopModule([19 x i8]* @cnn_pool_d8x8_p2x2_s) nounwind
  ...
  call void @llvm.dbg.declare(metadata !{[8 x i32]* %lineBuffer_0}, metadata !2736), !dbg !2744 ; [debug line = 95:12] [debug variable = lineBuffer[0]]
  call void @llvm.dbg.declare(metadata !{[8 x i32]* %lineBuffer_1}, metadata !2745), !dbg !2744 ; [debug line = 95:12] [debug variable = lineBuffer[1]]
  br label %1, !dbg !2746                         ; [debug line = 103:42]

; <label>:1                                       ; preds = %2, %0
  %x = phi i4 [ 6, %0 ], [ %x_1, %2 ]             ; [#uses=3 type=i4]
  %exitcond1 = icmp eq i4 %x, -8, !dbg !2746      ; [#uses=1 type=i1] [debug line = 103:42]
  br i1 %exitcond1, label %.preheader86.0.preheader, label %2, !dbg !2746 ; [debug line = 103:42]

.preheader86.0.preheader:                         ; preds = %1
  br label %.preheader86.0, !dbg !2748            ; [debug line = 111:17]

; <label>:2                                       ; preds = %1
  %x_cast = zext i4 %x to i32, !dbg !2746         ; [#uses=1 type=i32] [debug line = 103:42]
  %empty = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 2, i64 2, i64 2) ; [#uses=0 type=i32]
  %tmp_1 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str6), !dbg !2752 ; [#uses=1 type=i32] [debug line = 103:57]
  ...
  %x_1 = add i4 %x, 1, !dbg !2779                 ; [#uses=1 type=i4] [debug line = 103:51]
  call void @llvm.dbg.value(metadata !{i4 %x_1}, i64 0, metadata !2780), !dbg !2779 ; [debug line = 103:51] [debug variable = x]
  br label %1, !dbg !2779                         ; [debug line = 103:51]

.preheader86.0:                                   ; preds = %3, %.preheader86.0.preheader
  %x1 = phi i4 [ %x_2, %3 ], [ 0, %.preheader86.0.preheader ] ; [#uses=3 type=i4]
  %exitcond4 = icmp eq i4 %x1, -8, !dbg !2748     ; [#uses=1 type=i1] [debug line = 111:17]
  %x_2 = add i4 %x1, 1, !dbg !2781                ; [#uses=1 type=i4] [debug line = 111:26]
...
; <label>:3                                       ; preds = %.preheader86.0
  %x1_cast = zext i4 %x1 to i32, !dbg !2748       ; [#uses=1 type=i32] [debug line = 111:17]
  %empty_7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 8, i64 8, i64 8) ; [#uses=0 type=i32]
  %tmp_2 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str7), !dbg !2782 ; [#uses=1 type=i32] [debug line = 111:32]
  ...
  br label %.preheader86.0, !dbg !2781            ; [debug line = 111:26]
...
.preheader83.preheader:                           ; preds = %.preheader84
  ...
  %tmp_7 = trunc i32 %ctrl_read to i1, !dbg !2803 ; [#uses=1 type=i1] [debug line = 141:19]
...
.preheader85:                                     ; preds = %.preheader84
  ...
  %tmp_9 = trunc i2 %tmp_3_mid2_v to i1, !dbg !2826 ; [#uses=1 type=i1] [debug line = 125:2]
  ...
  %x4_cast9 = zext i2 %x4_mid2 to i4, !dbg !2821  ; [#uses=1 type=i4] [debug line = 123:35]
  ...
  %tmp_5 = add i4 7, %x4_cast9, !dbg !2826        ; [#uses=1 type=i4] [debug line = 125:2]
  %tmp_5_cast = zext i4 %tmp_5 to i32, !dbg !2826 ; [#uses=2 type=i32] [debug line = 125:2]
  %lineBuffer_0_addr_1 = getelementptr [8 x i32]* %lineBuffer_0, i32 0, i32 %tmp_5_cast, !dbg !2826 ; [#uses=1 type=i32*] [debug line = 125:2]
  %lineBuffer_1_addr_1 = getelementptr [8 x i32]* %lineBuffer_1, i32 0, i32 %tmp_5_cast, !dbg !2826 ; [#uses=1 type=i32*] [debug line = 125:2]
  ...
  %window_2_2_7 = select i1 %tmp_9, i32 %lineBuffer_0_load, i32 %lineBuffer_1_load, !dbg !2826 ; [#uses=2 type=i32] [debug line = 125:2]
...
.preheader82:                                     ; preds = %._crit_edge88, %.preheader83.preheader
  ...
  %y_assign = phi i4 [ 0, %.preheader83.preheader ], [ %y_assign_cast7_mid2_s, %._crit_edge88 ] ; [#uses=2 type=i4]
...
_ifconv1:                                         ; preds = %.preheader83
  ...
  call void @llvm.dbg.value(metadata !{i1 %tmp_7}, i64 0, metadata !2846), !dbg !2847 ; [debug line = 51:84@141:19] [debug variable = op]
  ...
  %tmp_12 = call i1 @_ssdm_op_BitSelect.i1.i32.i32(i32 %a_assign, i32 31), !dbg !2857 ; [#uses=2 type=i1] [debug line = 74:2@69:12@141:19]
  ...
  %result = select i1 %tmp_12, i20 %tmp_3, i20 %tmp_6, !dbg !2857 ; [#uses=1 type=i20] [debug line = 74:2@69:12@141:19]
  ...
  %result_1 = select i1 %tmp_12, i21 %tmp_4_i_i, i21 %result_cast, !dbg !2861 ; [#uses=1 type=i21] [debug line = 79:2@69:12@141:19]
  ...
  %tmp_data_V_2 = select i1 %tmp_7, i32 %result_1_cast, i32 %sel_SEBB_i, !dbg !2863 ; [#uses=1 type=i32] [debug line = 145:31@149:5]
  ...
  %tmp_last_V = icmp eq i32 %writeCount, 16, !dbg !2875 ; [#uses=1 type=i1] [debug line = 76:2@147:19]
...
._crit_edge:                                      ; preds = %.preheader83, %_ifconv1
  ...
  %lineBuffer_0_addr_2 = getelementptr [8 x i32]* %lineBuffer_0, i32 0, i32 %x_assign_cast5 ; [#uses=2 type=i32*]
  ...
  %lineBuffer_1_addr_2 = getelementptr [8 x i32]* %lineBuffer_1, i32 0, i32 %x_assign_cast5 ; [#uses=2 type=i32*]
  ...
  %tmp_13 = call i26 @_ssdm_op_PartSelect.i26.i32.i32.i32(i32 %readCount_1_load, i32 6, i32 31), !dbg !2898 ; [#uses=1 type=i26] [debug line = 160:4]
  %icmp = icmp slt i26 %tmp_13, 1, !dbg !2898     ; [#uses=1 type=i1] [debug line = 160:4]
  store i32 %windowRightCol_0, i32* %window_0_1
  br i1 %icmp, label %4, label %._crit_edge88, !dbg !2898 ; [debug line = 160:4]
...
._crit_edge88:                                    ; preds = %4, %._crit_edge
  ...
  %x_4 = add i4 %x_assign_mid2, 1, !dbg !2934     ; [#uses=1 type=i4] [debug line = 131:26]
  call void @llvm.dbg.value(metadata !{i4 %x_4}, i64 0, metadata !2935), !dbg !2934 ; [debug line = 131:26] [debug variable = x]
  br label %.preheader82, !dbg !2934              ; [debug line = 131:26]

.preheader83:                                     ; preds = %.preheader82
  %empty_14 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 64, i64 64, i64 64) ; [#uses=0 type=i32]
  %exitcond2 = icmp eq i4 %x_assign, -8, !dbg !2936 ; [#uses=2 type=i1] [debug line = 131:17]
  %x_assign_mid2 = select i1 %exitcond2, i4 0, i4 %x_assign ; [#uses=3 type=i4]
  %y_s = add i4 1, %y_assign, !dbg !2937          ; [#uses=1 type=i4] [debug line = 130:25]
  %y_assign_cast7_mid2_s = select i1 %exitcond2, i4 %y_s, i4 %y_assign, !dbg !2820 ; [#uses=2 type=i4] [debug line = 130:16]
  %tmp_10 = trunc i4 %y_assign_cast7_mid2_s to i1, !dbg !2820 ; [#uses=1 type=i1] [debug line = 130:16]
  %tmp_11 = trunc i4 %x_assign_mid2 to i1, !dbg !2936 ; [#uses=1 type=i1] [debug line = 131:17]
  %x_assign_cast5 = zext i4 %x_assign_mid2 to i32, !dbg !2936 ; [#uses=2 type=i32] [debug line = 131:17]
  %tmp_8 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str9), !dbg !2938 ; [#uses=1 type=i32] [debug line = 131:32]
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind, !dbg !2939 ; [debug line = 132:1]
  call void @llvm.dbg.value(metadata !{i4 %x_assign}, i64 0, metadata !2940), !dbg !2945 ; [debug line = 45:26@135:9] [debug variable = x]
  call void @llvm.dbg.value(metadata !{i4 %y_assign}, i64 0, metadata !2946), !dbg !2947 ; [debug line = 45:33@135:9] [debug variable = y]
  %tmp = and i1 %tmp_10, %tmp_11, !dbg !2948      ; [#uses=1 type=i1] [debug line = 47:2@135:9]
...
!128 = metadata !{i32 786478, i32 0, metadata !129, metadata !"cnn_pool_d8x8_p2x2", metadata !"cnn_pool_d8x8_p2x2", metadata !"_Z18cnn_pool_d8x8_p2x2RN3hls6streamI7ap_axiuILi32ELi2ELi5ELi6EEEES4_j", metadata !129, i32 85, metadata !130, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, null, null, null, metadata !159, i32 89} ; [ DW_TAG_subprogram ]
!129 = metadata !{i32 786473, metadata !"cnn_pool_d8x8_p2x2/core.cpp", metadata !"D:\5CSchool\5CProject\5Cnew_repo\5CHLS", null} ; [ DW_TAG_file_type ]
...
!2738 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 512, i64 32, i32 0, i32 0, metadata !2739, metadata !2740, i32 0, i32 0} ; [ DW_TAG_array_type ]
...
!2742 = metadata !{i32 786465, i64 0, i64 7}      ; [ DW_TAG_subrange_type ]
!2743 = metadata !{i32 786433, null, metadata !"", null, i32 0, i64 256, i64 32, i32 0, i32 0, metadata !2739, metadata !2740, i32 0, i32 0} ; [ DW_TAG_array_type ]
...
!2746 = metadata !{i32 103, i32 42, metadata !2747, null}
...
!2752 = metadata !{i32 103, i32 57, metadata !2753, null}
!2753 = metadata !{i32 786443, metadata !2747, i32 103, i32 56, metadata !129, i32 2} ; [ DW_TAG_lexical_block ]
...
!2779 = metadata !{i32 103, i32 51, metadata !2747, null}
!2780 = metadata !{i32 786688, metadata !2747, metadata !"x", metadata !129, i32 103, metadata !168, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2781 = metadata !{i32 111, i32 26, metadata !2749, null}
!2782 = metadata !{i32 111, i32 32, metadata !2783, null}
!2783 = metadata !{i32 786443, metadata !2749, i32 111, i32 31, metadata !129, i32 6} ; [ DW_TAG_lexical_block ]
...
!2805 = metadata !{i32 786443, metadata !2806, i32 131, i32 31, metadata !129, i32 14} ; [ DW_TAG_lexical_block ]
!2806 = metadata !{i32 786443, metadata !2807, i32 131, i32 3, metadata !129, i32 13} ; [ DW_TAG_lexical_block ]
!2807 = metadata !{i32 786443, metadata !2808, i32 130, i32 30, metadata !129, i32 12} ; [ DW_TAG_lexical_block ]
...
!2851 = metadata !{i32 786473, metadata !"cnn_pool_d8x8_p2x2/fixed_point.h", metadata !"D:\5CSchool\5CProject\5Cnew_repo\5CHLS", null} ; [ DW_TAG_file_type ]
...
!2909 = metadata !{i32 786443, metadata !2805, i32 160, i32 27, metadata !129, i32 18} ; [ DW_TAG_lexical_block ]
...
!2934 = metadata !{i32 131, i32 26, metadata !2806, null}
...
!2937 = metadata !{i32 130, i32 25, metadata !2808, null}
!2938 = metadata !{i32 131, i32 32, metadata !2805, null}
