...
entity cnn_pool_d60x60_p2x2 is
generic (
...
architecture behav of cnn_pool_d60x60_p2x2 is 
    attribute CORE_GENERATION_INFO : STRING;
    attribute CORE_GENERATION_INFO of behav : architecture is
    "cnn_pool_d60x60_p2x2,hls_ip_2016_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.220000,HLS_SYN_LAT=3676,HLS_SYN_TPT=none,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=808,HLS_SYN_LUT=1087}";
    ...
    component cnn_pool_d60x60_pbkb IS
    generic (
        DataWidth : INTEGER;
    ...
    component cnn_pool_d60x60_p2x2_CTRL_s_axi IS
    generic (
...
begin
    cnn_pool_d60x60_p2x2_CTRL_s_axi_U : component cnn_pool_d60x60_p2x2_CTRL_s_axi
    generic map (
    ...
    lineBuffer_0_U : component cnn_pool_d60x60_pbkb
    generic map (
        DataWidth => 32,
        AddressRange => 60,
        AddressWidth => 6)
    ...
    lineBuffer_1_U : component cnn_pool_d60x60_pbkb
    generic map (
        DataWidth => 32,
        AddressRange => 60,
        AddressWidth => 6)
    ...
    exitcond2_fu_626_p2 <= "1" when (x_assign_reg_392 = ap_const_lv6_3C) else "0";
    exitcond4_fu_453_p2 <= "1" when (x1_phi_fu_305_p4 = ap_const_lv6_3C) else "0";
    exitcond_flatten8_fu_614_p2 <= "1" when (indvar_flatten6_reg_370 = ap_const_lv12_E10) else "0";
    ...
    tmp_7_fu_677_p2 <= "1" when (signed(readCount_1_fu_170) < signed(ap_const_lv32_E10)) else "0";
    ...
    tmp_last_V_fu_874_p2 <= "1" when (writeCount_fu_828_p2 = ap_const_lv32_384) else "0";
