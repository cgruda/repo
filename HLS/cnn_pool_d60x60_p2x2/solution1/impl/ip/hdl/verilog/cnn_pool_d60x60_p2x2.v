...
(* CORE_GENERATION_INFO="cnn_pool_d60x60_p2x2,hls_ip_2016_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=8.220000,HLS_SYN_LAT=3676,HLS_SYN_TPT=none,HLS_SYN_MEM=4,HLS_SYN_DSP=0,HLS_SYN_FF=808,HLS_SYN_LUT=1087}" *)
...
parameter    ap_const_lv32_E10 = 32'b111000010000;
...
reg   [1:0] x4_reg_359;
reg   [11:0] indvar_flatten6_reg_370;
reg   [5:0] y_assign_reg_381;
reg   [5:0] x_assign_reg_392;
...
wire   [11:0] indvar_flatten_next7_fu_620_p2;
reg    ap_enable_reg_pp3_iter0;
wire   [5:0] y_assign_cast7_mid2_s_fu_646_p3;
reg   [5:0] y_assign_cast7_mid2_s_reg_1027;
wire   [0:0] tmp_fu_668_p2;
reg   [5:0] lineBuffer_0_addr_2_reg_1036;
reg   [5:0] lineBuffer_1_addr_2_reg_1042;
reg   [5:0] ap_pipeline_reg_pp3_iter1_lineBuffer_1_addr_2_reg_1042;
...
reg   [5:0] x1_phi_fu_305_p4;
reg   [1:0] y3_phi_fu_328_p4;
reg   [5:0] y_assign_phi_fu_385_p4;
...
wire  signed [5:0] x_cast_fu_444_p1;
...
wire  signed [5:0] tmp_5_cast1_fu_544_p1;
...
wire   [5:0] y_s_fu_640_p2;
wire   [5:0] x_assign_mid2_fu_632_p3;
...
cnn_pool_d60x60_p2x2_CTRL_s_axi #(
    .C_S_AXI_ADDR_WIDTH( C_S_AXI_CTRL_ADDR_WIDTH ),
    .C_S_AXI_DATA_WIDTH( C_S_AXI_CTRL_DATA_WIDTH ))
cnn_pool_d60x60_p2x2_CTRL_s_axi_U(
...
assign exitcond2_fu_626_p2 = ((x_assign_reg_392 == ap_const_lv6_3C) ? 1'b1 : 1'b0);

assign exitcond4_fu_453_p2 = ((x1_phi_fu_305_p4 == ap_const_lv6_3C) ? 1'b1 : 1'b0);

assign exitcond_flatten8_fu_614_p2 = ((indvar_flatten6_reg_370 == ap_const_lv12_E10) ? 1'b1 : 1'b0);
...
assign indvar_flatten_next7_fu_620_p2 = (indvar_flatten6_reg_370 + ap_const_lv12_1);
...
assign tmp_7_fu_677_p2 = (($signed(readCount_1_fu_170) < $signed(32'b111000010000)) ? 1'b1 : 1'b0);
...
assign tmp_last_V_fu_874_p2 = ((writeCount_fu_828_p2 == ap_const_lv32_384) ? 1'b1 : 1'b0);
...
assign x_2_fu_459_p2 = (x1_phi_fu_305_p4 + ap_const_lv6_1);

assign x_3_fu_560_p2 = (ap_const_lv2_1 + x4_mid2_fu_488_p3);

assign x_4_fu_694_p2 = (x_assign_mid2_fu_632_p3 + ap_const_lv6_1);

assign x_assign_cast5_fu_662_p1 = x_assign_mid2_fu_632_p3;

assign x_assign_mid2_fu_632_p3 = ((exitcond2_fu_626_p2[0:0] === 1'b1) ? ap_const_lv6_0 : x_assign_reg_392);
...
assign y_s_fu_640_p2 = (ap_const_lv6_1 + y_assign_phi_fu_385_p4);

endmodule //cnn_pool_d60x60_p2x2
