; ModuleID = 'D:/School/Project/new_repo/HLS/cnn_conv_d12x12_k3x3/solution1/.autopilot/db/a.o.2.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-f80:128:128-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S32"
target triple = "i686-pc-mingw32"

@llvm_global_ctors_1 = appending global [1 x void ()*] [void ()* @_GLOBAL__I_a]
@llvm_global_ctors_0 = appending global [1 x i32] [i32 65535]
@cnn_conv_d12x12_k3x3_1 = internal unnamed_addr constant [21 x i8] c"cnn_conv_d12x12_k3x3\00"
...
define void @cnn_conv_d12x12_k3x3(i32* %inStream_V_data_V, i4* %inStream_V_keep_V, i4* %inStream_V_strb_V, i2* %inStream_V_user_V, i1* %inStream_V_last_V, i5* %inStream_V_id_V, i6* %inStream_V_dest_V, i32* %outStream_V_data_V, i4* %outStream_V_keep_V, i4* %outStream_V_strb_V, i2* %outStream_V_user_V, i1* %outStream_V_last_V, i5* %outStream_V_id_V, i6* %outStream_V_dest_V, i32 %ctrl, i32* %kernel_0, i32* %kernel_1, i32* %kernel_2, i32* %kernel_3, i32* %kernel_4, i32* %kernel_5, i32* %kernel_6, i32* %kernel_7, i32* %kernel_8) {
  ...
  %lineBuffer_0 = alloca [12 x i32], align 4
  %lineBuffer_1 = alloca [12 x i32], align 4
...
; <label>:2                                       ; preds = %1
  ...
  %lineBuffer_0_addr = getelementptr [12 x i32]* %lineBuffer_0, i32 0, i32 %x_cast
...
.preheader86.0:                                   ; preds = %.preheader86.0.preheader, %3
  %x1 = phi i4 [ %x_2, %3 ], [ 0, %.preheader86.0.preheader ]
  %exitcond4 = icmp eq i4 %x1, -4
  %x_2 = add i4 %x1, 1
...
; <label>:3                                       ; preds = %.preheader86.0
  %x1_cast = zext i4 %x1 to i32
  %empty_7 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 12, i64 12, i64 12)
  ...
  %lineBuffer_1_addr = getelementptr [12 x i32]* %lineBuffer_1, i32 0, i32 %x1_cast
...
.preheader85:                                     ; preds = %.preheader84
  ...
  %x4_cast = zext i2 %x4_mid2 to i4
  %tmp_4 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str8)
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind
  %tmp_s = add i4 -7, %x4_cast
  %tmp_cast = zext i4 %tmp_s to i32
  %lineBuffer_0_addr_1 = getelementptr [12 x i32]* %lineBuffer_0, i32 0, i32 %tmp_cast
  %lineBuffer_1_addr_1 = getelementptr [12 x i32]* %lineBuffer_1, i32 0, i32 %tmp_cast
...
.preheader82:                                     ; preds = %.preheader83.preheader, %._crit_edge88
  %indvar_flatten6 = phi i8 [ 0, %.preheader83.preheader ], [ %indvar_flatten_next7, %._crit_edge88 ]
  %y_assign = phi i4 [ 0, %.preheader83.preheader ], [ %y_assign_mid2, %._crit_edge88 ]
  ...
  %x_assign = phi i4 [ 0, %.preheader83.preheader ], [ %x_4, %._crit_edge88 ]
  ...
  %exitcond_flatten8 = icmp eq i8 %indvar_flatten6, -112
  %indvar_flatten_next7 = add i8 %indvar_flatten6, 1
...
_ifconv1:                                         ; preds = %.preheader83
  ...
  %tmp_last_V = icmp eq i32 %writeCount, 100
...
._crit_edge:                                      ; preds = %_ifconv1, %.preheader83
  ...
  %lineBuffer_0_addr_2 = getelementptr [12 x i32]* %lineBuffer_0, i32 0, i32 %x_assign_cast
  %windowRightCol_0 = load i32* %lineBuffer_0_addr_2, align 4
  %lineBuffer_1_addr_2 = getelementptr [12 x i32]* %lineBuffer_1, i32 0, i32 %x_assign_cast
  %windowRightCol_1 = load i32* %lineBuffer_1_addr_2, align 4
  store i32 %windowRightCol_1, i32* %lineBuffer_0_addr_2, align 4
  %tmp_5 = icmp slt i32 %readCount_1_load, 144
...
.preheader83:                                     ; preds = %.preheader82
  %empty_14 = call i32 (...)* @_ssdm_op_SpecLoopTripCount(i64 144, i64 144, i64 144)
  %exitcond2 = icmp eq i4 %x_assign, -4
  %x_assign_mid2 = select i1 %exitcond2, i4 0, i4 %x_assign
  %y_s = add i4 %y_assign, 1
  %tmp_i_mid1 = icmp eq i4 %y_s, 0
  %tmp_i = icmp eq i4 %y_assign, 0
  %tmp_i_mid2 = select i1 %exitcond2, i1 %tmp_i_mid1, i1 %tmp_i
  %tmp_2_i_mid1 = icmp ugt i4 %y_s, -6
  %tmp_2_i = icmp ugt i4 %y_assign, -6
  %tmp_2_i_mid2 = select i1 %exitcond2, i1 %tmp_2_i_mid1, i1 %tmp_2_i
  %y_assign_mid2 = select i1 %exitcond2, i4 %y_s, i4 %y_assign
  %x_assign_cast = zext i4 %x_assign_mid2 to i32
  %tmp_3 = call i32 (...)* @_ssdm_op_SpecRegionBegin([12 x i8]* @p_str9)
  call void (...)* @_ssdm_op_SpecPipeline(i32 -1, i32 1, i32 1, i32 0, [1 x i8]* @p_str2) nounwind
  %tmp_i_15 = icmp eq i4 %x_assign_mid2, 0
  %tmp_1_i = icmp ugt i4 %x_assign_mid2, -6
