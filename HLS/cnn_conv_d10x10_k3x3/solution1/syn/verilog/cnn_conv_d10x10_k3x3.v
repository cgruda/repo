...
(* CORE_GENERATION_INFO="cnn_conv_d10x10_k3x3,hls_ip_2016_4,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xc7z020clg484-1,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=7.970000,HLS_SYN_LAT=133,HLS_SYN_TPT=none,HLS_SYN_MEM=4,HLS_SYN_DSP=36,HLS_SYN_FF=2663,HLS_SYN_LUT=4370}" *)
...
reg   [1:0] x4_reg_445;
reg   [6:0] indvar_flatten6_reg_456;
...
wire   [6:0] indvar_flatten_next7_fu_816_p2;
...
cnn_conv_d10x10_k3x3_CTRL_s_axi #(
    .C_S_AXI_ADDR_WIDTH( C_S_AXI_CTRL_ADDR_WIDTH ),
    .C_S_AXI_DATA_WIDTH( C_S_AXI_CTRL_DATA_WIDTH ))
cnn_conv_d10x10_k3x3_CTRL_s_axi_U(
...
assign exitcond1_fu_598_p2 = ((x_phi_fu_367_p4 == ap_const_lv4_A) ? 1'b1 : 1'b0);

assign exitcond2_fu_822_p2 = ((x_assign_reg_478 == ap_const_lv4_A) ? 1'b1 : 1'b0);

assign exitcond4_fu_615_p2 = ((x1_phi_fu_379_p4 == ap_const_lv4_A) ? 1'b1 : 1'b0);

assign exitcond_flatten8_fu_810_p2 = ((indvar_flatten6_reg_456 == ap_const_lv7_64) ? 1'b1 : 1'b0);
...
assign indvar_flatten_next7_fu_816_p2 = (indvar_flatten6_reg_456 + ap_const_lv7_1);
...
assign tmp_1_i_fu_902_p2 = ((x_assign_mid2_fu_828_p3 > ap_const_lv4_8) ? 1'b1 : 1'b0);

assign tmp_2_i_fu_868_p2 = ((y_assign_reg_467 > ap_const_lv4_8) ? 1'b1 : 1'b0);

assign tmp_2_i_mid1_fu_862_p2 = ((y_s_fu_836_p2 > ap_const_lv4_8) ? 1'b1 : 1'b0);
...
assign tmp_5_fu_929_p2 = (($signed(readCount_1_fu_194) < $signed(32'b1100100)) ? 1'b1 : 1'b0);
...
assign tmp_last_V_fu_1167_p2 = ((writeCount_fu_1100_p2 == ap_const_lv32_40) ? 1'b1 : 1'b0);

assign tmp_s_fu_700_p2 = (ap_const_lv4_7 + x4_cast_fu_696_p1);
...
endmodule //cnn_conv_d10x10_k3x3
