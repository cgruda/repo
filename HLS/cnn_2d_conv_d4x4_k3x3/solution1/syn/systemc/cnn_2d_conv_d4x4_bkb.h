...
#ifndef __cnn_2d_conv_d4x4_bkb__HH__
#define __cnn_2d_conv_d4x4_bkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_2d_conv_d4x4_bkb) {
    ...
    SC_CTOR(cnn_2d_conv_d4x4_bkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
