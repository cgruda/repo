...
#ifndef __cnn_conv_d4x4_k3xbkb__HH__
#define __cnn_conv_d4x4_k3xbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(cnn_conv_d4x4_k3xbkb) {
    ...
    SC_CTOR(cnn_conv_d4x4_k3xbkb):  ACMP_mul_ss_U ("ACMP_mul_ss_U") {
