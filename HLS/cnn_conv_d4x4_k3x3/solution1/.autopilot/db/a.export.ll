; ModuleID = 'D:/School/Project/new_repo/HLS/cnn_conv_d4x4_k3x3/solution1/.autopilot/db/a.o.2.bc'
target datalayout = "e-p:32:32:32-i1:8:8-i8:8:8-i16:16:16-i32:32:32-i64:64:64-f32:32:32-f64:64:64-f80:128:128-v64:64:64-v128:128:128-a0:0:64-f80:32:32-n8:16:32-S32"
target triple = "i686-pc-mingw32"

@llvm_global_ctors_1 = appending global [1 x void ()*] [void ()* @_GLOBAL__I_a]
@llvm_global_ctors_0 = appending global [1 x i32] [i32 65535]
@cnn_conv_d4x4_k3x3_s = internal unnamed_addr constant [19 x i8] c"cnn_conv_d4x4_k3x3\00"
...
_ifconv:                                          ; preds = %1
  ...
  %tmp_8 = trunc i3 %x to i2
  %cond = icmp eq i2 %tmp_8, -2
...
.preheader85:                                     ; preds = %.preheader84
  ...
  %tmp_11 = trunc i2 %tmp_2_mid2_v to i1
  %cond3_mid1 = icmp eq i2 %y3, 0
  %cond2 = icmp eq i2 %y3, 1
  ...
  %lineBuffer_load13_ph = select i1 %cond1, i32 %lineBuffer_0_2, i32 %lineBuffer_0_3
  %lineBuffer_load14_ph = select i1 %cond1, i32 %lineBuffer_1_2, i32 %lineBuffer_1_3
  %window_1_1_2 = select i1 %tmp_11, i32 %lineBuffer_load13_ph, i32 %lineBuffer_load14_ph
  %window_2_2 = select i1 %cond1, i32 %window_1_2_1, i32 %window_1_1_2
  %window_2_2_1 = select i1 %cond1, i32 %window_1_1_2, i32 %window_1_1_1
  %window_2_2_3 = select i1 %cond1, i32 %window_2_2_2_load_1, i32 %window_1_1_2
  %window_2_2_4 = select i1 %cond1, i32 %window_1_1_2, i32 %window_2_1_1
  %window_2_2_5 = select i1 %cond3_mid2, i32 %window_2_2_2_load_1, i32 %window_2_2_3
  ...
  %window_2_2_8 = select i1 %cond3_mid2, i32 %window_2_2_1, i32 %window_1_1_1
...
.preheader82:                                     ; preds = %.preheader83.preheader, %._crit_edge88_ifconv
  ...
  %y_assign = phi i3 [ 0, %.preheader83.preheader ], [ %y_assign_mid2, %._crit_edge88_ifconv ]
  ...
  %window_2_0 = phi i32 [ %window_2_1_1, %.preheader83.preheader ], [ %window_2_1_2, %._crit_edge88_ifconv ]
...
_ifconv59:                                        ; preds = %.preheader83
  ...
  %tmp94_trunc_ext_cast = sext i23 %tmp_9_2_i to i24
  %tmp94_trunc141_ext_c = sext i23 %tmp_9_2_1_i to i24
  %tmp3 = add i24 %tmp94_trunc141_ext_c, %tmp94_trunc_ext_cast
  %tmp94_cast = sext i24 %tmp3 to i25
  %tmp95_trunc_ext_cast = sext i23 %tmp_9_1_1_i to i24
  %tmp95_trunc140_ext_c = sext i23 %tmp_9_1_2_i to i24
  %tmp4 = add i24 %tmp95_trunc_ext_cast, %tmp95_trunc140_ext_c
  %tmp95_cast = sext i24 %tmp4 to i25
  %tmp5 = add i25 %tmp94_cast, %tmp95_cast
  %tmp93_cast = sext i25 %tmp5 to i27
  %tmp97_trunc_ext_cast = sext i23 %tmp_9_0_i to i24
  %tmp97_trunc139_ext_c = sext i23 %tmp_9_0_1_i to i24
  %tmp6 = add i24 %tmp97_trunc139_ext_c, %tmp97_trunc_ext_cast
  %tmp97_cast = sext i24 %tmp6 to i26
  %tmp99_trunc_ext_cast = sext i23 %tmp_9_0_2_i to i24
  %tmp99_trunc142_ext_c = sext i23 %tmp_9_2_2_i to i24
  %tmp7 = add i24 %tmp99_trunc142_ext_c, %tmp99_trunc_ext_cast
  %tmp99_cast = sext i24 %tmp7 to i25
  %tmp98_trunc_ext_cast = sext i23 %tmp_9_1_i to i25
  %tmp8 = add i25 %tmp98_trunc_ext_cast, %tmp99_cast
  %tmp98_cast = sext i25 %tmp8 to i26
  %tmp9 = add i26 %tmp97_cast, %tmp98_cast
  %tmp96_cast = sext i26 %tmp9 to i27
  %result_4_2_2_i = add i27 %tmp93_cast, %tmp96_cast
  %result_4_2_2_i_cast1 = sext i27 %result_4_2_2_i to i32
  %tmp_12 = call i1 @_ssdm_op_BitSelect.i1.i27.i32(i27 %result_4_2_2_i, i32 26)
  %result = select i1 %tmp_12, i27 0, i27 %result_4_2_2_i
  %result_cast1 = sext i27 %result to i31
  %result_cast = zext i31 %result_cast1 to i32
  %tmp_data_V = select i1 %tmp_10, i32 %result_cast, i32 %result_4_2_2_i_cast1
...
._crit_edge_ifconv:                               ; preds = %_ifconv59, %.preheader83
  ...
  %tmp_13 = trunc i3 %x_assign_mid2 to i2
  %windowRightCol_0 = call i32 @_ssdm_op_Mux.ap_auto.4i32.i2(i32 %lineBuffer_0_3_5_l, i32 %lineBuffer_0_3_8_l, i32 %lineBuffer_0_2_s, i32 %lineBuffer_0_3_3, i2 %tmp_13)
  %lineBuffer_0_3_15 = call i32 @_ssdm_op_Mux.ap_auto.4i32.i2(i32 %lineBuffer_1_3_1, i32 %lineBuffer_1_3_17, i32 %lineBuffer_1_2_3, i32 %lineBuffer_1_3_3, i2 %tmp_13)
  %sel_tmp2 = icmp eq i2 %tmp_13, -2
  %sel_tmp3 = icmp eq i2 %tmp_13, 1
  %sel_tmp4 = icmp eq i2 %tmp_13, 0
  ...
  %tmp_14 = call i28 @_ssdm_op_PartSelect.i28.i32.i32.i32(i32 %readCount_1_load, i32 4, i32 31)
  %icmp = icmp slt i28 %tmp_14, 1
...
.preheader83:                                     ; preds = %.preheader82
  ...
  %p_i = or i1 %tmp2, %tmp1
  br i1 %p_i, label %._crit_edge_ifconv, label %_ifconv59
...
entry:
  ...
  %empty_26 = shl i27 1, %empty
  %empty_27 = and i27 %0, %empty_26
  %empty_28 = icmp ne i27 %empty_27, 0
  ret i1 %empty_28
}
