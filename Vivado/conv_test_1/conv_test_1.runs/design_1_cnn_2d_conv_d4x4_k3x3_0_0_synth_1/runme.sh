...
HD_PWD='D:/School/Project/new_repo/Vivado/conv_test_1/conv_test_1.runs/design_1_cnn_2d_conv_d4x4_k3x3_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_cnn_2d_conv_d4x4_k3x3_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_cnn_2d_conv_d4x4_k3x3_0_0.tcl
