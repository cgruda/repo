...
HD_PWD='D:/School/Project/new_repo/Vivado/cnn_step_a/cnn_step_a.runs/design_1_cnn_fc_i50_o10_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_cnn_fc_i50_o10_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_cnn_fc_i50_o10_0_0.tcl
