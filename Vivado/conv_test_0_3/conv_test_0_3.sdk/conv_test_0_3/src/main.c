...
#include "xcnn_conv_d32x32_k3x3.h"
#include "xaxidma.h"

struct cnn_hw {
	XCnn_conv_d32x32_k3x3 cnn_0;
	XCnn_conv_d32x32_k3x3_Config *cnn_0_cfg;
	XAxiDma axiDMA;
...
void (*XCnn_Set_kernel[KERNEL_LEN])(XCnn_conv_d32x32_k3x3 *InstancePtr, u32 Data) = {
		XCnn_conv_d32x32_k3x3_Set_kernel_0,
		XCnn_conv_d32x32_k3x3_Set_kernel_1,
		XCnn_conv_d32x32_k3x3_Set_kernel_2,
		XCnn_conv_d32x32_k3x3_Set_kernel_3,
		XCnn_conv_d32x32_k3x3_Set_kernel_4,
		XCnn_conv_d32x32_k3x3_Set_kernel_5,
		XCnn_conv_d32x32_k3x3_Set_kernel_6,
		XCnn_conv_d32x32_k3x3_Set_kernel_7,
		XCnn_conv_d32x32_k3x3_Set_kernel_8
};
...
int cnn_hw_init(struct cnn_hw *p_cnn_hw)
{
	...
	p_cnn_hw->cnn_0_cfg = XCnn_conv_d32x32_k3x3_LookupConfig(XPAR_CNN_CONV_D32X32_K3X3_0_DEVICE_ID);
	if (!p_cnn_hw->cnn_0_cfg) {
		printf("XCnn_LookupConfig failed\n");
		return XST_FAILURE;
	}

	status = XCnn_conv_d32x32_k3x3_CfgInitialize(&p_cnn_hw->cnn_0, p_cnn_hw->cnn_0_cfg);
...
void XCnn_Set_HW(XCnn_conv_d32x32_k3x3 *InstancePtr, u32 ctrl, u32 kernel[KERNEL_LEN])
{
	XCnn_conv_d32x32_k3x3_Set_ctrl(InstancePtr, ctrl);
...
int main()
{
	...
	do {
		...
		XCnn_conv_d32x32_k3x3_Start(&cnn_hw.cnn_0);
		...
		while (!XCnn_conv_d32x32_k3x3_IsDone(&cnn_hw.cnn_0))
			/* wait */ ;
