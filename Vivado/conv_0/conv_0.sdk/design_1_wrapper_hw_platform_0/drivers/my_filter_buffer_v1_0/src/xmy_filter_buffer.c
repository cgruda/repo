...
void XMy_filter_buffer_Set_ctrl(XMy_filter_buffer *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XMy_filter_buffer_WriteReg(InstancePtr->Ctrl_BaseAddress, XMY_FILTER_BUFFER_CTRL_ADDR_CTRL_DATA, Data);
}

u32 XMy_filter_buffer_Get_ctrl(XMy_filter_buffer *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XMy_filter_buffer_ReadReg(InstancePtr->Ctrl_BaseAddress, XMY_FILTER_BUFFER_CTRL_ADDR_CTRL_DATA);
    return Data;
}
...
void XMy_filter_buffer_Set_bias_0(XMy_filter_buffer *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XMy_filter_buffer_WriteReg(InstancePtr->Kernel_bus_BaseAddress, XMY_FILTER_BUFFER_KERNEL_BUS_ADDR_BIAS_0_DATA, Data);
}

u32 XMy_filter_buffer_Get_bias_0(XMy_filter_buffer *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XMy_filter_buffer_ReadReg(InstancePtr->Kernel_bus_BaseAddress, XMY_FILTER_BUFFER_KERNEL_BUS_ADDR_BIAS_0_DATA);
    return Data;
}

void XMy_filter_buffer_Set_bias_1(XMy_filter_buffer *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XMy_filter_buffer_WriteReg(InstancePtr->Kernel_bus_BaseAddress, XMY_FILTER_BUFFER_KERNEL_BUS_ADDR_BIAS_1_DATA, Data);
}

u32 XMy_filter_buffer_Get_bias_1(XMy_filter_buffer *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XMy_filter_buffer_ReadReg(InstancePtr->Kernel_bus_BaseAddress, XMY_FILTER_BUFFER_KERNEL_BUS_ADDR_BIAS_1_DATA);
    return Data;
}

void XMy_filter_buffer_Set_bias_2(XMy_filter_buffer *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XMy_filter_buffer_WriteReg(InstancePtr->Kernel_bus_BaseAddress, XMY_FILTER_BUFFER_KERNEL_BUS_ADDR_BIAS_2_DATA, Data);
}

u32 XMy_filter_buffer_Get_bias_2(XMy_filter_buffer *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XMy_filter_buffer_ReadReg(InstancePtr->Kernel_bus_BaseAddress, XMY_FILTER_BUFFER_KERNEL_BUS_ADDR_BIAS_2_DATA);
    return Data;
}

void XMy_filter_buffer_Set_bias_3(XMy_filter_buffer *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XMy_filter_buffer_WriteReg(InstancePtr->Kernel_bus_BaseAddress, XMY_FILTER_BUFFER_KERNEL_BUS_ADDR_BIAS_3_DATA, Data);
}

u32 XMy_filter_buffer_Get_bias_3(XMy_filter_buffer *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XMy_filter_buffer_ReadReg(InstancePtr->Kernel_bus_BaseAddress, XMY_FILTER_BUFFER_KERNEL_BUS_ADDR_BIAS_3_DATA);
    return Data;
}

void XMy_filter_buffer_Set_bias_4(XMy_filter_buffer *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XMy_filter_buffer_WriteReg(InstancePtr->Kernel_bus_BaseAddress, XMY_FILTER_BUFFER_KERNEL_BUS_ADDR_BIAS_4_DATA, Data);
}

u32 XMy_filter_buffer_Get_bias_4(XMy_filter_buffer *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XMy_filter_buffer_ReadReg(InstancePtr->Kernel_bus_BaseAddress, XMY_FILTER_BUFFER_KERNEL_BUS_ADDR_BIAS_4_DATA);
    return Data;
}

void XMy_filter_buffer_Set_bias_5(XMy_filter_buffer *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XMy_filter_buffer_WriteReg(InstancePtr->Kernel_bus_BaseAddress, XMY_FILTER_BUFFER_KERNEL_BUS_ADDR_BIAS_5_DATA, Data);
}

u32 XMy_filter_buffer_Get_bias_5(XMy_filter_buffer *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XMy_filter_buffer_ReadReg(InstancePtr->Kernel_bus_BaseAddress, XMY_FILTER_BUFFER_KERNEL_BUS_ADDR_BIAS_5_DATA);
    return Data;
}

void XMy_filter_buffer_Set_bias_6(XMy_filter_buffer *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XMy_filter_buffer_WriteReg(InstancePtr->Kernel_bus_BaseAddress, XMY_FILTER_BUFFER_KERNEL_BUS_ADDR_BIAS_6_DATA, Data);
}

u32 XMy_filter_buffer_Get_bias_6(XMy_filter_buffer *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XMy_filter_buffer_ReadReg(InstancePtr->Kernel_bus_BaseAddress, XMY_FILTER_BUFFER_KERNEL_BUS_ADDR_BIAS_6_DATA);
    return Data;
}

void XMy_filter_buffer_Set_bias_7(XMy_filter_buffer *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XMy_filter_buffer_WriteReg(InstancePtr->Kernel_bus_BaseAddress, XMY_FILTER_BUFFER_KERNEL_BUS_ADDR_BIAS_7_DATA, Data);
}

u32 XMy_filter_buffer_Get_bias_7(XMy_filter_buffer *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XMy_filter_buffer_ReadReg(InstancePtr->Kernel_bus_BaseAddress, XMY_FILTER_BUFFER_KERNEL_BUS_ADDR_BIAS_7_DATA);
    return Data;
}

void XMy_filter_buffer_Set_bias_8(XMy_filter_buffer *InstancePtr, u32 Data) {
    Xil_AssertVoid(InstancePtr != NULL);
    Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    XMy_filter_buffer_WriteReg(InstancePtr->Kernel_bus_BaseAddress, XMY_FILTER_BUFFER_KERNEL_BUS_ADDR_BIAS_8_DATA, Data);
}

u32 XMy_filter_buffer_Get_bias_8(XMy_filter_buffer *InstancePtr) {
    u32 Data;

    Xil_AssertNonvoid(InstancePtr != NULL);
    Xil_AssertNonvoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);

    Data = XMy_filter_buffer_ReadReg(InstancePtr->Kernel_bus_BaseAddress, XMY_FILTER_BUFFER_KERNEL_BUS_ADDR_BIAS_8_DATA);
    return Data;
}
