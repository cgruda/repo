...
HD_PWD='D:/School/Project/new_repo/Vivado/conv_pool_test_0_1/conv_pool_test_0_1.runs/design_1_cnn_conv_d30x30_k3x3_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_cnn_conv_d30x30_k3x3_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_cnn_conv_d30x30_k3x3_0_0.tcl
