...
HD_PWD='D:/School/Project/new_repo/Vivado/cnn_0/cnn_0.runs/design_1_cnn_conv_d12x12_k3x3_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_cnn_conv_d12x12_k3x3_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_cnn_conv_d12x12_k3x3_0_0.tcl
