...
HD_PWD='D:/School/Project/new_repo/Vivado/cpx2_test_0_0/cpx2_test_0_0.runs/design_1_cnn_pool_d12x12_p2x2_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_cnn_pool_d12x12_p2x2_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_cnn_pool_d12x12_p2x2_0_0.tcl
