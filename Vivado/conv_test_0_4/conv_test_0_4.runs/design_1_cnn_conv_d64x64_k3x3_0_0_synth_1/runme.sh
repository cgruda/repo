...
HD_PWD='D:/School/Project/new_repo/Vivado/conv_test_0_4/conv_test_0_4.runs/design_1_cnn_conv_d64x64_k3x3_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_cnn_conv_d64x64_k3x3_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_cnn_conv_d64x64_k3x3_0_0.tcl
