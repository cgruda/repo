...
HD_PWD='D:/School/Project/new_repo/Vivado/cpx3_test_0_1/cpx3_test_0_1.runs/design_1_cnn_pool_d4x4_p2x2_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_cnn_pool_d4x4_p2x2_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_cnn_pool_d4x4_p2x2_0_0.tcl
