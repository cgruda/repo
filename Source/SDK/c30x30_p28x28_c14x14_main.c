...
// cnn output
#define CNN_OUTPUT_ROWS		CONV_1_OUTPUT_ROWS
#define CNN_OUTPUT_COLS		CONV_1_OUTPUT_COLS
...
void set_data(u32 *conv_0_kernel, u32 *conv_1_kernel, u32 *input_data, u32 *conv_0_ctrl, u32 *pool_0_ctrl, u32 *conv_1_ctrl)
{
...
int main()
{
	...
	/*******************************************************/
	set_data(conv_0_kernel, conv_1_kernel, input_data, &conv_0_ctrl, &pool_0_ctrl, &conv_1_ctrl);
	/*******************************************************/
	...
	do {
		...
		while (!XCnn_conv_d14x14_k3x3_IsDone(&cnn_hw.conv_1))
			/* wait */ ;
