...
// cnn output
#define CNN_OUTPUT_ROWS		POOL_1_OUTPUT_ROWS
#define CNN_OUTPUT_COLS		POOL_1_OUTPUT_COLS
...
void set_data(u32 *conv_0_kernel, u32 *conv_1_kernel, u32 *input_data, u32 *conv_0_ctrl, u32 *pool_0_ctrl, u32 *conv_1_ctrl, u32 *pool_1_ctrl)
{
...
int main()
{
	...
	/*******************************************************/
	set_data(conv_0_kernel, conv_1_kernel, input_data, &conv_0_ctrl, &pool_0_ctrl, &conv_1_ctrl, &pool_1_ctrl);
	/*******************************************************/
	...
	do {
		...
		while (!XCnn_pool_d12x12_p2x2_IsDone(&cnn_hw.pool_1))
			/* wait */ ;
