...
architecture behav of fixed_point_mul is 
    ...
    signal tmp_1_fu_30_p3 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_2_fu_38_p2 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal tmp_s_fu_103_p2 : STD_LOGIC_VECTOR (22 downto 0);
    signal grp_fu_74_ce : STD_LOGIC;

    component cnn_fc_i50_o10_mubkb IS
    generic (
        ID : INTEGER;
        NUM_STAGE : INTEGER;
        din0_WIDTH : INTEGER;
...
begin
    cnn_fc_i50_o10_mubkb_U0 : component cnn_fc_i50_o10_mubkb
    generic map (
        ID => 1,
        NUM_STAGE => 6,
        din0_WIDTH => 32,
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((ap_const_logic_1 = ap_ce)) then
                ...
                b_read_reg_117 <= b;
                tmp_3_reg_137 <= grp_fu_74_p2(31 downto 10);
            end if;
        end if;
    end process;
    a_assign_fu_44_p3 <= 
        tmp_2_fu_38_p2 when (tmp_1_fu_30_p3(0) = '1') else 
        a;
    ap_return <= 
        tmp_s_fu_103_p2 when (tmp_6_fu_95_p3(0) = '1') else 
    ...
    result_cast_fu_92_p1 <= std_logic_vector(resize(unsigned(tmp_3_reg_137),23));
    tmp_1_fu_30_p3 <= a(31 downto 31);
    tmp_2_fu_38_p2 <= std_logic_vector(unsigned(ap_const_lv32_0) - unsigned(a));
    tmp_4_fu_52_p3 <= b(31 downto 31);
    tmp_5_fu_60_p2 <= std_logic_vector(unsigned(ap_const_lv32_0) - unsigned(b));
    tmp_6_fu_95_p3 <= tmp_fu_88_p2(31 downto 31);
    tmp_fu_88_p2 <= (ap_pipeline_reg_pp0_iter6_b_read_reg_117 xor ap_pipeline_reg_pp0_iter6_a_read_reg_122);
    tmp_s_fu_103_p2 <= std_logic_vector(unsigned(ap_const_lv23_0) - unsigned(result_cast_fu_92_p1));
end behav;
