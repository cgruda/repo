...
fixed_point_mul::fixed_point_mul(sc_module_name name) : sc_module(name), mVcdFile(0) {
    cnn_fc_i50_o10_mubkb_U0 = new cnn_fc_i50_o10_mubkb<1,6,32,32,32>("cnn_fc_i50_o10_mubkb_U0");
    cnn_fc_i50_o10_mubkb_U0->clk(ap_clk);
    cnn_fc_i50_o10_mubkb_U0->reset(ap_rst);
    cnn_fc_i50_o10_mubkb_U0->din0(b_assign_reg_132);
    cnn_fc_i50_o10_mubkb_U0->din1(a_assign_reg_127);
    cnn_fc_i50_o10_mubkb_U0->ce(grp_fu_74_ce);
    cnn_fc_i50_o10_mubkb_U0->dout(grp_fu_74_p2);
    ...
    sensitive << ( a );
    sensitive << ( tmp_1_fu_30_p3 );
    sensitive << ( tmp_2_fu_38_p2 );

    SC_METHOD(thread_ap_return);
    sensitive << ( ap_ce );
    sensitive << ( result_cast_fu_92_p1 );
    sensitive << ( tmp_6_fu_95_p3 );
    sensitive << ( tmp_s_fu_103_p2 );
    ...
    sensitive << ( tmp_3_reg_137 );

    SC_METHOD(thread_tmp_1_fu_30_p3);
    sensitive << ( a );

    SC_METHOD(thread_tmp_2_fu_38_p2);
    sensitive << ( a );
    ...
    SC_METHOD(thread_tmp_s_fu_103_p2);
    sensitive << ( result_cast_fu_92_p1 );
    ...
    sc_trace(mVcdFile, tmp_3_reg_137, "tmp_3_reg_137");
    sc_trace(mVcdFile, tmp_1_fu_30_p3, "tmp_1_fu_30_p3");
    sc_trace(mVcdFile, tmp_2_fu_38_p2, "tmp_2_fu_38_p2");
    ...
    sc_trace(mVcdFile, tmp_s_fu_103_p2, "tmp_s_fu_103_p2");
...
fixed_point_mul::~fixed_point_mul() {
    ...
    delete cnn_fc_i50_o10_mubkb_U0;
}
...
void fixed_point_mul::thread_ap_clk_no_reset_() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_ce.read())) {
        ...
        tmp_3_reg_137 = grp_fu_74_p2.read().range(31, 10);
    }
}

void fixed_point_mul::thread_a_assign_fu_44_p3() {
    a_assign_fu_44_p3 = (!tmp_1_fu_30_p3.read()[0].is_01())? sc_lv<32>(): ((tmp_1_fu_30_p3.read()[0].to_bool())? tmp_2_fu_38_p2.read(): a.read());
}

void fixed_point_mul::thread_ap_return() {
    ap_return = (!tmp_6_fu_95_p3.read()[0].is_01())? sc_lv<23>(): ((tmp_6_fu_95_p3.read()[0].to_bool())? tmp_s_fu_103_p2.read(): result_cast_fu_92_p1.read());
}
...
void fixed_point_mul::thread_result_cast_fu_92_p1() {
    result_cast_fu_92_p1 = esl_zext<23,22>(tmp_3_reg_137.read());
}

void fixed_point_mul::thread_tmp_1_fu_30_p3() {
    tmp_1_fu_30_p3 = a.read().range(31, 31);
}

void fixed_point_mul::thread_tmp_2_fu_38_p2() {
    tmp_2_fu_38_p2 = (!ap_const_lv32_0.is_01() || !a.read().is_01())? sc_lv<32>(): (sc_biguint<32>(ap_const_lv32_0) - sc_biguint<32>(a.read()));
}
...
void fixed_point_mul::thread_tmp_6_fu_95_p3() {
    tmp_6_fu_95_p3 = tmp_fu_88_p2.read().range(31, 31);
}
...
void fixed_point_mul::thread_tmp_s_fu_103_p2() {
    tmp_s_fu_103_p2 = (!ap_const_lv23_0.is_01() || !result_cast_fu_92_p1.read().is_01())? sc_lv<23>(): (sc_biguint<23>(ap_const_lv23_0) - sc_biguint<23>(result_cast_fu_92_p1.read()));
}
