...
if {[file isfile cnn_conv_d54x54_k3x3.autotvin.dat]} {
	file delete -force cnn_conv_d54x54_k3x3.autotvin.dat
}

if {[file isfile cnn_conv_d54x54_k3x3.autotvout.dat]} {
	file delete -force cnn_conv_d54x54_k3x3.autotvout.dat
}
