...
fixed_point_mul::fixed_point_mul(sc_module_name name) : sc_module(name), mVcdFile(0) {
    cnn_fc_i144_o50_mbkb_U0 = new cnn_fc_i144_o50_mbkb<1,6,32,32,32>("cnn_fc_i144_o50_mbkb_U0");
    cnn_fc_i144_o50_mbkb_U0->clk(ap_clk);
    cnn_fc_i144_o50_mbkb_U0->reset(ap_rst);
    cnn_fc_i144_o50_mbkb_U0->din0(b_assign_reg_132);
    cnn_fc_i144_o50_mbkb_U0->din1(a_assign_reg_127);
    cnn_fc_i144_o50_mbkb_U0->ce(grp_fu_74_ce);
    cnn_fc_i144_o50_mbkb_U0->dout(grp_fu_74_p2);
...
fixed_point_mul::~fixed_point_mul() {
    ...
    delete cnn_fc_i144_o50_mbkb_U0;
}
