...
typedef struct {
    ...
    XCnn_fc_i50_o10_uio_map maps[ MAX_UIO_MAPS ];
} XCnn_fc_i50_o10_uio_info;

/***************** Variable Definitions **************************************/
static XCnn_fc_i50_o10_uio_info uio_info;
...
static int uio_info_read_name(XCnn_fc_i50_o10_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XCnn_fc_i50_o10_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XCnn_fc_i50_o10_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XCnn_fc_i50_o10_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XCnn_fc_i50_o10_Initialize(XCnn_fc_i50_o10 *InstancePtr, const char* InstanceName) {
	XCnn_fc_i50_o10_uio_info *InfoPtr = &uio_info;
